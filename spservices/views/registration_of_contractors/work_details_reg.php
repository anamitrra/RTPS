...
<main class="rtps-container">
    <div class="container-fluid my-2">
        <form id="myfrm" method="POST" action="<?= base_url('spservices/registration_of_contractors/registration/submit_work_details') ?>" enctype="multipart/form-data">
            ...
            <div class="card shadow-sm">
                ...
                <div class="card-body" style="padding:5px">
                                ...
                                <table class="table table-bordered small" id="add_work_row_tbl">
                                    ...
                                    <?php
                                        ...
                                        ?>
                                                ...
                                                <td><?php if ($deptt_code === "PWDNH"): ?><input onkeypress="return /[0-9%]/i.test(event.key)" name="work_value_remaining[]" class="form-control" type="text" pattern="\d{1,3}%" title="Please enter a percentage value (e.g., 0%, 25%, 100%)" /><?php else: ?>
                                                <input onkeypress="return /[0-9]/i.test(event.key)" name="work_value_remaining[]" class="form-control" type="text" />
                                                <?php endif; ?>
                                                </td>
                                            ...
                                            <td><textarea name="desc_work[]" class="form-control" cols="25"></textarea></td>
                                                ...
                                                <td><?php if ($deptt_code === "PWDNH"): ?><input onkeypress="return /[0-9%]/i.test(event.key)" name="work_value_remaining[]" class="form-control" type="text" pattern="\d{1,3}%" title="Please enter a percentage value (e.g., 0%, 25%, 100%)"/><?php else: ?>
                                                <input onkeypress="return /[0-9]/i.test(event.key)" name="work_value_remaining[]" class="form-control" type="text" /><?php endif; ?></td>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><?php if ($deptt_code === "PWDNH"): ?><input onkeypress="return /[a-zA-Z0-9]/i.test(event.key)" name="work_unit[]" class="form-control" type="text" pattern="[a-zA-Z0-9]+" title="Please enter an alphanumeric value" value="<?= $quantities_of_works_executed[$i]->work_unit ?>" /><?php else: ?><input name="work_unit[]" class="form-control" type="text" value="<?= $quantities_of_works_executed[$i]->work_unit ?>" /><?php endif; ?></td>
                                                <td>
                                            ...
                                            <tr>
                                               ...
                                               <td><?php if ($deptt_code === "PWDNH"): ?><input onkeypress="return /[a-zA-Z0-9]/i.test(event.key)" name="work_unit[]" class="form-control" type="text" pattern="[a-zA-Z0-9]+" title="Please enter an alphanumeric value" /><?php else: ?><input name="work_unit[]" class="form-control" type="text" /><?php endif; ?></td>
                                                <td>
                    ...
                    <?php } ?>
                    <fieldset class="border border-success deed_div" style="margin-top:10px">
                        <legend class="h6">Key Personnel for works and administration<?php if(!(($deptt_code == 'GMC' && $category == 'Class-II') || $category_of_regs == 'Unemployed Graduate Engineer' || $category_of_regs == 'Unemployed Diploma Engineer')) {?><span class="text-danger">*</span><?php } ?> </legend>
                        <div class="row">
                            <div class="col-md-12 table-responsive">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                <!-- <input name="emp_qualification[]" class="form-control" type="text" value="<?= $key_personnel[$i]->emp_qualification ?>"/> -->
                                                <select name="emp_qualification[]" class="form-control">
                                                        <option value="">Please Select</option>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                <!-- <input name="emp_qualification[]" class="form-control" value="<?php echo set_value('emp_qualification[]'); ?>" type="text" /> -->
                                                <select name="emp_qualification[]" class="form-control">
                                                        <option value="">Please Select</option>
                                                        <option value="Degree Holder Engineer" >Degree Holder Engineer</option>
                                                        <option value="Diploma Holder Engineer" >Diploma Holder Engineer</option>
                ...
                <div class="card-footer text-center">
                    <a class="btn btn-primary frmbtn" id="DRAFT" href="<?= base_url('spservices/registration_of_contractors/address-section/'. $obj_id) ?>">
