...
$sub_date1 = isset($response->form_data->submission_date) ? format_mongo_date($response->form_data->submission_date) : '';
$sub_date2 = explode(" ", $sub_date1);
$sub_date =$sub_date2[0];
...
$rtps_convenience_fee = isset($response->form_data->convenience_fee)? $response->form_data->convenience_fee : 0;
...
if (!empty($response->form_data->payment_params->ACCOUNT2)) {
   $appl_fee = $response->form_data->payment_params->AC2_AMOUNT;
} else if (!empty($response->form_data->payment_params->ACCOUNT3)) {
  $appl_fee = $response->form_data->payment_params->AC3_AMOUNT;
} else { $appl_fee = 0; } 
?>
      ...
      <div class="col-sm-12 mx-auto">
        <div class="card my-4 " style="border: 1px solid;padding:20px">
          <div class="card-body">
            ...
            <!-- fee description -->
            <?php if ($rtps_convenience_fee || ($pfc_payment_status === "Y")) { ?>


              <div class="row">
                The following fees have been collected for this application:
              ...
              <div class="row">
                <table>
                  ...
                  <tr>
                    <td><b>Total:</b></td>
                    <td><?= (calculateTotal($response) + $appl_fee) ?></td>
                  </tr>
                </table>
              </div>
