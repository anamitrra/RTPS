        ...
        <div class="card-body border-design">
            <form id="myfrm" method="POST" action="<?= base_url('spservices/upms/dscsign/withoutpdfsigned/') ?>" enctype="multipart/form-data">
                ...
                <div class="topbar">
                    ...
                    <p style="text-align:center;font-weight:bold;margin-top:0;padding-top:0;color:#af7077">ASSAM HIGHER SECONDARY EDUCATION COUNCIL : GUWAHATI - 21 <br> ADMIT</p><br>
                    <table width="100%">
                        <tbody>
                            <tr>
                                ...
                                <td colspan="2"></td>
                                <td rowspan="5" class="photo-td"><?php $photo = base64_encode(file_get_contents(FCPATH . $data[0]->form_data->passport_photo)); ?>
