...
<main class="rtps-container">
    <div class="container my-2">
        <form method="POST" action="<?= base_url('spservices/necertificate/submitfiles') ?>" enctype="multipart/form-data">
            ...
            <div class="card shadow-sm" style="background:#E6F1FF">
                ...
                <div class="card-footer text-center">
                    <a href="<?=site_url('spservices/necertificate/index/'.$obj_id)?>" class="btn btn-primary">
