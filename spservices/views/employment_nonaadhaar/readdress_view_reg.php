    ...
    $(document).ready(function() {
        ...
        $(document).on("change", ".address_same", function() {
            ...
            if (checkedVal === "Yes") {
                ...
                $("#district").html("<option value='" + $("#district_p").val() + "'>" + $("#district_p").val() + "</option>");
...
<main class="rtps-container">
    <div class="container my-2">
        <form id="myfrm" method="POST" action="<?= base_url('spservices/employment-reregistration-nonaadhaar/save-address') ?>" enctype="multipart/form-data">
            ...
            <div class="card shadow-sm">
                ...
                <div class="card-body" style="padding:5px">
                    ...
                    <fieldset class="border border-success" style="margin-top:40px">
                        ...
                        <div class="row form-group">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="name_of_the_house_apartment_p" id="name_of_the_house_apartment_p" value="<?= $name_of_the_house_apartment_p ?>" <?= (count($editable_fields)) ? ((in_array('name_of_the_house_apartment_p', $editable_fields)) ? '' : 'readonly') : '' ?> <?php ($type_of_reg == '3')? print  "": print "disabled"; ?>/>
                                <?= form_error("name_of_the_house_apartment_p") ?>
                            </div>
                            <div class="col-md-6">
                                <label>House No/Apartment No </label>
                                <input <?php ($type_of_reg == '3')? print  "": print "disabled"; ?> type="text" class="form-control" name="house_no_apartment_no_p" id="house_no_apartment_no_p" value="<?= $house_no_apartment_no_p ?>" <?= (count($editable_fields)) ? ((in_array('house_no_apartment_no_p', $editable_fields)) ? '' : 'readonly') : '' ?> />
                        ...
                        <div class="row form-group">
                            <div class="col-md-6">
                                ...
                                <input <?php ($type_of_reg == '3')? print  "": print "disabled"; ?> type="text" class="form-control" name="building_no_block_no_p" id="building_no_block_no_p" value="<?= $building_no_block_no_p ?>" <?= (count($editable_fields)) ? ((in_array('building_no_block_no_p', $editable_fields)) ? '' : 'readonly') : '' ?> />
                                <?= form_error("building_no_block_no_p") ?>
                            </div>
                            <div class="col-md-6">
                                <label>Address (Locality/Street/etc.) </label>
                                <input <?php ($type_of_reg == '3')? print  "": print "disabled"; ?> type="text" class="form-control" name="address_locality_street_etc_p" id="address_locality_street_etc_p" value="<?= $address_locality_street_etc_p ?>" <?= (count($editable_fields)) ? ((in_array('address_locality_street_etc_p', $editable_fields)) ? '' : 'readonly') : '' ?> />
                        ...
                        <div class="row form-group">
                            <div class="col-md-6">
                                ...
                                <input <?php ($type_of_reg == '3')? print  "": print "disabled"; ?> type="text" class="form-control" name="vill_town_ward_city_p" id="vill_town_ward_city_p" value="<?= $vill_town_ward_city_p ?>" <?= (count($editable_fields)) ? ((in_array('vill_town_ward_city_p', $editable_fields)) ? '' : 'readonly') : '' ?> />
                                <?= form_error("vill_town_ward_city_p") ?>
                            </div>
                            <div class="col-md-6">
                                <label>Post Office <span class="text-danger">*</span></label>
                                <input <?php ($type_of_reg == '3')? print  "": print "disabled"; ?> type="text" class="form-control" name="post_office_p" id="post_office_p" value="<?= $post_office_p ?>" <?= (count($editable_fields)) ? ((in_array('post_office_p', $editable_fields)) ? '' : 'readonly') : '' ?> />
                        ...
                        <div class="row form-group">
                            <div class="col-md-6">
                                ...
                                <input <?php ($type_of_reg == '3')? print  "": print "disabled"; ?> type="text" class="form-control" name="police_station_p" id="police_station_p" value="<?= $police_station_p ?>" <?= (count($editable_fields)) ? ((in_array('police_station_p', $editable_fields)) ? '' : 'readonly') : '' ?> />
                                <?= form_error("police_station_p") ?>
                            </div>
                            <div class="col-md-6">
                                <label>Pin Code <span class="text-danger">*</span></label>
                                <input <?php ($type_of_reg == '3')? print  "": print "disabled"; ?> type="text" class="form-control" name="pin_code_p" id="pin_code_p" value="<?= $pin_code_p ?>" maxlength="6" <?= (count($editable_fields)) ? ((in_array('pin_code_p', $editable_fields)) ? '' : 'readonly') : '' ?> />
                        ...
                        <div class="row form-group">
                            <div class="col-md-6">
                                ...
                                <select <?php ($type_of_reg == '3')? print  "": print "disabled"; ?> name="district_p" class="form-control" id="district_p">
                                    <?php if (count($editable_fields)) {
                                        if (in_array('district_p', $editable_fields)) { ?>
                                        ...
                                        <?php  }
                                            ...
                                            echo '<option value="' . $district_p . '" selected>' . $district_p . '</option>';
                                        }
                                    } else { ?>
                                        <option value="">Please Select</option>
                                        <?php foreach ($districts as $district_list) { ?>
                            ...
                            <div class="col-md-6">
                                ...
                                <select <?php ($type_of_reg == '3')? print  "": print "disabled"; ?> name="sub_division" class="form-control" id="sub_division">
                                    <?php if (count($editable_fields)) {
                                        if (in_array('sub_division', $editable_fields)) { ?>
                                            <option value="">Please Select</option>
                                        <?php if (strlen($sub_division)) {
                                                echo '<option value=' . $sub_division . '>' . $sub_division . '</option>';
                                            }
                                        } else {
                        ...
                        <div class="row form-group">
                            <div class="col-md-6">
                                ...
                                <select <?php ($type_of_reg == '3')? print  "": print "disabled"; ?> name="revenue_circle" id="revenue_circle" class="form-control">
                                    <?php if (count($editable_fields)) {
                                        if (in_array('revenue_circle', $editable_fields)) { ?>
                                            <option value="">Please Select</option>
                            ...
                            <div class="col-md-6">
                                ...
                                <select <?php ($type_of_reg == '3')? print  "": print "disabled"; ?> name="residence" class="form-control">
                                    <?php if (count($editable_fields)) {
                                        if (in_array('residence', $editable_fields)) { ?>
                                            <option value="">Please Select</option>
                                            <option value="Urban" <?= ($residence === "Urban") ? 'selected' : '' ?>>Urban</option>
                                            <option value="Rural" <?= ($residence === "Rural") ? 'selected' : '' ?>>Rural</option>
                                        <?php } else {
                                            echo '<option value="' . $residence . '" selected>' . $residence . '</option>';
                                        }
                                    } else { ?>
                                        <option value="">Please Select</option>
                                        <option value="Urban" <?= ($residence === "Urban") ? 'selected' : '' ?>>Urban</option>
                    ...
                    <fieldset class="border border-success" style="margin-top:40px">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-md-6">
                                <div class="form-check form-check-inline">
                                    <input <?php ($type_of_reg == '3')? print  "": print "disabled"; ?> class="form-check-input address_same" type="radio" name="same_as_permanent_address" id="dcsYes" value="Yes" <?= ($same_as_permanent_address === 'Yes') ? 'checked' : '' ?> />
                                    <label class="form-check-label" for="dcsYes">YES</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input <?php ($type_of_reg == '3')? print  "": print "disabled"; ?> class="form-check-input address_same" type="radio" name="same_as_permanent_address" id="dcsNo" value="No" <?= ($same_as_permanent_address === 'No') ? 'checked' : '' ?> />
                        ...
                        <div class="row form-group">
                            <div class="col-md-6">
                                <label>Name of the House/Apartment </label>
                                <input <?php ($type_of_reg == '3')? print  "": print "disabled"; ?> type="text" class="form-control" name="name_of_the_house_apartment" id="name_of_the_house_apartment" value="<?= $name_of_the_house_apartment ?>" <?= ($same_as_permanent_address === 'Yes') ? 'readonly' : '' ?> />
                                <?= form_error("name_of_the_house_apartment") ?>
                            </div>
                            <div class="col-md-6">
                                <label>House No/Apartment No </label>
                                <input <?php ($type_of_reg == '3')? print  "": print "disabled"; ?> type="text" class="form-control" name="house_no_apartment_no" id="house_no_apartment_no" value="<?= $house_no_apartment_no ?>" <?= ($same_as_permanent_address === 'Yes') ? 'readonly' : '' ?> />
                        ...
                        <div class="row form-group">
                            <div class="col-md-6">
                                <label>Building No/Block No. </label>
                                <input <?php ($type_of_reg == '3')? print  "": print "disabled"; ?> type="text" class="form-control" name="building_no_block_no" id="building_no_block_no" value="<?= $building_no_block_no ?>" <?= ($same_as_permanent_address === 'Yes') ? 'readonly' : '' ?> />
                                <?= form_error("building_no_block_no") ?>
                            </div>
                            <div class="col-md-6">
                                <label>Address (Locality/Street/etc.) </label>
                                <input <?php ($type_of_reg == '3')? print  "": print "disabled"; ?> type="text" class="form-control" name="address_locality_street_etc" id="address_locality_street_etc" value="<?= $address_locality_street_etc ?>" <?= ($same_as_permanent_address === 'Yes') ? 'readonly' : '' ?> />
                        ...
                        <div class="row form-group">
                            <div class="col-md-6">
                                <label>Vill/Town/Ward/City <span class="text-danger">*</span></label>
                                <input <?php ($type_of_reg == '3')? print  "": print "disabled"; ?> type="text" class="form-control" name="vill_town_ward_city" id="vill_town_ward_city" value="<?= $vill_town_ward_city ?>" <?= ($same_as_permanent_address === 'Yes') ? 'readonly' : '' ?> />
                                <?= form_error("vill_town_ward_city") ?>
                            </div>
                            <div class="col-md-6">
                                <label>Post Office <span class="text-danger">*</span></label>
                                <input <?php ($type_of_reg == '3')? print  "": print "disabled"; ?> type="text" class="form-control" name="post_office" id="post_office" value="<?= $post_office ?>" <?= ($same_as_permanent_address === 'Yes') ? 'readonly' : '' ?> />
                        ...
                        <div class="row form-group">
                            <div class="col-md-6">
                                <label>Police Station <span class="text-danger">*</span></label>
                                <input <?php ($type_of_reg == '3')? print  "": print "disabled"; ?> type="text" class="form-control" name="police_station" id="police_station" value="<?= $police_station ?>" <?= ($same_as_permanent_address === 'Yes') ? 'readonly' : '' ?> />
                                <?= form_error("police_station") ?>
                            </div>
                            <div class="col-md-6">
                                <label>Pin Code <span class="text-danger">*</span></label>
                                <input <?php ($type_of_reg == '3')? print  "": print "disabled"; ?> type="text" class="form-control" name="pin_code" id="pin_code" value="<?= $pin_code ?>" maxlength="6" <?= ($same_as_permanent_address === 'Yes') ? 'readonly' : '' ?> />
                                <?= form_error("pin_code") ?>
                            </div>
                        </div>
                        ...
                        <div class="row form-group">
                            <div class="col-md-6">
                                <label>District <span class="text-danger">*</span> </label>
                                <select <?php ($type_of_reg == '3')? print  "": print "disabled"; ?> name="district" class="form-control" id="district">
                                    <option value="">Please Select</option>
                                    <?php foreach ($districts as $district_list) { ?>
                ...
                <div class="card-footer text-center">
                    <a class="btn btn-primary frmbtn" id="DRAFT" href="<?= base_url('spservices/employment-reregistration-nonaadhaar/personal-details/' . $obj_id) ?>">
