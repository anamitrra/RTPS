...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $(document).on("click", "#finalBtn", function() {
            location.replace("<?= base_url('spservices/employmentnonaadhaar/registration/submit_query/' . $obj_id) ?>")
        });
    });
</script>
        ...
        <div class="card shadow-sm" id="printDiv">
            ...
            <div class="card-footer text-center no-print">
                ...
                if ($status == 'QS') { ?>
                    ...
                    <a class="btn btn-primary frmbtn" id="DRAFT" href="<?= base_url('spservices/employment-registration-nonaadhaar/enclosures/' . $obj_id) ?>">
