...
<script>
    $(document).ready(function() {
        ...
        $(function() {
            ...
            // var startingDate = new Date.today().addDays(1).toString("dd/mm/yy");
...
<main class="rtps-container">
    <div class="container my-2">
        <form id="myfrm" method="POST" action="<?= base_url('spservices/employment-registration-nonaadhaar/save-slot') ?>" enctype="multipart/form-data">
            ...
            <div class="card shadow-sm">
                ...
                <div class="card-footer text-center">
                    <a class="btn btn-primary frmbtn" id="DRAFT" href="<?= base_url('spservices/employment-registration-nonaadhaar/work-experiences/' . $obj_id) ?>">
