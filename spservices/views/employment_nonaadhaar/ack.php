...
$sub_date = isset($response->form_data->submission_date) ? date('d-m-Y', strtotime($response->form_data->submission_date)) : '';
...
$rtps_convenience_fee = $response->form_data->convenience_fee;
