...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        function getExaminationPassedList(highestEducationLevel) {
            examinationPassedList = '';
            $.ajax({
                url: '<?= base_url("spservices/employmentnonaadhaar/reregistration/get_examination_passed") ?>',
                method: 'post',
                data: {
...
<main class="rtps-container">
    ...
    <form id="myfrm" method="POST" action="<?= base_url('spservices/employmentnonaadhaar/reregistration/submit_education_details') ?>" enctype="multipart/form-data">
            ...
            <div class="card shadow-sm">
                ...
                <div class="card-body" style="padding:5px">
                    ...
                    <fieldset class="border border-success deed_div" style="margin-top:40px">
                        ...
                        <div class="row form-group">
                            <div class="col-md-6">
                                ...
                                <select <?php ($type_of_reg == '4')? print  "": print "disabled"; ?> name="highest_educational_level" class="form-control" id="highest_educational_level">
                                    <option value="">Please Select</option>
                            ...
                            <div class="col-md-6">
                                ...
                                <select <?php ($type_of_reg == '4')? print  "": print "disabled"; ?> name="highest_examination_passed" class="form-control highest_examination_passed">
                            ...
                            <div class="col-md-6 mt-2 other_examination_passed_div d-none">
                                ...
                                <input <?php ($type_of_reg == '4')? print  "": print "disabled"; ?> type="text" class="form-control" name="other_examination_passed" value="<?= $other_examination_passed ?>">
                                    ...
                                    <table class="table table-bordered" id="education_qualification_tbl">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                    <tr>
                                                        <td>
                                                            <select <?php ($type_of_reg == '4')? print  "": print "disabled"; ?> name="examination_passed[]" class="form-control examination_passed">
                                                        ...
                                                        <td class="other_examination_name <?= ($education_qualification[$i]->other_examination_name == '') ? 'd-none' : '' ?>">
                                                            <input <?php ($type_of_reg == '4')? print  "": print "disabled"; ?> name="other_examination_name[]" value="<?= $education_qualification[$i]->other_examination_name ?>" class="form-control " type="text" />
                                                        </td>
                                                        <td><input <?php ($type_of_reg == '4')? print  "": print "disabled"; ?> name="major_elective_subject[]" value="<?= $education_qualification[$i]->major__elective_subject ?>" class="form-control" type="text" /></td>
                                                        <td><input <?php ($type_of_reg == '4')? print  "": print "disabled"; ?> name="subjects_other_subjects[]" value="<?= $education_qualification[$i]->subjects__other_subjects ?>" class="form-control" type="text" /></td>
                                                        <td><input <?php ($type_of_reg == '4')? print  "": print "disabled"; ?> name="board_university[]" value="<?= $education_qualification[$i]->board__university ?>" class="form-control" type="text" /></td>
                                                        <td><input <?php ($type_of_reg == '4')? print  "": print "disabled"; ?> name="institution_school_college[]" value="<?= $education_qualification[$i]->institution__school__college ?>" class="form-control" type="text" /></td>
                                                        <td><input <?php ($type_of_reg == '4')? print  "": print "disabled"; ?> name="date_of_passing[]" value="<?= $education_qualification[$i]->date_of_passing ?>" class="form-control dp" type="text" /></td>
                                                        <td><input <?php ($type_of_reg == '4')? print  "": print "disabled"; ?> name="registration_no[]" value="<?= $education_qualification[$i]->registration_no ?>" class="form-control" type="text" /></td>
                                                        <td><input <?php ($type_of_reg == '4')? print  "": print "disabled"; ?> name="percentage_of_marks[]" value="<?= $education_qualification[$i]->percentage_of_marks ?>" class="form-control" type="text" /></td>
                                                        <td>
                                                            <select <?php ($type_of_reg == '4')? print  "": print "disabled"; ?> name="class_division[]" class="form-control" id="">
                                                                <option value="">Please Select</option>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="other_examination_name d-none"><input name="other_examination_name[]" <?php ($type_of_reg == '4')? print  "": print "disabled"; ?> class="form-control " type="text" /></td>
                                                    <td><input <?php ($type_of_reg == '4')? print  "": print "disabled"; ?> name="major_elective_subject[]" class="form-control" type="text" /></td>
                                                    <td><input <?php ($type_of_reg == '4')? print  "": print "disabled"; ?> name="subjects_other_subjects[]" class="form-control" type="text" /></td>
                                                    <td><input <?php ($type_of_reg == '4')? print  "": print "disabled"; ?> name="board_university[]" class="form-control" type="text" /></td>
                                                    <td><input <?php ($type_of_reg == '4')? print  "": print "disabled"; ?> name="institution_school_college[]" class="form-control" type="text" /></td>
                                                    <td><input <?php ($type_of_reg == '4')? print  "": print "disabled"; ?> name="date_of_passing[]" class="form-control dp" type="text" /></td>
                                                    <td><input <?php ($type_of_reg == '4')? print  "": print "disabled"; ?> name="registration_no[]" class="form-control" type="text" /></td>
                                                    <td><input <?php ($type_of_reg == '4')? print  "": print "disabled"; ?> name="percentage_of_marks[]" class="form-control" type="text" /></td>
                                                    <td>
                                                        <select <?php ($type_of_reg == '4')? print  "": print "disabled"; ?> name="class_division[]" class="form-control" id="">
                                                            <option value="">Please Select</option>
                                                            <option value="1st">1st</option>
                            ...
                            <div class="col-md-12">
                                ...
                                <table class="table table-bordered" id="other_qualification_tbl">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                                <tr>
                                                    <td><input <?php ($type_of_reg == '4')? print  "": print "disabled"; ?> name="certificate_name[]" value="<?= $other_qualification_trainings_courses[$i]->certificate_name ?>" class="form-control" type="text" /></td>
                                                    <td><input <?php ($type_of_reg == '4')? print  "": print "disabled"; ?> name="issued_by[]" value="<?= $other_qualification_trainings_courses[$i]->issued_by ?>" class="form-control" type="text" /></td>
                                                    <td>
                                                        <select <?php ($type_of_reg == '4')? print  "": print "disabled"; ?> name="duration_in_months[]" class="form-control">
                                                            <option value="">Please Select</option>
                                                            <?php for ($j = 1; $j <= 24; $j++) { ?>
                                                    ...
                                                    <td><input <?php ($type_of_reg == '4')? print  "": print "disabled"; ?> name="odate_of_passing[]" value="<?= (strlen($other_qualification_trainings_courses[$i]->date_of_passing) == 10) ? date('d-m-Y', strtotime($other_qualification_trainings_courses[$i]->date_of_passing)) : '' ?>" class="form-control dp" type="text" /></td>
                                                    <td>
                                                    <?php if($type_of_reg == '4'){ ?>
                                                        <?= $btn ?>
                                                        <?php } ?>
                                            ...
                                            <tr>
                                                <td><input <?php ($type_of_reg == '4')? print  "": print "disabled"; ?> name="certificate_name[]" class="form-control" type="text" /></td>
                                                <td><input <?php ($type_of_reg == '4')? print  "": print "disabled"; ?> name="issued_by[]" class="form-control" type="text" /></td>
                                                <td>
                                                    <select <?php ($type_of_reg == '4')? print  "": print "disabled"; ?> name="duration_in_months[]" class="form-control">
                                                        <option value="">Please Select</option>
                                                        <?php for ($i = 1; $i <= 24; $i++) {
                                                ...
                                                <td><input <?php ($type_of_reg == '4')? print  "": print "disabled"; ?> name="odate_of_passing[]" class="form-control dp" type="text" /></td>
                                                <td style="text-align:center">
                                                <?php if($type_of_reg == '4'){ ?>
                                ...
                                <table class="table table-bordered" id="skill_qualification">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                                ...
                                                <tr>
                                                    <td><input <?php ($type_of_reg == '4')? print  "": print "disabled"; ?> name="exam_diploma_certificate[]" value="<?= $exam_diploma_certificate[$i] ?>" class="form-control" type="text" /></td>
                                                    <td><input <?php ($type_of_reg == '4')? print  "": print "disabled"; ?> name="sector[]" value="<?= $sector[$i] ?>" class="form-control" type="text" /></td>
                                                    <td><input <?php ($type_of_reg == '4')? print  "": print "disabled"; ?> name="course_job_role[]" value="<?= $course_job_role[$i] ?>" class="form-control" type="text" /></td>
                                                    <td><input <?php ($type_of_reg == '4')? print  "": print "disabled"; ?> name="duration[]" value="<?= $duration[$i] ?>" class="form-control" type="text" /></td>
                                                    <td><input <?php ($type_of_reg == '4')? print  "": print "disabled"; ?> name="certificate_id[]" value="<?= $certificate_id[$i] ?>" class="form-control" type="text" /></td>
                                                    <td><input <?php ($type_of_reg == '4')? print  "": print "disabled"; ?> name="engagement[]" value="<?= $engagement[$i] ?>" class="form-control" type="text" /></td>
                                                    <td>
                                                    <?php if($type_of_reg == '4'){ ?>
                                                        <?= $btn ?>
                                                        <?php } ?>
                                            ...
                                            <tr>
                                                <td><input <?php ($type_of_reg == '4')? print  "": print "disabled"; ?> name="exam_diploma_certificate[]" class="form-control" type="text" /></td>
                                                <td><input <?php ($type_of_reg == '4')? print  "": print "disabled"; ?> name="sector[]" class="form-control" type="text" /></td>
                                                <td><input <?php ($type_of_reg == '4')? print  "": print "disabled"; ?> name="course_job_role[]" class="form-control" type="text" /></td>
                                                <td><input <?php ($type_of_reg == '4')? print  "": print "disabled"; ?> name="duration[]" class="form-control" type="text" /></td>
                                                <td><input <?php ($type_of_reg == '4')? print  "": print "disabled"; ?> name="certificate_id[]" class="form-control" type="text" /></td>
                                                <td><input <?php ($type_of_reg == '4')? print  "": print "disabled"; ?> name="engagement[]" class="form-control" type="text" /></td>
                                                <td style="text-align:center">
                                                <?php if($type_of_reg == '4'){ ?>
                            ...
                            <div class="col-md-12">
                                ...
                                <table class="table table-bordered" id="language_tbl">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                                <tr>
                                                    <td><input <?php ($type_of_reg == '4')? print  "": print "disabled"; ?> name="languages_known[]" value="<?= isset($languages_known[$i]->language) ? $languages_known[$i]->language : '' ?>" class="form-control" type="text" /></td>
                                                    <td>
                                                        <div class="form-check form-check-inline">
                                                            <input <?php ($type_of_reg == '4')? print  "": print "disabled"; ?> class="form-check-input" type="checkbox" name="read_option[]" id="read" value="Read" <?= isset($languages_known[$i]->r_option) ? (($languages_known[$i]->r_option === 'Read') ? 'checked' : '') : '' ?>>
                                                            <label class="form-check-label" for="read">Read</label>
                                                        </div>
                                                        <div class="form-check form-check-inline">
                                                            <input <?php ($type_of_reg == '4')? print  "": print "disabled"; ?> class="form-check-input" type="checkbox" name="write_option[]" id="write" value="Write" <?= isset($languages_known[$i]->w_option) ? (($languages_known[$i]->w_option === 'Write') ? 'checked' : '') : '' ?>>
                                                            <label class="form-check-label" for="write">Write</label>
                                                        </div>
                                                        <div class="form-check form-check-inline">
                                                            <input <?php ($type_of_reg == '4')? print  "": print "disabled"; ?> class="form-check-input" type="checkbox" name="speak_option[]" id="speak" value="Speak" <?= isset($languages_known[$i]->s_option) ? (($languages_known[$i]->s_option === 'Speak') ? 'checked' : '') : '' ?>>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-check form-check-inline">
                                                        <input <?php ($type_of_reg == '4')? print  "": print "disabled"; ?> class="form-check-input" type="checkbox" name="read_option[]" id="" value="Read">
                                                        <label class="form-check-label" for="">Read</label>
                                                    </div>
                                                    <div class="form-check form-check-inline">
                                                        <input <?php ($type_of_reg == '4')? print  "": print "disabled"; ?> class="form-check-input" type="checkbox" name="write_option[]" id="" value="Write">
                                                        <label class="form-check-label" for="">Write</label>
                                                    </div>
                                                    <div class="form-check form-check-inline">
                                                        <input <?php ($type_of_reg == '4')? print  "": print "disabled"; ?> class="form-check-input" type="checkbox" name="speak_option[]" id="" value="Speak">
                                                        <label class="form-check-label" for="">Speak</label>
                                                    </div>
                                                </td>
                    ...
                    <fieldset class="border border-success" style="margin-top:40px">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-md-6">
                                <input <?php ($type_of_reg == '4')? print  "": print "disabled"; ?> type="text" class="form-control" name="job_preference_key_skills" id="job_preference_key_skills" value="<?= $job_preference_key_skills ?>" />
                ...
                <div class="card-footer text-center">
                    <a class="btn btn-primary frmbtn" id="DRAFT" href="<?= base_url('spservices/employment-reregistration-nonaadhaar/address-section/' . $obj_id) ?>">
