    ...
    <div class="container my-2">
        <div class="card shadow-sm" id="printDiv">
            ...
            <div class="card-body" style="padding:5px">
                    ...
                    <table class="table table-borderless" style="margin-top:0px; margin-bottom:0px;">
                        <tbody style="border-top: none !important">
                            ...
                            <tr>
                                ...
                                <td>Applicant's Gender/ আবেদনকাৰীৰ লিংগ <br><strong><?=$applicant_gender?></strong>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>Correspondence Address/ চিঠিপত্ৰৰ
                                    ঠিকনা<br><strong><?=$correspondence_addr?></strong> </td>
                            </tr>
                            <tr>
                ...
                <fieldset class="border border-success table-responsive" style="margin-top:40px">
                    ...
                    <table class="table table-borderless" style="margin-top:0px; margin-bottom:0px;">
                        <tbody style="border-top: none !important">
                            <tr>
                                <td>Primary Qualification(MBBS or equivalent)/ প্ৰাথমিক অৰ্হতা(MBBS বা
                                    সমতুল্য)<br><strong><?=$primary_qualification?></strong> </td>
                                <td>Month & year of passing the Final MBBS Exam/চূড়ান্ত এম.বি.বি.এছ. পৰীক্ষাত উত্তীৰ্ণ হোৱাৰ মাহ আৰু বছৰ* <br><strong><?=$primary_qua_doc?></strong>
                                </td>
                            </tr>
                            <tr>
                                <td>College Name/ কলেজৰ নাম <br><strong><?=$primary_qua_college_name?></strong> </td>
                               <td>Course Duration/ পাঠ্যক্ৰমৰ সময়সীমা
                                    <br><strong><?=$primary_qua_course_dur?></strong> </td>
                            </tr>
                            <tr>
                                
                                <td>Date of Completion of Internship/ ইন্টাৰশ্বিপ সম্পূৰ্ণ হোৱাৰ
                                    তাৰিখ<br><strong><?=$primary_qua_doci?></strong> </td>
                                    <td>Name of the university awarding the degree/ ইন্টাৰশ্বিপ প্ৰদান কৰা
                                    বিশ্ববিদ্যালয়
                                    <br><strong><?=$primary_qua_university_award_intership?></strong> </td>     
                            </tr>
                              <tr>  
                ...
                <fieldset class="border border-success table-responsive" style="margin-top:40px">
                    <legend class="h5">Applicant Study Location Details</legend>
                    <table class="table table-borderless" style="margin-top:0px; margin-bottom:0px;">
                        <tbody style="border-top: none !important">
                            <tr>
                                <td>Applicant Study Location<br><strong><?= $study_place ?></strong></td>
                                ...
                                <td>Address Line 2/ ঠিকনাৰ চিতীয় শাৰী<br><strong><?= $address2 ?></strong></td>
                                <?php } ?>
                                ...
                                <td>State/ৰাজ্য/Province/প্ৰদেশ<br><strong><?= $state_foreign ?></strong></td>
                                <?php } ?>
                            </tr>
                        </tbody>
                    </table>
            ...
            <div class="card-footer text-center no-print">
                ...
                <a href="<?= base_url('spservices/acmr_provisional_certificate/registration/index/' . $obj_id) ?>"
                ...
                <a href="<?= base_url('spservices/acmr_provisional_certificate/payment/initiate/' . $obj_id) ?>"
