...
<main class="rtps-container">
    <form  method="POST" action="<?= base_url('spservices/acmr_provisional_certificate/payment/submit') ?>">
                ...
                <fieldset class="border border-success table-responsive" style="margin-top:40px">
                    ...
                    <div class="row form-group">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="convenience_fee" id="convenience_fee" value="<?=$rtps_convenience_fee?>" readonly />
