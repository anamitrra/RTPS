        ...
        <div class="card shadow">
            ...
            <div class="card-body">
                <table class="table  table-sm" id="application_list_table">
                    <tr>
                        <td>
                            <p style="font-size:16px"><b>RTPS Ref. No. : <span class="text-danger"><?php echo $dbrow->rtps_trans_id; ?></span></b></p>
                        </td>
                        <td>
                            <p style="font-size:16px ; text-align:right "><b>Application Receiving Date : <?php echo date('d/m/Y', strtotime($this->mongo_db->getDateTime($dbrow->created_at))); ?></b></p>
                        </td>
                    </tr>
                </table>
