        ...
        <div class="card shadow-sm" id="printDiv">
            ...
            <div class="card-footer text-center no-print">
                <?php if($form_status === 'DRAFT') { ?>    
                    <a href="<?=base_url('spservices/prc/Application/index/'. $obj_id)?>" class="btn btn-primary">
                ...
                <?php if($payment_status !== 'PAYMENT_COMPLETED'){
                    if($form_status === 'QS'){ ?>
                        <!--<button class="btn btn-warning frmbtn"  type="button">
                         ...
                         -->
                        <a href="<?=base_url('spservices/prc/Application/finalsubmition/'. $obj_id)?>" class="btn btn-warning" onclick='this.disabled = true;'>
                        <i class="fa fa-pencil"></i> Submit
                    </a>
                    <?php } else if($user_type == 'user'){ ?>
                        <a href="<?=base_url('spservices/prc/Payment/ctz_initiate/'. $obj_id)?>" class="btn btn-warning">
                    ...
                    <?php } else{ ?>
                        ...
                        <a href="<?=base_url('spservices/prc/Payment/initiate/'. $obj_id)?>" class="btn btn-warning">
                        <i class="fa fa-angle-double-right"></i> Make Payment
                    </a>
                    <?php }//End of if else
                }//End of if ?>
