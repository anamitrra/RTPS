...
<script type="text/javascript">
    ...
    //     let url = '<?= base_url('spservices/delayedbirth/pdbr/finalsubmition') ?>'
        ...
        <div class="card shadow-sm" id="printDiv">
            ...
            <div class="card-footer text-center no-print">
                <?php if ($appl_status === 'DRAFT') { ?>
                    <a href="<?= base_url('spservices/delayedbirth/pdbr/index/' . $obj_id) ?>" class="btn btn-primary">
                ...
                <?php if (($appl_status != 'QA') && ($appl_status != 'QS')) { ?>
                    <a href="<?= base_url('spservices/delayedbirth/payment/initiate/' . $obj_id) ?>" class="btn btn-success">
                        <i class="fa fa-angle-double-right"></i> Make Payment
                    </a>
                <?php } ?>
                <!-- <?php //if //((($user_type != 'user') && ($appl_status === 'DRAFT')) || ($appl_status === 'payment_initiated')) { ?>
                    <a href="<?php //base_url('spservices/delayedbirth/payment/initiate/' . $obj_id) ?>" class="btn btn-success">
                        <i class="fa fa-angle-double-right"></i> Make Payment
                    </a>
                <?php //} ?> -->
            </div>
