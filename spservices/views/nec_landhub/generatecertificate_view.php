...
$params['data'] = base_url('spservices/necapi/verifycertificate/' . $obj_id);
$params['level'] = 'H';
$params['size'] = 10;
        ...
        <div class="card shadow">
            <div class="card-body" style="border: 2px solid #ccc; margin: 2px; padding: 10px;">
                <div style="text-align: center; border-bottom: 2px solid #ccc; padding: 10px">
                    <img src="<?=FCPATH.'assets/frontend/images/assam_logo.png'?>" style="height: 110px; width: 100px" alt="Govt. of Assam" />
                    ...
                    <!--<div style="font-size: 16px; font-weight: bold;"><?=$office_name?> Sub-Registrar Office</div>-->
                </div>
                
                <table class="table table-borderless" style="margin: 10px auto; width: 100%; display: block">
                ...
                <div style="margin: 10px auto; padding: 10px;">
                    <div style="display: block; text-align: justify; line-height: 24px; font-size: 14px; clear: both">
                        Name of the applicant <strong><?=$dbrow->applicant_name?></strong>,<br>
                        S/O, D/O, W/O : <strong><?=$dbrow->father_name?></strong>,<br>
                        Certified that the properties indicated below have been searched in this office records from<br>
                        <strong>01-01-<?=$dbrow->searched_from?></strong> to <strong><?=$searchTo?></strong> 
                    ...
                    <table class="table table-borderless" style="margin: 20px auto; width: 100%; display:block">
                        <tbody style="border-top: none">
                            <tr>
