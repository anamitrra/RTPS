...
<?php 
$applications = !empty($ahsecmarksheetduplicatecertificate) ? $ahsecmarksheetduplicatecertificate : array();
        ...
        <div class="col-sm-12 mx-auto">
            <div class="card my-4">
                <div class="card-body table-container">
                    <h4>AHSEC - Duplicate Marksheet </h4>
                                ...
                                <td>
                                   ...
                                   elseif($value->service_data->appl_status == "D"){ ?>
                                    ...
                                    <a class="btn btn-danger btn-sm mbtn"
                                        href="<?= base_url('spservices/duplicatecertificateahsec/registration/request_for_recorrection/'.$obj_id)?>">Request for re-correction</a>
                                    <?php if($value->service_data->service_id=='AHSECDMRK') { ?>
