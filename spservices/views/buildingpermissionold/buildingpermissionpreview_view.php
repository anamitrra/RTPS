...
if ($dbrow->form_data->case_type == 1) 
    $case_type_name = "New Type";
else if ($dbrow->form_data->case_type == 2)
    $case_type_name = "Alteration Addition Existing";
else
    $case_type_name = "NA";
...
$district_emp_tech_name = !empty($dbrow->form_data->district_emp_tech_name)? $dbrow->form_data->district_emp_tech_name: "NA";
$empanelled_reg_tech_person_name = !empty($dbrow->form_data->empanelled_reg_tech_person_name)? $dbrow->form_data->empanelled_reg_tech_person_name: "NA";

$district_name = !empty($dbrow->form_data->district_name)? $dbrow->form_data->district_name: "NA";
$house_no = $dbrow->form_data->house_no;
$mst_pln_dev_auth_name = !empty($dbrow->form_data->mst_pln_dev_auth_name)? $dbrow->form_data->mst_pln_dev_auth_name: "NA";
...
$old_dag_no = !empty($dbrow->form_data->old_dag_no)? $dbrow->form_data->old_dag_no: "NA";
            ...
            <div class="card-body" style="padding:5px">
                    ...
                    <table class="table table-borderless" style="margin-top:0px; margin-bottom:0px;">
                        <tbody style="border-top: none !important">
                            <tr>
                                ...
                                <td>Case Type/ কেছৰ ধৰণ <br><strong><?=$case_type_name?></strong> </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td>District/জিলা<br><strong><?=$district_emp_tech_name?></strong> </td>
                                <td>Empanelled Registered Technical Person/ তালিকাভুক্ত পঞ্জীভুক্ত কাৰিকৰী ব্যক্তি<br><strong><?=$empanelled_reg_tech_person_name?></strong> </td>
                            </tr>
                        </tbody>
                    </table>
                </fieldset>
                ...
                <fieldset class="border border-success table-responsive" style="margin-top:40px">
                    ...
                    <table class="table table-borderless" style="margin-top:0px; margin-bottom:0px;">
                        <tbody style="border-top: none !important">
                            <tr>
                                <td>District/জিলা<br><strong><?=$district_name?></strong> </td>
                                <td>House No/ঘৰ নং<br><strong><?=$house_no?></strong> </td>
                            </tr>
                            <tr>
                                <td>Master Plan/Development Authority/মাষ্টাৰ প্লেন/উন্নয়ন কৰ্তৃপক্ষ<br><strong><?=$mst_pln_dev_auth_name?></strong> </td>
                                <td>Name Of Road/পথৰ নাম<br><strong><?=$name_of_road?></strong> </td>
                            </tr>
                            <tr>
                                <td>ULB/Panchayat/পঞ্চায়ত<br><strong><?=$panchayat_ulb_name?></strong> </td>
                                <td>Pin Code/ পিন কোড<br><strong><?=$site_pin_code?></strong> </td>
                            </tr>
                            <tr>
                                <td>Revenue Village/ৰাজহ গাঁও<br><strong><?=$revenue_village_name?></strong> </td>
                                <td>Old Dag No/পুৰণি দাগ নং<br><strong><?=$old_dag_no?></strong> </td>
                            </tr>
                            <tr>
                                <td>Ward No/ ৱাৰ্ড নং<br><strong><?=$ward_no_name?></strong> </td>
                                <td>New Dag No/ নতুন দাগ নম্বৰ <br><strong><?=$new_dag_no?></strong> </td>
                            </tr>
                            <tr>
                                <td>Mouza/ মৌজা<br><strong><?=$mouza_name?></strong> </td>
                                <td>Old Patta No/ পুৰণি পট্টা নং<br><strong><?=$old_patta_no?></strong> </td>
                            </tr>
                            <tr>
                ...
                <fieldset class="border border-success table-responsive" style="margin-top:40px">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <?php if(($case_type === '2') && ($any_old_permission === 'yes')) { ?>
                            <tr>
