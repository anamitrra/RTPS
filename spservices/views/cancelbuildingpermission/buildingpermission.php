                    ...
                    <fieldset class="border border-success" style="margin-top:40px">
                        ...
                        <div class="row form-group">
                            <div class="col-md-6">
                                ...
                                <select name="district_emp_tech" id="district_emp_tech" class="form-control" readonly>
                                    <option value="">Please Select</option>
                                </select>
                                <input type="text" name="district_emp_tech_name" value="<?= strlen($district_emp_tech_name) ? $district_emp_tech_name : '' ?>" id="district_emp_tech_name" hidden readonly/>
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="empanelled_reg_tech_person" class="form-control" id="empanelled_reg_tech_person" readonly>
                                    <option value="">Please Select</option>
                                    <?php
                                ...
                                <input type="text" name="empanelled_reg_tech_person_name" id="empanelled_reg_tech_person_name" value="<?= strlen($empanelled_reg_tech_person_name) ? $empanelled_reg_tech_person_name : '' ?>" hidden readonly/>
                                <?= form_error("empanelled_reg_tech_person") ?>
                            </div>
                        </div>
                    </fieldset>
