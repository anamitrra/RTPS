                        ...
                        <tbody style="border-top: none !important">
                            <tr>
                                ...
                                <td>Valid AHSEC Registrtion Number / বৈধ এ এইচ এছ ই চি পঞ্জীয়ন নম্বৰ
                                    <br><strong><?=$ahsec_reg_no?></strong> </td>

                            </tr>
                            <tr>
                                <td>Years of Passing of H.S. 2nd Year Examination / এইচ.এছ. ২য় বৰ্ষৰ
                                    পৰীক্ষা<br><strong><?=$ahsec_yearofpassing?></strong> </td>
                        ...
                        <tbody style="border-top: none !important">
                            ...
                            <tr>
                                <td>State where seeking admission/ ক’ত নামভৰ্তি বিচাৰিছে সেই কথা উল্লেখ কৰক
                                    <br><strong><?=$state_seaking_adm?></strong> </td>
                                <td>Describe Reason for Seeking Migration/ প্ৰব্ৰজন বিচৰাৰ কাৰণ বৰ্ণনা কৰা
                                    <br><strong><?=$reason_seaking_adm?></strong> </td>
                            </tr>
