...
if ($dbrow->service_data->service_id != "AHSECDMRK") {
    ...
    //result table data
    $roll = $master_data1->Roll ?? null;
    $no = $master_data1->No ?? null;
    $stream = $master_data1->Stream ?? null;
    $commencing_day = $master_data1->commencing_day ?? null;
    $commencing_month = $master_data1->commencing_month ?? null;
    $exam_year = $master_data1->Year_of_Examination ?? null;
}
?>
<style type="text/css">
legend {
