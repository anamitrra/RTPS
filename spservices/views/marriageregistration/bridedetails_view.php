...
<main class="rtps-container">
    <div class="container my-2">
        <form id="myfrm" method="POST" action="<?= base_url('spservices/marriageregistration/bridedetails/submit') ?>" enctype="multipart/form-data">
            ...
            <div class="card shadow-sm">
                ...
                <div class="card-footer text-center">
                    <a href="<?=site_url('spservices/marriageregistration/applicantdetails/index/'.$obj_id)?>" class="btn btn-primary">
