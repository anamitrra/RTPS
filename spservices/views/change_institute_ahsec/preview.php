...
$obj_id = $dbrow->{'_id'}->{'$id'};
    ...
    $ahsec_inst_name =isset($dbrow->form_data->ahsec_inst_name) ? $dbrow->form_data->ahsec_inst_name: "";    
        ...
        <div class="card shadow-sm" id="printDiv">
            ...
            <div class="card-footer text-center no-print">
                <?php if($appl_status === 'DRAFT') { ?>
                    <a href="<?=site_url('spservices/change_institute_ahsec/registration/sectionThree/'.$obj_id)?>"
                        class="btn btn-info">
                        <i class="fa fa-angle-double-left"></i> Back
                    </a>
                    <a href="<?= base_url('spservices/change_institute_ahsec/registration/index/' . $obj_id) ?>" class="btn btn-primary">
                ...
                <a href="<?= base_url('spservices/change_institute_ahsec/payment/initiate/' . $obj_id) ?>" class="btn btn-success">
