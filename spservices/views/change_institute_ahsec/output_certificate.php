...
<body>
    <div class="wrapper">
        <div class="main">
            <div class="topbar">
                <p style="text-align:center;font-weight:bold;margin-top:0;padding-top:0">ASSAM COUNCIL OF MEDICAL REGISTRATION<br> CERTIFICATE OF REGISTRATION OF ADDITIONAL QUALIFICATION</p>
                ...
                <table width="100%">
                    <thead>
                        <tr>
                            ...
                            <th style="text-align:center;font-weight:bold">Date and Place of Registration</th>
                            <th style="text-align:center;font-weight:bold">Qualification (Additional)</th>
                            <th style="text-align:center;font-weight:bold">Original Reg. No</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            ...
                            <td width="20%"><?= $data[0]->form_data->registration_date ?></td>
                            <td width="20%">
                                <?php
