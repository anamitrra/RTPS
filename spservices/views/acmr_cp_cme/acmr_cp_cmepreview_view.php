...
<script type="text/javascript">   
    $(document).ready(function () {
        ...
        $(document).on("click", ".frmsbbtn", function(e){ 
            ...
            let url='<?=base_url('spservices/acmr_cp_cme/registration/finalsubmition')?>'
    ...
    <div class="container my-2">
        <div class="card shadow-sm" id="printDiv">
                ...
                <fieldset class="border border-success table-responsive" style="margin-top:40px">
                    ...
                    <table class="table table-borderless" style="margin-top:0px; margin-bottom:0px;">
                        <tbody style="border-top: none !important">
                            ...
                            <tr>                            
                                <td>In case of Live Workshop, are all operating Faculties Registered with Assam Council of Medical Registration? /
                                     লাইভ ৱৰ্কশ্বপৰ ক্ষেত্ৰত, সকলোৱে অসম চিকিৎসা পঞ্জীয়ন পৰিষদৰ সৈতে পঞ্জীয়ন কৰা অনুষদ বোৰ পঞ্জীয়ন কৰিছে নেকি?  <br><strong><?=$live_workshop?></strong> </td>
                            </tr>
                        </tbody>
                    </table>
                </fieldset>
            ...
            <div class="card-footer text-center no-print">
                ...
                <a href="<?= base_url('spservices/acmr_cp_cme/registration/index/' . $obj_id) ?>" class="btn btn-primary">
                ...
                <a href="<?= base_url('spservices/acmr_cp_cme/payment/initiate/' . $obj_id) ?>" class="btn btn-success">
