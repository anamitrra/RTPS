...
<?php 
$applications = !empty($migrationahsecs) ? $migrationahsecs : array();
...
<div class="container">
    <div class="row">
        <div class="col-sm-12 mx-auto">
            <div class="card my-4">
                <div class="card-body">
                    <h4>Registration of Migration Certificate <a
                            href="<?= base_url('spservices/migrationcertificateahsec/registration/searchdetails') ?>"
                            class="btn btn-sm btn-warning" style="float: right" target="_blank">Apply for Migration
                            Certificate</a></h4>
                    ...
                    <table class="table">
                        ...
                        <tbody id="">
                            ...
                            <tr>
                                <td><?=($key+1)?></td>
                                <td><a href="<?=base_url("spservices/migrationcertificateahsec/registration/applicationpreview/").$obj_id ?>"
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-primary btn-sm mbtn"
                                        href="<?=base_url("spservices/migrationcertificateahsec/registration/index/").$obj_id ?>">Complete
                                        Your Application</a>
                                    <?php }
                                   elseif($value->service_data->appl_status == "submitted"){?>
                                    <a class="btn btn-success btn-sm mbtn"
                                        href="<?=base_url("spservices/migrationcertificateahsec/registration/acknowledgement/").$obj_id ?>">Acknowledgement</a>
                                    <?php } elseif($value->service_data->appl_status == "QS"){
                                    ?>
                                    <a class="btn btn-success btn-sm mbtn"
                                        href="<?=base_url("spservices/migrationcertificateahsec/registration/acknowledgement/").$obj_id ?>">Acknowledgement</a>
                                    <a class="btn btn-warning btn-sm mbtn"
                                        href="<?= base_url('spservices/migrationcertificateahsec/registration/queryform/'.$obj_id)?>">Reply
                                        to query</a>
                                    <?php 
                                    ...
                                    <a class="btn btn-success btn-sm mbtn" title="Query Payment"
                                        href="<?=base_url("spservices/migrationcertificateahsec/payment/querypayment/").$obj_id ?>">Make/Verify
                                        Payment</a>
                                    ...
                                    <form method="post" name="getGRN" id="getGRN"
                                        ...
                                        <input type="hidden" id="ACTION_CODE" name="ACTION_CODE" value="GETCIN"
                                            readonly />
                                        <input type="hidden" id="SUB_SYSTEM" name="SUB_SYSTEM"
                                            value="ARTPS-SP|<?=base_url('spservices/migrationcertificateahsec/payment_response/cin_response')?>" />
                                        <input type="submit" style="margin-top: 3px;color:white" id="submit"
                                            class="btn btn-sm btn-warning mbtn" name="submit" target="_BLANK"
                                            value="Verify Payment" />
                                    </form>
                                    <?php
                                            ...
                                            ?>
                                    <a class="btn btn-warning btn-sm mbtn"
                                        href="<?= base_url('spservices/migrationcertificateahsec/registration/submit_to_backend/'.$obj_id)?>">Verify
                                        Payment</a>
                                    <?php
                                          }else{  ?>
                                    <a class="btn btn-warning btn-sm mbtn"
                                        href="<?= base_url('spservices/migrationcertificateahsec/payment/verify/'.$obj_id)?>">Make/Verify
                                        Payment</a>
                                    <?php }
                                          ?>
                                    <?php }elseif($value->service_data->appl_status == "S" || $value->service_data->appl_status == "QA" || $value->service_data->appl_status == "PR" || $value->service_data->appl_status == "R" || $value->service_data->appl_status == "F" || $value->service_data->appl_status == "AF" ){ ?>
                                    <a class="btn btn-success btn-sm mbtn"
                                        href="<?=base_url("spservices/migrationcertificateahsec/registration/acknowledgement/").$obj_id ?>"
                                   ...
                                   elseif($value->service_data->appl_status == "D"){ ?>
                                    <a class="btn btn-success btn-sm mbtn"
                                        ...
                                        <?php if($value->service_data->service_id=='AHSECMIGR') { ?>
                                        
                                            <a class="btn btn-primary btn-sm mbtn" target="_blank"
                                            href="<?= base_url('spservices/migrationcertificateahsec/registration/download_certificate/'.$obj_id)?>">
                                    ...
                                    <?php }
                                  ?>
                                    <a href="<?=base_url('spservices/migrationcertificateahsec/registration/track/'.$obj_id)?>"
                                        class="btn btn-info btn-sm mbtn">Track</a>
