...
<main class="rtps-container">
    <div class="container my-2">
        <form id="myfrm" method="POST"
            action="<?= base_url('spservices/migrationcertificateahsec/registration/submitfiles') ?>"
            ...
            <div class="card shadow-sm">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select name="hs_marksheet_type" class="form-control">
                                                    <!-- <option value="">Select</option> -->
                                                    <option value="H.S. Final Year Marksheet"
                                                        <?=($hs_marksheet_type === 'H.S. Final Year Marksheet')?'selected':''?>>
                                                        H.S. Final Year Marksheet</option>
                                                </select>
                ...
                <div class="card-footer text-center">
                    ...
                    <a href="<?=site_url('spservices/migrationcertificateahsec/registration/sectionTwo/'.$obj_id)?>"
