                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <div id="live_photo_div" class="row text-center mt-" style="display:none;">
                                                    ...
                                                    <input id="photo_of_the_candidate_data" name="photo_of_the_candidate_data" value=""
                                                        type="hidden" />
                                                    <button id="capture_photo" class="btn btn-warning"
                                                        style="margin:2px auto" type="button">Capture Photo</button>
                                                </div>
                                                <div style="text-align:right">
                                                  <span id="open_camera" class="btn btn-sm btn-success text-white"> Capture <img 
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <?= $this->digilocker_api->digilocker_fetch_btn('hs_reg_card'); ?>
                                            </td>
                                        </tr>
                                        <!-- <tr>
