                ...
                <fieldset class="border border-success table-responsive" style="margin-top:40px">
                    ...
                    <table class="table table-borderless" style="margin-top:0px; margin-bottom:0px;">
                        <tbody style="border-top: none !important">
                            ...
                            <tr>
                                <td>Year of Appearing in HS Final Year Examination / এইচ.এছ.ত উপস্থিত হোৱাৰ বছৰটো।
                            ...
                            <tr>
                                <td>Valid H.S. Final Year Examination Roll/ বৈধ এইচ.এছ. চূড়ান্ত বৰ্ষৰ এডমিট ৰোল<br><strong><?=$ahsec_admit_roll?></strong> </td>
                                <td>Valid H.S. Final Year Examination Number / বৈধ এইচ.এছ. চূড়ান্ত বৰ্ষৰ এডমিট নম্বৰ<br><strong><?=$ahsec_admit_no?></strong> </td>
                            </tr>
