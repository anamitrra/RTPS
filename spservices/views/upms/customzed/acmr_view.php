...
$usersBackward = false;//Since the remaining ACMR services does not have BACKWARD options
                        ...
                        <div class="col-md-12 form-group">
                            ...
                            <select name="forward_to" id="forward_to" class="form-control action-select">
                                ...
                                <?php foreach($usersForward as $fUser) {
                                    ...
                                    //if($fUser->login_username != 'President') echo "<option value='".$roleObj."'>".$fUserText."</option>";
