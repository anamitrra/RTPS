<main class="rtps-container">
    <form method="POST" action="<?= base_url('spservices/bakijai/payment/submit') ?>">
                    ...
                    <fieldset class="border border-success table-responsive" style="margin-top:40px">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control" name="bakijai_certificate_charge" id="bakijai_certificate_charge" value="<?= $bakijai_certificate_charge ?>" readonly />
                                <?= form_error("bakijai_certificate_charge") ?>
                            </div>
                            <div class="col-md-4">
