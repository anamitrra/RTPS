...
<body>    
    <?php if(strlen($aadhaar_no)) { ?>
        <form id="myfrm" method="POST" action="<?= base_url('spservices/employment_aadhaar_based/test/otpverify') ?>">
    ...
    echo "err : ".$xml->attributes()->err."<br>";
        ...
        <form id="myfrm" method="POST" action="<?= base_url('spservices/employment_aadhaar_based/test/otpsend') ?>">
