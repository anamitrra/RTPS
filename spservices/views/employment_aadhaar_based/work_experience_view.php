...
<main class="rtps-container">
    <div class="container my-2">
        <form id="myfrm" method="POST" action="<?= base_url('spservices/employment_aadhaar_based/registration/submit_work_experience') ?>" enctype="multipart/form-data">
            ...
            <div class="card shadow-sm">
                ...
                <div class="card-body" style="padding:5px">
                    ...
                    <fieldset class="border border-success" style="margin-top:40px">
                        ...
                        <div class="row form-group">
                            <div class="col-md-6">
                                <label>Years</label>
                                <input type="text" class="form-control" name="years" id="years" value="<?= $years ?>" maxlength="255" />
                                <?= form_error("years") ?>
                            </div>
                            <div class="col-md-6">
                                <label>Months</label>
                                <input type="text" class="form-control" name="months" id="months" value="<?= $months ?>" maxlength="255" />
                                <?= form_error("months") ?>
                            </div>
                        </div>
                    </fieldset>
                ...
                <div class="card-footer text-center">
                    <a class="btn btn-primary frmbtn" id="DRAFT" href="<?= base_url('spservices/employment-registration/education-skill-details/' . $obj_id) ?>">
