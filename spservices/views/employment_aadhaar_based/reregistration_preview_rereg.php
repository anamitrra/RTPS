        ...
        <div class="card shadow-sm" id="printDiv">
            ...
            <div class="card-footer text-center no-print">
                <?php if($form_status === 'DRAFT') { ?>    
                    <a href="<?=base_url('spservices/employment_aadhaar_based/Reregistration/index/'. $obj_id)?>" class="btn btn-primary">
                        <i class="fa fa-pencil"></i> Edit
                    </a>
                <?php }//End of if ?>
                <a class="btn btn-primary frmbtn" id="DRAFT" href="<?= base_url('spservices/employment-re-registration/enclosures/' . $obj_id) ?>">
