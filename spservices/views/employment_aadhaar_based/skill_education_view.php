...
if ($dbrow) {
    ...
    if (isset($dbrow->form_data->languages_known)) {
        $languages_known = $dbrow->form_data->languages_known;
    } else {
        $check_lang = is_array(set_value("languages_known")) ? COUNT(set_value("languages_known")) : 0;
        if ($check_lang) {
            for ($k = 0; $k < $check_lang; $k++) {
                $languages_known[$k]['language'] = set_value("languages_known")[$k];
                $languages_known[$k]['r_option'] = set_value("read_option")[$k];
                $languages_known[$k]['w_option'] = set_value("write_option")[$k];
                $languages_known[$k]['s_option'] = set_value("speak_option")[$k];
            }
            $languages_known = json_decode(json_encode($languages_known), FALSE);
        } else {
...
<main class="rtps-container">
    <div class="container my-2">
        <form id="myfrm" method="POST" action="<?= base_url('spservices/employment_aadhaar_based/registration/submit_education_details') ?>" enctype="multipart/form-data">
            ...
            <div class="card shadow-sm">
                                            ...
                                            ?>
                                                    <tr>
                                                        ...
                                                        <td class="other_examination_name <?= ($education_qualification[$i]->other_examination_name == '') ? 'd-none' : '' ?>">
                                                            <input name="other_examination_name[]" value="<?= $education_qualification[$i]->other_examination_name ?>" class="form-control " type="text" onKeyPress="return checkValidAlphaWithoutComma(event);" />
                                                        </td>
                                                        <td><input name="major_elective_subject[]" value="<?= $education_qualification[$i]->major__elective_subject ?>" class="form-control" type="text" onKeyPress="return checkValidAlpha(event);" /></td>
                                                        <td><input name="subjects_other_subjects[]" value="<?= $education_qualification[$i]->subjects__other_subjects ?>" class="form-control alpha-only" type="text" onKeyPress="return checkValidAlpha(event);" /></td>
                                                        <td><input name="board_university[]" value="<?= $education_qualification[$i]->board__university ?>" class="form-control" type="text" onKeyPress="return checkValidAlphaWithoutComma(event);" /></td>
                                                        <td><input name="institution_school_college[]" value="<?= $education_qualification[$i]->institution__school__college ?>" class="form-control" type="text" onKeyPress="return checkValidAlphaWithoutComma(event);" /></td>
                                                        ...
                                                        <td><input name="percentage_of_marks[]" value="<?= $education_qualification[$i]->percentage_of_marks ?>" class="form-control float" type="number" min="1" max="100" /></td>
                                                        <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input name="major_elective_subject[]" class="form-control" type="text" onKeyPress="return checkValidAlpha(event);" /></td>
                                                    <td><input name="subjects_other_subjects[]" class="form-control" type="text" onKeyPress="return checkValidAlpha(event);" /></td>
                                                    <td><input name="board_university[]" class="form-control" type="text" onKeyPress="return checkValidAlphaWithoutComma(event);" /></td>
                                                    <td><input name="institution_school_college[]" class="form-control" type="text" onKeyPress="return checkValidAlphaWithoutComma(event);" /></td>
                                                    <td><input name="date_of_passing[]" class="form-control dp" type="text" /></td>
                                                    <td><input name="registration_no[]" class="form-control" type="text" /></td>
                                                    <td><input name="percentage_of_marks[]" class="form-control float" type="number" min="1" max="100" /></td>
                                                    <td>
                                                        <select name="class_division[]" class="form-control" id="">
                                                            <option value="">Please Select</option>
                                                            <option value="1st">1st</option>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="form-check form-check-inline">
                                                            ...
                                                            <input class="form-check-input" type="checkbox" name="read_option_check[]" onclick="$(this).parent().find('input[type=hidden]').val(this.checked ? 'Read' : '')" value="Read" <?= isset($languages_known[$i]->r_option) ? (($languages_known[$i]->r_option === 'Read') ? 'checked' : '') : '' ?>>
                                                        ...
                                                        <div class="form-check form-check-inline">
                                                            ...
                                                            <input class="form-check-input" type="checkbox" name="write_option_check[]" onclick="$(this).parent().find('input[type=hidden]').val(this.checked ? 'Write' : '')" value="Write" <?= isset($languages_known[$i]->w_option) ? (($languages_known[$i]->w_option === 'Write') ? 'checked' : '') : '' ?>>
                                                        ...
                                                        <div class="form-check form-check-inline">
                                                            ...
                                                            <input class="form-check-input" type="checkbox" name="speak_option_check[]" onclick="$(this).parent().find('input[type=hidden]').val(this.checked ? 'Speak' : '')" value="Speak" <?= isset($languages_known[$i]->s_option) ? (($languages_known[$i]->s_option === 'Speak') ? 'checked' : '') : '' ?>>
                ...
                <div class="card-footer text-center">
                    <a class="btn btn-primary frmbtn" id="DRAFT" href="<?= base_url('spservices/employment-registration/address-section/' . $obj_id) ?>">
