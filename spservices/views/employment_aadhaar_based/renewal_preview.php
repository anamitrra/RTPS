        ...
        <div class="card shadow-sm" id="printDiv">
            ...
            <div class="card-body" style="padding:5px">
                    ...
                    <table class="table table-borderless" style="margin-top:0px; margin-bottom:0px;">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><strong><?=isset($dbrow->form_data->education_qualification[$i]->registration_no)? $dbrow->form_data->education_qualification[$i]->registration_no:''?></strong> </td>
                ...
                <?php if($form_status === 'DRAFT') { ?>    
                    <a href="<?=base_url('spservices/employment_aadhaar_based/Registration/index/'. $obj_id)?>" class="btn btn-primary">
                ...
                <?php if($payment_status !== 'PAYMENT_COMPLETED'){
                    if($user_type == 'user'){ ?>
                        <a href="<?=base_url('spservices/employment_aadhaar_based/Payment/ctz_initiate/'. $obj_id)?>" class="btn btn-warning">
                    ...
                    <?php } else{ ?>
                        ...
                        <a href="<?=base_url('spservices/employment_aadhaar_based/Payment/initiate/'. $obj_id)?>" class="btn btn-warning">
                        <i class="fa fa-angle-double-right"></i> Make Payment
                    </a>
                    <?php }//End of if else
                }//End of if ?>
