...
$application_charge = $dbrow->form_data->application_charge;
                        ...
                        <?php if ($amount || ($pfc_payment_status === "Y")) { ?>
                            ...
                            <div class="row">
                                <table>
                                    ...
                                    <?php endif; ?>
                                    <?php if ($application_charge): ?>
                                        <tr>
                                            <td><b>Application Charge:</b></td>
                                            <td><?= $application_charge ?></td>
                                        </tr>
                                    <?php endif; ?>
...
function calculateTotal($dbrow) {
    ...
    if (!empty($dbrow->form_data->pfc_payment_status) && $dbrow->form_data->pfc_payment_status === "Y") {
        ...
        if (!empty($dbrow->form_data->application_charge)) {
            $total += $dbrow->form_data->application_charge;
        }
