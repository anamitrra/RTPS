...
$applications = !empty($kaac_services_CCM) ? $kaac_services_CCM : array();
...
<div class="container">
    <div class="row">
        <div class="col-sm-12 mx-auto">
            <div class="card my-4">
                <div class="card-body">
                    <h4>Certified Copy of Mutation <a href="<?= base_url('spservices/kaac-services/CCM') ?>" class="btn btn-sm btn-warning" style="float: right" target="_blank">Apply for
                            Certified Copy of Mutation</a></h4>
