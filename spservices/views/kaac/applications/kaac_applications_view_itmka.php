...
$applications = !empty($kaac_services_ITMKA) ? $kaac_services_ITMKA : array();
...
<div class="container">
    <div class="row">
        <div class="col-sm-12 mx-auto">
            <div class="card my-4">
                <div class="card-body">
                    <h4>Issuance of Trace Map <a href="<?= base_url('spservices/kaac-services/ITMKA') ?>" class="btn btn-sm btn-warning" style="float: right" target="_blank">Apply for Issuance of Trace Map</a></h4>
