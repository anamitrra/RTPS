...
$applications = !empty($kaac_services_DLP) ? $kaac_services_DLP : array();
...
<div class="container">
    <div class="row">
        <div class="col-sm-12 mx-auto">
            <div class="card my-4">
                <div class="card-body">
                    <h4>Duplicate Copies of Land Patta <a href="<?= base_url('spservices/kaac-services/DLP') ?>" class="btn btn-sm btn-warning" style="float: right" target="_blank">Apply for Duplicate Copies of Land Patta
                            Certificate</a></h4>
