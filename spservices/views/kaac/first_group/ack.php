            ...
            <div class="card my-4 " style="border: 1px solid;padding:20px">
                <div class="card-body">
                  ...
                  <div class="row">
                      ...
                      <br/>
                      <br/>
                      Your application for <strong> <?=isset($response->service_name)?$response->service_name:''?></strong> has been submitted successfully on <strong><?=isset($response->submission_date)?format_mongo_date($response->submission_date):''?></strong> and
