...
<div class="content-wrapper">
    <main class="rtps-container">
        <form id="myfrm" method="POST" action="<?php echo base_url('spservices/mcc_users/district_admin/create') ?>" enctype="multipart/form-data">
            <div class="row">
                <div class="col">
                    <div class="container  my-3">
                        <div class="row">
                            <div class="col">
                                <?php if ($this->session->flashdata('dist_admin_update_success') != null) { ?>
                                ...
                                if ($this->session->flashdata('dist_adimin_creation_error') != null) { ?>
                                    <div class="alert alert-danger alert-dismissible fade show" role="alert">
                                        <strong>Error in inputs : </strong> <?= $this->session->flashdata('dist_adimin_creation_error') ?>
                                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                        </button>
                                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" value="<?= $mobile ?>" name="mobile" class="form-control" id="mobile" placeholder="mobile">
                                    <?= form_error("mobile") ?>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <button id="clrBtn" type="button" class="btn btn-warning">Reset</button>
                            </div>
                        </div>
                    </div>
                </div>
