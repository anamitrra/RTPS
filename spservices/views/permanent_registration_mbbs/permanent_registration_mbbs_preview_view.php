...
// if($dbrow->form_data->state==="Assam"){
//     $state="Assam";
// }
// if($dbrow->form_data->state==="Meghalaya"){
//     $state="Meghalaya";
// }
// else{
//     $state="";
...
$reg_certificate_of_concerned_university_type = $dbrow->form_data->reg_certificate_of_concerned_university_type??'';
$reg_certificate_of_concerned_university = $dbrow->form_data->reg_certificate_of_concerned_university??'';

$mbbs_pass_certificate_from_university_type = $dbrow->form_data->mbbs_pass_certificate_from_university_type??'';
$mbbs_pass_certificate_from_university = $dbrow->form_data->mbbs_pass_certificate_from_university??'';

$permanent_registration_certificate_of_concerned_medical_council_type = $dbrow->form_data->permanent_registration_certificate_of_concerned_medical_council_type??'';
$permanent_registration_certificate_of_concerned_medical_council = $dbrow->form_data->permanent_registration_certificate_of_concerned_medical_council??'';


$noc_from_concerned_medical_council_type = $dbrow->form_data->noc_from_concerned_medical_council_type??'';
$noc_from_concerned_medical_council = $dbrow->form_data->noc_from_concerned_medical_council??'';


$all_documents_related_to_medical_college_details_type = $dbrow->form_data->all_documents_related_to_medical_college_details_type??'';
$all_documents_related_to_medical_college_details = $dbrow->form_data->all_documents_related_to_medical_college_details??'';


$registration_certificate_from_respective_university_or_equivalent_type = $dbrow->form_data->registration_certificate_from_respective_university_or_equivalent_type??'';
$all_documents_related_to_medical_college_details = $dbrow->form_data->all_documents_related_to_medical_college_details??'';


$passport_and_visa_with_travel_details_type = $dbrow->form_data->passport_and_visa_with_travel_details_type??'';
$passport_and_visa_with_travel_details = $dbrow->form_data->passport_and_visa_with_travel_details??'';



$screening_test_result_from_national_board_of_examination_type = $dbrow->form_data->screening_test_result_from_national_board_of_examination_type??'';
$screening_test_result_from_national_board_of_examination = $dbrow->form_data->screening_test_result_from_national_board_of_examination??'';


$eligibility_certificate_from_national_medical_commission_type = $dbrow->form_data->eligibility_certificate_from_national_medical_commission_type??'';
$eligibility_certificate_from_national_medical_commission = $dbrow->form_data->eligibility_certificate_from_national_medical_commission??'';

$mbbs_or_equivalent_degree_pass_certificate_from_university_type = $dbrow->form_data->mbbs_or_equivalent_degree_pass_certificate_from_university_type??'';
$mbbs_or_equivalent_degree_pass_certificate_from_university = $dbrow->form_data->mbbs_or_equivalent_degree_pass_certificate_from_university??'';


$all_marksheets_of_mbbs_or_equivalent_type = $dbrow->form_data->all_marksheets_of_mbbs_or_equivalent_type??'';
$all_marksheets_of_mbbs_or_equivalent = $dbrow->form_data->all_marksheets_of_mbbs_or_equivalent??'';



$registration_certificate_from_respective_university_or_equivalent_type = $dbrow->form_data->registration_certificate_from_respective_university_or_equivalent_type??'';
$registration_certificate_from_respective_university_or_equivalent = $dbrow->form_data->registration_certificate_from_respective_university_or_equivalent??'';
...
<?php if(($dbrow->form_data->study_place == 2) ){ ?> 
                            ...
                            <tr>
                                ...
                                <td style="font-weight:bold"><?=$reg_certificate_of_concerned_university_type?></td>
                                <td>
                                    <?php if(strlen($reg_certificate_of_concerned_university)){ ?>
                                        <a href="<?=base_url($reg_certificate_of_concerned_university)?>" class="btn btn-block font-weight-bold text-success" target="_blank">
                                            <span class="fa fa-download"></span> 
                                            View/Download
                                        </a>
                                    <?php }//End of if ?>
                            ...
                            <tr>
                                ...
                                <td style="font-weight:bold"><?=$mbbs_pass_certificate_from_university_type?></td>
                                <td>
                                    <?php if(strlen($mbbs_pass_certificate_from_university)){ ?>
                                        <a href="<?=base_url($mbbs_pass_certificate_from_university)?>" class="btn btn-block font-weight-bold text-success" target="_blank">
                                            <span class="fa fa-download"></span> 
                                            View/Download
                                        </a>
                                    <?php }//End of if ?>
...
<?php if(($dbrow->form_data->study_place == 3) ){ ?> 
                            ...
                            <tr>
                                ...
                                <td style="font-weight:bold"><?=$registration_certificate_from_respective_university_or_equivalent_type?></td>
                                <td>
                                    <?php if(strlen($registration_certificate_from_respective_university_or_equivalent)){ ?>
                                        <a href="<?=base_url($registration_certificate_from_respective_university_or_equivalent)?>" class="btn btn-block font-weight-bold text-success" target="_blank">
                                            <span class="fa fa-download"></span> 
                                            View/Download
                                        </a>
                                    <?php }//End of if ?>
                            ...
                            <tr>
                                ...
                                <td style="font-weight:bold"><?=$all_marksheets_of_mbbs_or_equivalent_type?></td>
                                <td>
                                
                                    <?php if(strlen($all_marksheets_of_mbbs_or_equivalent)){ ?>
                                        <a href="<?=base_url($all_marksheets_of_mbbs_or_equivalent)?>" class="btn btn-block font-weight-bold text-success" target="_blank">
                                            <span class="fa fa-download"></span> 
                                            View/Download
                                        </a>
                                    <?php }//End of if ?>
                            ...
                            <tr>
                                ...
                                <td style="font-weight:bold"><?=$mbbs_or_equivalent_degree_pass_certificate_from_university_type?></td>
                                <td>
                                    <?php if(strlen($mbbs_or_equivalent_degree_pass_certificate_from_university)){ ?>
                                        <a href="<?=base_url($mbbs_or_equivalent_degree_pass_certificate_from_university)?>" class="btn btn-block font-weight-bold text-success" target="_blank">
                                            <span class="fa fa-download"></span> 
                                            View/Download
                                        </a>
                                    <?php }//End of if ?>
                            ...
                            <tr>
                                ...
                                <td style="font-weight:bold"><?=$eligibility_certificate_from_national_medical_commission_type?></td>
                                <td>
                                    <?php if(strlen($eligibility_certificate_from_national_medical_commission)){ ?>
                                        <a href="<?=base_url($eligibility_certificate_from_national_medical_commission)?>" class="btn btn-block font-weight-bold text-success" target="_blank">
                                            <span class="fa fa-download"></span> 
                                            View/Download
                                        </a>
                                    <?php }//End of if ?>
                            ...
                            <tr>
                                ...
                                <td style="font-weight:bold"><?=$screening_test_result_from_national_board_of_examination_type?></td>
                                <td>
                                    <?php if(strlen($screening_test_result_from_national_board_of_examination)){ ?>
                                        <a href="<?=base_url($screening_test_result_from_national_board_of_examination)?>" class="btn btn-block font-weight-bold text-success" target="_blank">
                                            <span class="fa fa-download"></span> 
                                            View/Download
                                        </a>
                                    <?php }//End of if ?>
                            ...
                            <tr>
                                ...
                                <td style="font-weight:bold"><?=$passport_and_visa_with_travel_details_type?></td>
                                <td>
                                    <?php if(strlen($passport_and_visa_with_travel_details)){ ?>
                                        <a href="<?=base_url($passport_and_visa_with_travel_details)?>" class="btn btn-block font-weight-bold text-success" target="_blank">
                                            <span class="fa fa-download"></span> 
                                            View/Download
                                        </a>
                                    <?php }//End of if ?>
                            ...
                            <tr>
                                ...
                                <td style="font-weight:bold"><?=$all_documents_related_to_medical_college_details_type?></td>
                                <td>
                                    <?php if(strlen($all_documents_related_to_medical_college_details)){ ?>
                                        <a href="<?=base_url($all_documents_related_to_medical_college_details)?>" class="btn btn-block font-weight-bold text-success" target="_blank">
                                            <span class="fa fa-download"></span> 
                                            View/Download
                                        </a>
                                    <?php }//End of if ?>
        ...
        <?php if(($dbrow->form_data->study_place == 2) || ($dbrow->form_data->study_place == 3) ){ ?> 
            ...
            <tr>
                                ...
                                <td style="font-weight:bold"><?=$permanent_registration_certificate_of_concerned_medical_council_type?></td>
                                <td>
                                    <?php if(strlen($permanent_registration_certificate_of_concerned_medical_council)){ ?>
                                        <a href="<?=base_url($permanent_registration_certificate_of_concerned_medical_council)?>" class="btn btn-block font-weight-bold text-success" target="_blank">
                                            <span class="fa fa-download"></span> 
                                            View/Download
                                        </a>
                                    <?php }//End of if ?>
            ...
            <tr>
                                ...
                                <td style="font-weight:bold"><?=$noc_from_concerned_medical_council_type?></td>
                                <td>
                                    <?php if(strlen($noc_from_concerned_medical_council)){ ?>
                                        <a href="<?=base_url($noc_from_concerned_medical_council)?>" class="btn btn-block font-weight-bold text-success" target="_blank">
                                            <span class="fa fa-download"></span> 
                                            View/Download
                                        </a>
                                    <?php }//End of if ?>
