    ...
    <div class="container my-2">
        <div class="card shadow-sm" id="printDiv">
            ...
            <div class="card-footer text-center no-print">
                ...
                <a href="<?= base_url('spservices/delayeddeath/registration/index/' . $obj_id) ?>" class="btn btn-primary">
                ...
                <a href="<?= base_url('spservices/delayeddeath/payment/initiate/' . $obj_id) ?>" class="btn btn-success">
