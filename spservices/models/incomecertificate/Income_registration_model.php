...
class Income_registration_model extends Mongo_model {

    public function __construct() {
        parent::__construct();
        $this->set_collection("incomecertificate_applications");
    }//End of __construct()
    ...
    public function update_payment_status($appl_ref_no,$data){
        ...
        return $this->mongo_db->update('incomecertificate_applications');
    }
}
