...
class Office_user_roles_model extends Mongo_model {
    ...
    function getAllUserRoles() {
        ...
        $users = $this->mongo_db->order_by('role_name', 'ASC')->get($this->table);
    ...
    public function getUniqueUserId($role_name,$di,$last_digit)
	{

		$data = $role_name.$di.$last_digit;
        return $data;
	}
