...
class Registration extends Rtps
{
    ...
    private $serviceName = "Application for Registration of Contractors";
    ...
    public function index($objId = null)
    {
        ...
        $this->load->view('registration_of_contractors/personal_details_reg', $data);
    ...
    public function get_serviceID($deptt, $category)
    {
        ...
        if ($deptt == 'PHED') {
            if ($category == 'Class-II') {
                $service_id = 'CON_REG_PHED_2';
            } else {
                $service_id = 'CON_REG_PHED_1';
            }
        } else if ($deptt == 'PWDB') {
            if ($category == 'Class-II') {
                $service_id = 'CON_REG_PWDB_2';
            } else {
                $service_id = 'CON_REG_PWDB_1';
            }
        } else if ($deptt == 'PWDNH') {
            if ($category == 'Class-II') {
                $service_id = 'CON_REG_PWDNH_2';
            } else {
                $service_id = 'CON_REG_PWDNH_1';
            }
        }
        else if ($deptt == 'WRD') {
            if ($category == 'Class-II') {
                $service_id = 'CON_REG_WRD_2';
            } else {
                $service_id = 'CON_REG_WRD_1';
            }
        }
        else if ($deptt == 'GMC') {
            if ($category == 'Class-II') {
                $service_id = 'CON_REG_GMC_2';
            } else {
                $service_id = 'CON_REG_GMC_1';
            }
        }
    ...
    public function get_serviceName($service_id)
    {
        switch ($service_id) {
            case 'CON_REG_PWDB_1':
              return "Application for Registration of Contractors PWD Building (Class-I)";
              break;
            case 'CON_REG_PWDB_2':
              return "Application for Registration of Contractors PWD Building (Class-II)";
              break;
            case 'CON_REG_PHED_1':
              return "Application for Registration of Contractors PHED (Class-I)";
              break;
            case 'CON_REG_PHED_2':
              return "Application for Registration of Contractors PHED (Class-II)";
              break;
            case 'CON_REG_WRD_1':
              return "Application for Registration of Contractors WRD (Class-I)";
              break;
            case 'CON_REG_WRD_2':
              return "Application for Registration of Contractors WRD (Class-II)";
              break;
    ...
    public function submit_personal_details($objId = null)
    {
        ...
        else if(($this->input->post("deptt_name") == "WRD") || ($this->input->post("deptt_name") == "PWDNH"))
        {
            if ($this->input->post("category") == 'Class-II') {
                $this->form_validation->set_rules("circle", "Circle", "required");
            }
        ...
        if($this->input->post('applicant_type') == 'Individual')
        {
            ...
            if($this->input->post("deptt_name") === "GMC") {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            if (strlen($objId)) {
                ...
                $newArray['service_data.service_name'] = $serviceName;
        ...
        redirect('spservices/registration_of_contractors/address-section/' . $obj_id);
        }
      }
    ...
    public function address($objId = null)
    {
        ...
        $this->load->view('includes/frontend/header');
        $this->load->view('registration_of_contractors/address_details_reg', $data);
        $this->load->view('includes/frontend/footer');
    }
    ...
    public function submit_address_details()
    {
        ...
        if ($this->input->post("applicant_type") == 'Individual') {
            ...
            $unset_data = 'form_data.communication_address';
            $this->unsetdata($objId, $unset_data);
            $unset_data = 'form_data.permanent_address';
            $this->unsetdata($objId, $unset_data);
        }
        ...
        redirect('spservices/registration_of_contractors/work-section/' . $objId);
     }
    }
    ...
    public function work($objId = null)
    {
        ...
        $this->load->view('includes/frontend/header');
        $this->load->view('registration_of_contractors/work_details_reg', $data);
        $this->load->view('includes/frontend/footer');
    }
    ...
    public function submit_work_details()
    {
        ...
        if (($deptt_code == "GMC" && $category == "Class-II") || $category_of_regs == 'Unemployed Graduate Engineer' || $category_of_regs == 'Unemployed Diploma Engineer') {
        ...
        redirect('spservices/registration_of_contractors/machinery-section/' . $objId);
        }
     }
    }
    ...
    public function machinery($objId = null)
    {
        ...
        $this->load->view('includes/frontend/header');
        $this->load->view('registration_of_contractors/machinery_details_reg', $data);
        $this->load->view('includes/frontend/footer');
    }
    ...
    public function submit_machinery_details()
    {
        ...
        redirect('spservices/registration_of_contractors/turnover-section/' . $objId);
     }
    }
    ...
    public function turnover($objId = null)
    {
        ...
        $this->load->view('includes/frontend/header');
        $this->load->view('registration_of_contractors/turnover_details_reg', $data);
        $this->load->view('includes/frontend/footer');
    }
    ...
    public function submit_turnover_details()
    {
        ...
        $category = $dbRow->form_data->category;
        $category_of_regs = $dbRow->form_data->category_of_regs;
        if (($deptt_code == "GMC") && ($category == "Class-II")) {
        ...
        redirect('spservices/registration_of_contractors/history-section/' . $objId);
        }
     }
    }
    ...
    public function history($objId = null)
    {
        ...
        $this->load->view('includes/frontend/header');
        $this->load->view('registration_of_contractors/history_details_reg', $data);
        $this->load->view('includes/frontend/footer');
    }
    ...
    public function submit_history_details()
    {
        ...
        redirect('spservices/registration_of_contractors/attachments-section/' . $objId);
     }
    }
    ...
    public function attachments($objId = null)
    {
        ...
        $this->load->view('includes/frontend/header');
        $this->load->view('registration_of_contractors/attachments_up_reg', $data);
        $this->load->view('includes/frontend/footer');
    }
    ...
    public function submit_enclosures()
    {
        ...
        $this->employment_model->update_where(['_id' => new ObjectId($objId)], $data);
        redirect('spservices/registration_of_contractors/preview/' . $objId);
    }
    ...
    function preview($objId = null)
    {
        ...
        $this->load->view('includes/frontend/header');
        $this->load->view('registration_of_contractors/regs_preview', $data);
        $this->load->view('includes/frontend/footer');
    }
    ...
    public function finalsubmition($objId = null)
    {
        if ($objId) {
            ...
            if (!empty($dbRow->form_data->pfc_payment_response->GRN) && ($dbRow->form_data->pfc_payment_response->STATUS === "Y")) {
                ...
                $exc_zone = array("Karbi Anglong A.C.", "Dima Hasaon A.C.", "BTAD Zone");
                if($deptt_code == 'PHED' && in_array($zone, $exc_zone))
                {
                    ...
                    if($category == 'Class-II') {
                        ...
                        $userFilter = array('user_services.service_code' => $serviceId, 'zone_circle' => $circle, 'dept_info.dept_code' => $deptt_code, 'user_levels.level_no' => 1, 'status' => 1);
                    } else {
                    ...
                    // else if ($deptt_code == 'PWDNH') {// Why this code?
                    // $userFilter = array('user_services.service_code' => $serviceId,'dept_info.dept_code' =>$deptt_code,
                    // 'user_levels.level_no' => 1, 'status' => 1, 'zone_info.zone_name' => null,'zone_circle' => $circle);
                    // }
                    else{
                    $userFilter = array('user_services.service_code' => $serviceId, 'zone_info.zone_name' => $zone, 'dept_info.dept_code' => $deptt_code, 'user_levels.level_no' => 1, 'status' => 1);
                    }
                ...
                $smsData = [
                    ...
                    'service_name' => 'Registration of Contractors',
    ...
    function getDepttName($deptt_code)
    {
        if ($deptt_code == 'PHED') {
            ...
            $departmentName = "Assam Public Works (National Highway) Department";
        } else if ($deptt_code == 'GMC') {
            $departmentName = "Guwahati Municipal Corporation";
        } 
        else {
