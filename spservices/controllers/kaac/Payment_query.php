...
class Payment_query extends Rtps
{
    ...
    public function application_submission($obj_id,$service_id){
        $service_ids = array("CCJ", "DCTH", "CCM", "NECKA","LVC","LRCC","LHOLD","ITMKA","DLP");
    ...
    private function check_query_payment_status($DEPARTMENT_ID = null) {
        if ($DEPARTMENT_ID) {
            ...
            $ref = modules::load('spservices/kaac/Payment_query_response');
        ...
        if (count((array) $dbRow)) {
            ...
            $data['query_payment'] = true;
                ...
                $data['department_data'] = array(
                    ...
                    "SUB_SYSTEM" => "ARTPS-SP|" . base_url('spservices/kaac/payment_query_response/response'),
