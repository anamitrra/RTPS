    ...
    public function response()
    {
        ...
        if ($_POST['STATUS'] === 'Y') {
            ...
            if ($this->checkgrn($DEPARTMENT_ID, true) === $_POST['GRN']) {
                ...
                if ($transaction_data->form_data->service_id === "EMP_A_REG") {
                ...
                if ($transaction_data->form_data->service_id === "EMP_A_RENEW") {
                    $ref = modules::load('spservices/employment_aadhaar_based/Renewal');
                    $ref->finalsubmition($transaction_data->_id->{'$id'}, true);
                    //redirect(base_url('spservices/prc/Acknowledgement/acknowledgement/') . $transaction_data->_id->{'$id'});
                }
                if ($transaction_data->form_data->service_id === "EMP_A_RE_REG") {
    ...
    public function cin_response()
    {
        ...
        if (!empty($_POST)) {
            if (!empty($_POST['DEPARTMENT_ID'])) {
                ...
                $res=$this->employment_model->update_row(array('form_data.department_id' => $DEPARTMENT_ID), array(
