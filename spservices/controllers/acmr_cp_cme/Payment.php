...
class Payment extends Rtps
{
    ...
    public function __construct()
    {
        ...
        $this->load->helper('payment'); // added sbk
    ...
    public function application_submission($obj_id, $service_id)
    {
        if ($service_id === $this->serviceId) {
            $ref = modules::load('spservices/acmr_cp_cme/registration');
    ...
    private function check_pfc_payment_status($DEPARTMENT_ID = null)
    {
        if ($DEPARTMENT_ID) {
            ...
            $ref = modules::load('spservices/acmr_cp_cme/Payment_response');
    ...
    public function initiate($obj_id = null)
    {
        ...
        if (count((array) $dbRow)) {
            ...
            if (!empty($this->session->userdata('role'))) {
                ...
                $this->load->view('acmr_cp_cme/kiosk_payment', $data);
        ...
        if (count((array) $dbRow)) {
            ...
            if ($this->slug === "user") {
                $data['department_data'] = array(
                    ...
                    "SUB_SYSTEM" => "ARTPS-SP|" . base_url('spservices/acmr_cp_cme/payment_response/response'),
                    ...
                    "MULTITRANSFER" => "Y",
                    "NON_TREASURY_PAYMENT_TYPE" => "03",
                    "TOTAL_NON_TREASURY_AMOUNT" => $application_charge + $this->convenience_fee + $gst,	
                    "AC1_AMOUNT" => $application_charge + $gst,
                    "ACCOUNT1" => "DME29458", //$user->account1,$account = "PFC23362";
                ...
                $data['department_data'] = array(
                    ...
                    "MULTITRANSFER" => "Y",
                    "NON_TREASURY_PAYMENT_TYPE" => "03",
                    "TOTAL_NON_TREASURY_AMOUNT" => $total_amount + $application_charge + $this->convenience_fee + $gst,
                    "AC1_AMOUNT" => $application_charge + $gst,
                    "ACCOUNT1" => "DME29458", //$user->account1,
                    "AC2_AMOUNT" => $total_amount + $this->convenience_fee ,
                    "ACCOUNT2" => "ARI64576",
                );
               //pre($data);
              if ($this->slug === "CSC") {
                    ...
                    $data['department_data']['ACCOUNT1'] = "DME82092";
                    $data['department_data']['AC2_AMOUNT'] = $total_amount+ $this->convenience_fee + $gst;
                    $data['department_data']['ACCOUNT2'] =  "ARI64576";
                   // $data['department_data']['AC3_AMOUNT'] = $this->config->item('rtps_convenience_fee');
                    ...
                    $data['department_data']['AC1_AMOUNT'] = $application_charge;
                    $data['department_data']['ACCOUNT1'] = "DME82092";
                    $data['department_data']['AC2_AMOUNT'] = $total_amount + $this->config->item('rtps_convenience_fee')+ $gst;
                    $data['department_data']['ACCOUNT2'] = "ARI64576";
                }
