...
class Payment_response extends Frontend
{
    ...
    public function response()
    {
        ...
        $this->registration_model->update_row(array('form_data.department_id' => $DEPARTMENT_ID), array("form_data.pfc_payment_status" => $_POST['STATUS'], "form_data.pfc_payment_response" => $response));
        if ($_POST['STATUS'] === 'Y') { 
            ...
            if ($this->checkgrn($DEPARTMENT_ID, true) === $_POST['GRN']) { 
                ...
                $service_ids = array("AHSECDRC", "AHSECDADM", "AHSECDMRK", "AHSECDPC");
                if(in_array($transaction_data->service_data->service_id, $service_ids)){ 
                    $ref=modules::load('spservices/duplicatecertificateahsec/registration');
                ...
                $this->registration_model->update_row(array('form_data.department_id' => $DEPARTMENT_ID), array("form_data.pfc_payment_status" => "P", "form_data.pfc_payment_response.STATUS" => 'P'));
                $this->show_error();
            }
    ...
    public function cin_response()
    {
        ...
        if (!empty($_POST)) {
            if (!empty($_POST['DEPARTMENT_ID'])) {
                ...
                $this->registration_model->update_row(array('form_data.department_id' => $DEPARTMENT_ID), array(
