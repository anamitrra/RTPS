...
class Actions extends Upms
{
  ...
  public function generate_certificate($appl_no = null)
  {
    ...
    // $link = base_url('spservices/acmr_reg_of_addl_degrees/' . $pdata[0]->_id->{'$id'});
    ...
    $html = $this->load->view('acmr_reg_of_addl_degrees/output_certificate', array('data' => $pdata,'qr' => $qr_file_name,'certificate_no' => $certificate_no), true);
