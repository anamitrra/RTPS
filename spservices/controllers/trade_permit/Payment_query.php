...
class Payment_query extends Rtps
{
    ...
    private function check_query_payment_status($DEPARTMENT_ID = null) {
        if ($DEPARTMENT_ID) {
            ...
            $ref = modules::load('spservices/trade_permit/Payment_query_response');
    ...
    public function initiate($obj_id = null) {
        ...
        if (count((array) $dbRow)) {
            ...
            $this->tradepermit_model->update_where(['_id' => new ObjectId($obj_id)], array('service_data.appl_status'=>'FRS')); //Update status  
    ...
    private function payment_make($obj_id = null)
    {
        ...
        if (count((array) $dbRow)) {
            ...
            $data['department_data'] = array(
                ...
                "SUB_SYSTEM" => "ARTPS-SP|" . base_url('spservices/trade_permit/Payment_query_response/response'),
