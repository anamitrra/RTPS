    ...
    public function initiate($obj_id = null)
    {
        ...
        if (count((array) $dbRow)) {
            ...
            if (!empty($this->session->userdata('role'))) {
                ...
                $this->load->view('kaac_noc_trade_license/kaac_noctl_kiosk_payment', $data);
        ...
        if (count((array) $dbRow)) {
            ...
            if ($this->slug === "user") {
                ...
                $data['department_data'] = array(
                    ...
                    "SUB_SYSTEM" => "ARTPS-SP|" . base_url('spservices/kaac_noc_trade_license/Payment_response/response'),
