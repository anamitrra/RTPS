    ...
    public function submit() {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            if (strlen($objId)) {
                ...
                redirect('spservices/marriageregistration/bridedetails/index/' . $objId);
            } else {
                ...
                if ($insert) {
                    ...
                    if ($submitMode === 'SAVE_NEXT') {
                        ...
                        redirect('spservices/marriageregistration/bridedetails/index/' . $objectId);
                    } else {
                        $this->session->set_flashdata('success', 'Your application has been successfully drafted');
                        redirect('spservices/marriageregistration/applicantdetails/index/' . $objectId);
                    }//End of if else
                } else {
