...
class Payment extends Rtps {
    ...
    private function check_pfc_payment_status($DEPARTMENT_ID = null) {
        if ($DEPARTMENT_ID) {
            ...
            $ref = modules::load('spservices/marriageregistration/paymentresponse');
    ...
    public function application_submission($obj_id) {
        ...
        $paymentresponse = modules::load('spservices/marriageregistration/paymentresponse');
    ...
    public function initiate($obj_id = null) {
        ...
        if ($dbRow) {
            ...
            if (!empty($this->session->userdata('role'))) {
                ...
                $this->load->view('marriageregistration/payment_view', $data);
                ...
                if (strlen($treasuryCode) && strlen($officeCode)) {
                    ...
                    if ($serviceRow) {
                        ...
                        $data['department_data'] = array(
                            ...
                            "SUB_SYSTEM" => "ARTPS-SP|" . base_url('spservices/marriageregistration/paymentresponse/paymentmade'),
                        );
