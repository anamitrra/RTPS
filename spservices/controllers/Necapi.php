...
class Necapi extends frontend {
    ...
    public function verifycertificate($objId = null) {
        ...
        if (count((array) $dbRow)) {
            ...
            $this->load->view('nec/verifycertificate_view', $data);
    ...
    public function get_circles() {
        ...
        if($httpCode == 404) {
            $data1 = array(
                ...
                "log_msg" => "Circles : Page not found at {$getUrl}",
                "log_status" => 2
            );
            $this->logreports_model->insert($data1);
            echo "<select class='form-control'><option value=''>Page not found at {$getUrl}</option></select>";
        } elseif(isset($error_msg)) {
            $data2 = array(
                "log_time" => new UTCDateTime(strtotime(date('d-m-Y g:i a')) * 1000),
                "log_msg" => "Circles : CURL ERROR : {$error_msg}",
                "log_status" => 2
            );
    ...
    public function get_mouzas() {
        ...
        if($httpCode == 404) {
            $data1 = array(
                "log_time" => new UTCDateTime(strtotime(date('d-m-Y g:i a')) * 1000),
                "log_msg" => "Mouzas : Page not found at {$getUrl}",
                "log_status" => 2
            );
            $this->logreports_model->insert($data1);
            echo "<select class='form-control'><option value=''>Page not found at {$getUrl}</option></select>";
            ...
            $data2 = array(
                "log_time" => new UTCDateTime(strtotime(date('d-m-Y g:i a')) * 1000),
                "log_msg" => "Mouzas : CURL ERROR : {$error_msg}",
                "log_status" => 2
            );
            $this->logreports_model->insert($data2);
            echo "<select class='form-control'><option value=''>CURL ERROR : {$error_msg}</option></select>";
    ...
    public function get_villages() {
        ...
        if($httpCode == 404) {
            $data1 = array(
                "log_time" => new UTCDateTime(strtotime(date('d-m-Y g:i a')) * 1000),
                "log_msg" => "Villages : Page not found at {$getUrl}",
                "log_status" => 2
            );
            $this->logreports_model->insert($data1);
            echo "<select class='form-control'><option value=''>Page not found at {$getUrl}</option></select>";
            ...
            $data2 = array(
                "log_time" => new UTCDateTime(strtotime(date('d-m-Y g:i a')) * 1000),
                "log_msg" => "Villages : CURL ERROR : {$error_msg}",
                "log_status" => 2
            );
            $this->logreports_model->insert($data2);
            echo "<select class='form-control'><option value=''>CURL ERROR : {$error_msg}</option></select>";
