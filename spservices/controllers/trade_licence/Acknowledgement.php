...
class Acknowledgement extends Rtps {
    ...
    public function index() {
        ...
        $data['applications'] = $this->tradelicence_model->get_rows($fillter);
   ...
   public function acknowledgement($objid) {
        $applicationRow = $this->tradelicence_model->get_by_doc_id($objid);
        if ($applicationRow) {
            //pre($applicationRow);
            ...
            $this->load->view('includes/frontend/header');
            $this->load->view('trade_licence/ack', $data);
            $this->load->view('includes/frontend/footer');
        } else {
