...
class Kaacincomeapi extends frontend
{
        ...
        if (!empty($resObj)) {
            ...
            if ($status === 'QS') {
                if (strlen($applId) < 9) {
                    ...
                    $dbrow = $this->kaac_registration_model->get_row(array('service_data.appl_id' => (int)$applId, "form_data.service_id" => $this->serviceId));
                ...
                if (strlen($applId) < 9) {
                    ...
                    if (!empty($dbrow)) {
                        ...
                        if (!is_dir($dirPath)) {
                            ...
                            file_put_contents($dirPath . "index.html", '<html><head></head><body>This directory contains files for kaac only</body></html>');
                        }
