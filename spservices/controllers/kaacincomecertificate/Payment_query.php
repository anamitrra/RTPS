...
class Payment_query extends Rtps
{
    ...
    private function check_query_payment_status($DEPARTMENT_ID = null) {
        if ($DEPARTMENT_ID) {
            ...
            $ref = modules::load('spservices/kaacincomecertificate/Payment_query_response');
        ...
        if (count((array) $dbRow)) {
            ...
            $data['query_payment'] = true;
                ...
                $data['department_data'] = array(
                    ...
                    "SUB_SYSTEM" => "ARTPS-SP|" . base_url('spservices/kaacincomecertificate/payment_query_response/response'),
