...
class Payment extends Rtps
{
    ...
    {
        $service_ids = array("ICERT");
        if(in_array($service_id, $service_ids)){ 
            $ref = modules::load('spservices/kaacincomecertificate/registration');
    ...
    private function check_pfc_payment_status($DEPARTMENT_ID = null)
    {
        if ($DEPARTMENT_ID) {
            ...
            $ref = modules::load('spservices/kaacincomecertificate/Payment_response');
    ...
    public function initiate($obj_id = null)
    {
        ...
        if (count((array) $dbRow)) {
            ...
            if (!empty($this->session->userdata('role'))) {
                ...
                $this->load->view('kaacincomecertificate/kaac_income_kiosk_payment', $data);
        ...
        if (count((array) $dbRow)) {
            ...
            if ($this->slug === "user") {
                $data['department_data'] = array(
                    ...
                    "SUB_SYSTEM" => "ARTPS-SP|" . base_url('spservices/kaacincomecertificate/Payment_response/response'),
