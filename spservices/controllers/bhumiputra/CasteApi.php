...
class CasteApi extends frontend {
    ...
    public function update_data() { 
        ...
        if(count((array)$dbrow)) {
            ...
            if($status === 'QS') {
                ...
                //Sending Query SMS
                $sms=array(
                    "mobile" => (int)$dbrow->form_data->contact_number,
                ...
                if (!is_dir($dirPath)) {
                    ...
                    file_put_contents($dirPath . "index.html", '<html><head></head><body>This directory contains files for Caste Certificate only</body></html>');
                }
