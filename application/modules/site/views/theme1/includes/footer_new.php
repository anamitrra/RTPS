            ...
            <div class="row gy-4 g-lg-0">
                ...
                <div class="col-12 col-md-6 col-lg-3 mb-4 mb-md-0">
                    ...
                    <section class="recent-updates mb-2">
                        ...
                        <article class="py-1 mb-1">
                            <div>
                                <img width="16" height="16" src="<?= base_url('assets/site/theme1/images/phone.png') ?>" alt="Phone icon">
                        ...
                        <article class="py-1">
                            <div>
                                <img width="16" height="16" src="<?= base_url('assets/site/theme1/images/email.png') ?>" alt="Email icon">
                                <span class="dept-text text-white fw-bold small">
                    ...
                    <section class="social-links mt-2">
                        ...
                        <?php foreach ($footer->help_deks->social_links->links as $link) : ?>
                            ...
                            <a href="<?= $link->link ?>" title="<?= $link->title ?>" class="d-inline-block me-1" target="_blank" rel="noopener noreferrer">
                                <img width="25" height="25" src="<?= base_url($link->img_path) ?>" alt="social icon">
                            </a>
                ...
                <div class="col-12 col-md-6 col-lg-3">
                    ...
                    <div class="w-75 visitors d-none border border-light border-1 rounded-0 p-2 d-flex justify-content-start align-items-start">
                        ...
                        <img width="30" height="30" src="<?= base_url('assets/site/theme1/images/feedbackicon.png') ?>" alt="visitor icon">
                ...
                <div class="col-12 col-md-6 col-lg-3">
                    ...
                    <a href="<?= $footer->nodal->link->url ?>" class="dept-text small text-decoration-none" target="_blank" rel="noopener noreferrer">
                        <img class="d-inline-block me-1" width="16" height="16" src="<?= base_url('assets/site/theme1/images/agency.png') ?>" alt="agency logo">
                    ...
                    <img class="d-block" style="transform: translateX(-17px);" width="188" height="86" src="<?= base_url('assets/site/theme1/images/nic.png') ?>" alt="NIC logo">
        ...
        <div class="chatwindow rounded shadow-lg border">
            ...
            <div class="panel-body msg_container_base rounded">
                ...
                <div class="chatbox rounded-bottom p-3  p-3 d-flex justify-content-center align-items-center">
                    ...
                    <button type="button" class="btn rtps-btn">Start Over <i class="ms-2 fa fa-redo" aria-hidden="true"></i>
                    </button>
                </div>
            </div>
        </div>
