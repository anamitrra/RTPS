                ...
                <div class="col-lg-12 wow fadeInUp" data-wow-delay="0.3s">
                    ...
                    <section class="sub-cat-filters mb-5 d-flex gap-3 p-3">
                        <?php foreach ($sub_categs->sub_categories as $key => $val) : ?>
                            <button type="button" class="btn service-cat-btn d-flex flex-column align-items-center justify-content-around gap-2 <?= $key === 0 ? 'service-cat-btn__focus' : '' ?>" data-subcat="<?= $val->en ?>" data-categ="15">
