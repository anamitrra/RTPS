                ...
                <?php if ($role === 'System Administrator') : ?>
                    ...
                    <div class="tab-pane fade show active" id="add-service" role="tabpanel" aria-labelledby="service-tab">
                        ...
                        <div class="form-group">
                            ...
                            <div>
                                <input name="service_as" type="text" placeholder="assamese" value="<?= $service_info->service_name->as ?? ''; ?>">
                            </div>
                            <div>
                                <input name="service_bn" type="text" placeholder="bangla" value="<?= $service_info->service_name->bn ?? ''; ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div>
                                <label for="cat_id"><span class="text-danger font-weight-bold">*</span> Select a Category:</label>
                            </div>
                        ...
                        <div class="form-group">
                            <div>
                                <label for="sub_cat"><span class="text-danger font-weight-bold">*</span> Select a Sub-Category:</label>
                            </div>

                            <select id="sub_cat" name="sub_cat" required data-subcat="<?= $service_info->sub_cat ?? '' ?>">
                        ...
                        <!-- MIS ID -->
                        <div class="form-group">
                            <label for="service_url">MIS ID for This Service: </label><br>
                            <input type="text" id="mis_id" name="mis_id" placeholder="mis id" value="<?= $service_info->mis_id ?? ''; ?>">
                        </div>
                        ...
                        <!-- Integrated Service Type (EODB/RTPS) -->
                        <div class="form-group">
                            <p class="font-weight-bold d-inline-block mr-3"><span class="text-danger font-weight-bold">*</span> Integrated Service Type: </p>

                            <input type="radio" id="service_type_none" name="service_type" value="NA" <?= (($service_info->service_type ?? 'NA') == 'NA') ? 'checked' : '' ?>>
                            <label class="font-weight-normal" for="service_type_none">N/A</label>

                            <input type="radio" id="service_type_rtps" name="service_type" value="RTPS" <?= (($service_info->service_type ?? '') == 'RTPS') ? 'checked' : '' ?>>
                        ...
                        <!-- External ServicePlus Service (EODB only for NOW) -->
                        <div class="form-group">
                            <p class="font-weight-bold d-inline-block mr-3"><span class="text-danger font-weight-bold">*</span> External Service Type: </p>

                            <select name="ext_service_type" id="ext_service_type">
                                <option value="NA" <?= (($service_info->ext_service_type ?? 'NA') == 'NA') ? 'selected' : '' ?>>N/A</option>
                                <option value="EODB" <?= (($service_info->ext_service_type ?? '') == 'EODB') ? 'selected' : '' ?>>EODB</option>
                            </select>
