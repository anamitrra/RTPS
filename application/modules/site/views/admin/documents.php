...
<div class="modal fade" id="docsModel" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <?= form_open( base_url("site/admin/documents/delete_document") ); ?>
    ...
    <div class="content-header">
        <div class="container-fluid">
            ...
            <section class="text-right">
                <a class="btn btn-secondary" href="<?= base_url("site/admin/documents/upload_document"); ?>" role="button">
...
$(document).ready(function(){
    ...
    const table = $('#my-table')
        .DataTable({
            ...
            deferRender: true,
            ajax: {
                url: '<?= base_url("site/admin/documents/all_docs_api"); ?>',
                dataSrc: ''
            },
            columns: [
                { data: 'sl_no' },
                ...
                { 
                    ...
                    render: function(data, type, row, meta) {
                        ...
                        return type === 'display' ? `
                        <a title="view/edit" href="<?= base_url("site/admin/documents/upload_document/")?>${data['$id']}">

                        
                        <i class="fas fa-edit fa-lg mr-2"></i>
                        </a>

                        <a title="delete" class="delete" data-ob_id="${data['$id']}" href="#">
