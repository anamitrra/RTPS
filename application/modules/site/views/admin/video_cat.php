...
<div class="modal fade" id="videoModel" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <?= form_open( base_url("site/admin/videos_category/delete_video_cat") ); ?>

        <div class="modal-body">
            <h4>Delete this Video Category ?</h4>
            <p>This will delete relevant videos as well.</p>
...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            ...
            <div class="row mb-4">
                <div class="col-sm-8">
                    <h1 class="m-0 text-dark">Video Categories</h1>
                </div>
                <div class="col-sm-4">
            ...
            <section class="text-right">
                ...
                <a class="btn btn-secondary " href="<?= base_url("site/admin/videos_category/add_video_category"); ?>" role="button">
...
$(document).ready(function(){
    ...
    const table = $('#my-table')
        .DataTable({
            ...
            deferRender: true,
            ajax: {
                url: '<?= base_url("site/admin/videos_category/video_category_api"); ?>',
                dataSrc: ''
            },
            columns: [
                { data: 'sl_no' },
                ...
                { 
                    ...
                    render: function(data, type, row, meta) {
                        ...
                        return type === 'display' ? `
                        <a title="view/edit" href="<?= base_url("site/admin/videos_category/add_video_category/")?>${row.short_name}">
