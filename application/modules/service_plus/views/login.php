            ...
            <div class="login-box">
                ...
                <div class="card mt-4">
                    <div class="card-body login-card-body">
                        <form id="login-form" action="<?php echo base_url("service_plus/login/loginMe"); ?>" method="post">
                            ...
                            <div class="form-group d-flex justify-content-between">
                                ...
                                <a href="<?php echo base_url('service_plus/login/forgot-password') ?>">Forgot password?</a>
                            </div>
                            <div class="form-group">
...
<script type="text/javascript">
    ...
    const refreshCaptchaURL = '<?=base_url('service_plus/refresh-captcha')?>';
    $(function(){
