          ...
          <div class="card-body">
            <table class="table table-striped">
              <tbody>
                ...
                <tr>
                  <td></td>
                  <td><a href="<?php echo base_url('mis/users'); ?>" class="btn btn-default">Close</a>
                  </td>
                </tr>
              </tbody>
            </table>
        ...
        <div class="card">
          ...
          <div class="card-body">
            <form class="form-inline">
              ...
              <a href="<?php echo base_url('users'); ?>" class="btn btn-default mb-2 mr-2">Close</a>
...
<script>
  ...
  function changePassword() {
    ...
    $.ajax({
        url: '<?=base_url("mis/users/change_user_password");?>',
        type: 'POST',
        data: {
