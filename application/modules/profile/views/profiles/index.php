...
if(isset($photo) && !empty($photo)){
    ...
    $avatar=base_url("storage/images/avatar.jpg");
}
?>
<style>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-8">
                            <form method="post" id="profile-update" action="<?= base_url('profile/update') ?>">
                                <div class="row">
                                    ...
                                    <div class="col-6 form-group">
                                        ...
                                        <input type="tel" name="phone" class="form-control" value="<?= $mobile ?>" maxlength="10" minlength="10" required>
                                    </div>
...
<script>
    $(document).ready(function() {
        ...
        $el1.fileinput({
            theme: 'fas',
            uploadUrl: '<?= base_url("profile/upload_Profile") ?>',
