<div class="d-flex justify-content-center">
    <div class="row">
        <div class="col-md-12">
            ...
            <h3 class="text-center my-2 mt-4">Public Grievance</h3>
            <div class="login-box">
                ...
                <div class="card">
                    <div class="card-body login-card-body">
                        <form id="login-form" action="<?=base_url('grm/admin/login/process'); ?>" method="POST">
                            <h4 class="login-box-msg my-1">Log in</h4>
                            <?php $this->load->helper('form'); ?>
                            <div class="row">
                                <div class="col-md-3">
                                    <?php echo validation_errors('<div class="alert alert-danger alert-dismissable">', ' <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>'); ?>
                                </div>
                            </div>
                            <?php
...
<!--                                <a href="--><?php //echo base_url() ?><!--grievance/login/forgot-password">Forgot password?</a>-->
                            </div>
...
<script type="text/javascript">
    ...
    const refreshCaptchaURL = '<?=base_url('grm/refresh-captcha')?>';
    $(function(){
