...
$route['spservices/generate_certificate/(:any)']['GET'] = 'registration_of_contractors/registration/generate_certificate/$1';
...
//Renewal of Contractors Routes: Author: Abhijit
...
//End of Renewal of Contractors Routes: Author: Abhijit
...
//Route for Gap  Permission Certificate added by Bishwajit

$route['spservices/gap-permission-certificate-ahsec-details']['GET'] = 'gappermissioncertificateahsec/registration/details';
$route['spservices/gap-permission-certificate-searchdeatails-ahsec']['POST'] = 'gappermissioncertificateahsec/registration/searchdetails_submit';
...
$route['spservices/kaac-services']['POST'] = 'kaac/registration/submit';

// Business Registration Certificate karbi anglong , Renewal of Business Registration -nitul
$route['spservices/kaac-brc/(:any)']['GET'] = 'kaac_brc/registration/index/$1';
$route['spservices/kaac-brc']['POST'] = 'kaac_brc/registration/submit';

$route['spservices/kaac-farmer']['GET'] = 'kaac_farmer/registration/index';
$route['spservices/kaac-farmer']['POST'] = 'kaac_farmer/registration/submit';
//Start of kaac income certificate//
$route['spservices/kaac-incomecertificate']['GET'] = 'kaacincomecertificate/registration/index';
$route['spservices/kaac-incomecertificate']['POST'] = 'kaacincomecertificate/registration/submit';

//Start of kaac NOC trade License//
$route['spservices/kaac-noc-trade-license']['GET'] = 'kaac_noc_trade_license/registration/index';
$route['spservices/kaac-noc-trade-license']['POST'] = 'kaac_noc_trade_license/registration/submit';
