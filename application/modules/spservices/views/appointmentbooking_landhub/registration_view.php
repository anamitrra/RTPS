...
<script type="text/javascript">   
    $(document).ready(function () {
        ...
        var getRefNos = function(sroCode) {
            $.ajax({
                type: "POST",
                url: "<?=base_url('spservices/appointmentbooking_landhub/registration/get_refnos')?>",
        ...
        var getAppointmentDates = function(appointment_type) {
            $.ajax({
                type: "POST",
                url: "<?=base_url('spservices/appointmentbooking_landhub/registration/get_holidays')?>",
        ...
        $(document).on("change", "#appointee_ref_no", function(){
            ...
            if(appointee_ref_no.length === 0) {
                ...
                $.ajax({
                    type: "POST",
                    dataType: "json",
                    url: "<?=base_url('spservices/appointmentbooking_landhub/registration/get_mrgdetails')?>",
...
<main class="rtps-container">
    <div class="container my-2">
        <form id="myfrm" method="POST" action="<?= base_url('spservices/appointmentbooking_landhub/registration/submit') ?>" enctype="multipart/form-data">
