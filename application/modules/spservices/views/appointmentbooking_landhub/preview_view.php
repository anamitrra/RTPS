    ...
    <div class="container my-2">
        <div class="card shadow-sm" id="printDiv">
            ...
            <div class="card-footer text-center no-print">
                <?php if($status === 'DRAFT') { ?>
                    <a href="<?=base_url('spservices/appointmentbooking_landhub/registration/index/'.$obj_id)?>" class="btn btn-primary">
                ...
                <?php if($payment_status !== 'PAID') { ?>    
                    <a href="<?=base_url('spservices/appointmentbooking_landhub/payment/initiate/'.$obj_id)?>" class="btn btn-warning frmsbbtn">
