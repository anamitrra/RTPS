...
if ($dbrow) {
    ...
    $last_registration_copy = isset($dbrow->form_data->enclosures->last_registration_copy) ? $dbrow->form_data->enclosures->last_registration_copy : ($uploadedFiles['last_registration_copy'] ?? null);
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("#last_registration_copy").fileinput({
            dropZoneEnabled: false,
            showUpload: false,
            showRemove: false,
            required: true,
...
<main class="rtps-container">
    <div class="container my-2">
        <form id="myfrm" method="POST" action="<?= base_url('spservices/registration_of_contractors/registration/submit_enclosures') ?>" enctype="multipart/form-data">
            ...
            <input name="last_registration_copy_old" type="hidden" value="<?= $any_other_docs ?>" />
                    ...
                    <fieldset class="border border-success" style="margin-top: 0px">
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <?php } ?>
                                <tr>
                                    <td>Copy of last registration</td>
                                    <td>
                                        <div class="file-loading">
                                            <input id="last_registration_copy" name="last_registration_copy" type="file" />
                                        </div>
                                        <?php if (strlen($last_registration_copy)) { ?>
                                            <a href="<?= base_url($last_registration_copy) ?>" class="btn font-weight-bold text-success" target="_blank">
                                                <span class="fa fa-download"></span>
                                                View/Download
                                            </a>
                                        <?php } ?>
                                        <input class="last_registration_copy" type="hidden" name="last_registration_copy_temp">
                                        <?= form_error("last_registration_copy") ?>
                                    </td>
                                </tr>
                                <tr>
