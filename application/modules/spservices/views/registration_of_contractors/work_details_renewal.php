...
<main class="rtps-container">
    <div class="container-fluid my-2">
        <form id="myfrm" method="POST" action="<?= base_url('spservices/registration_of_contractors/renewal/submit_work_details') ?>" enctype="multipart/form-data">
            ...
            <div class="card shadow-sm">
                ...
                <div class="card-body" style="padding:5px">
                    ...
                    <fieldset class="border border-success deed_div" style="margin-top:10px">
                        <legend class="h6">Works executed as <?= $prime?> contractor in the last <?= $year_label?><?php if($deptt_code != 'WRD' && ($category_of_regs != 'Unemployed Graduate Engineer' && $category_of_regs != 'Unemployed Diploma Engineer')) { ?><?php } ?> </legend>
                        <div class="row">
                            <div class="col-md-12 table-responsive">
                    ...
                    <?php } ?>
                    <fieldset class="border border-success deed_div" style="margin-top:10px">
                        <legend class="h6">Key Personnel for works and administration</legend>
                        <div class="row">
                            <div class="col-md-12 table-responsive">
