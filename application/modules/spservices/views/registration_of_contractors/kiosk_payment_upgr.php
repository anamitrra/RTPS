<main class="rtps-container">
    <form method="POST" action="<?= base_url('spservices/registration_of_contractors/Payment_upgr/submit') ?>">
                    ...
                    <fieldset class="border border-success table-responsive" style="margin-top:40px">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="service_charge" id="service_charge"
                                    value="<?= $service_charge ?>" readonly />
                                <?= form_error("service_charge") ?>
                            </div>
                            <div class="col-md-6">
                                <label>Number of printing page<span class="text-danger">*</span> </label>
                                <input type="text" class="form-control" name="no_printing_page" id="no_printing_page"
                                    value="<?= $no_printing_page ?>" />
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="no_scanning_page" id="no_scanning_page"
                                    value="<?= $no_scanning_page ?>" />
