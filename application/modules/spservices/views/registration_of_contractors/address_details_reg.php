...
<main class="rtps-container">
    <div class="container my-2">
        <form id="myfrm" method="POST" action="<?= base_url('spservices/registration_of_contractors/registration/submit_address_details') ?>" enctype="multipart/form-data">
            ...
            <div class="card shadow-sm">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-md-6">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input address_same" type="radio" name="same_as_communication_address" id="dcsYes" value="Yes"/>
                                    <label class="form-check-label" for="dcsYes">YES</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input address_same" type="radio" name="same_as_communication_address" id="dcsNo" value="No"/>
                ...
                <div class="card-footer text-center">
                    <a class="btn btn-primary frmbtn" id="DRAFT" href="<?= base_url('spservices/registration_of_contractors/personal-details/'. $obj_id) ?>">
