...
$(document).on("change", "#deptt_name", function() {
    ...
    if (deptt_code == 'PWDB' || deptt_code === 'PWDNH' || deptt_code === 'GMC') {
        $('#category_of_regs option[value="Contractor from other department"]').remove();
    } else if (deptt_code != '' && deptt_code != 'PWDB' && deptt_code !== 'PWDNH' && deptt_code !== 'GMC') {
...
function getOfficeDetails(val) 
{
    ...
    if (deptt_code != '' && deptt_code != 'PWDB' && deptt_code !== 'PWDNH' && deptt_code != 'GMC') {
        if (val == 'Class-II') {
            $("#category_of_regs").html(`<select name="category_of_regs" id="category_of_regs" class="form-control">
                                    <option value="">Please Select</option>
                                    <option value="Contractor from other department" <?= ($category_of_regs === "Contractor from other department") ? 'selected' : '' ?>>Contractor from other department</option>
...
<main class="rtps-container">
    <div class="container my-2">
        <form id="myfrm" method="POST" action="<?= base_url('spservices/registration_of_contractors/registration/submit_personal_details') ?>" enctype="multipart/form-data">
                        ...
                        <div class="row form-group">
                            <div class="col-md-6">
                                ...
                                <select name="deptt_name" id="deptt_name" class="form-control">
                                    <option value="">Please Select</option>
                                    <option value="PHED" <?= ($deptt_name === "PHED") ? 'selected' : '' ?>>Public Health Engineering</option>
                                    <option value="PWDB" <?= ($deptt_name === "PWDB") ? 'selected' : '' ?>>Public Works Department (Building)</option>
                                    <option value="PWDNH" <?= ($deptt_name === "PWDNH") ? 'selected' : '' ?>>Public Works Department (NH)</option>
                                    <option value="WRD" <?= ($deptt_name === "WRD") ? 'selected' : '' ?>>Water Resources</option>
                                    <option value="GMC" <?= ($deptt_name === "GMC") ? 'selected' : '' ?>>Guwahati Municipal Corporation</option>
                                </select>
                        ...
                        <div class="row form-group ind_div">
                            ...
                            <div class="col-md-2" id="age_div">
                                ...
                                <input type="text" class="form-control" name="age" id="age" value="<?= $age ?? ''?>"
                                    autocomplete="off" placeholder="Age" pattern="[0-9]+" title="please enter number only" />
                                <?= form_error("age") ?>
                            </div>
                            <div class="col-md-2">
