    ...
    <div class="container my-2">
        <div class="card shadow-sm" id="printDiv">
            ...
            <div class="card-footer text-center no-print">
                ...
                <?php 
                if ($status == 'QS') { ?>
                    <button class="btn btn-success" id="finalBtn" type="button" onclick="location.href='<?= base_url('spservices/registration_of_contractors/renewal/submit_query/' . $obj_id) ?>'">
                        <i class="fa fa-check"></i> Final Submit
                    </button>
                    <a class="btn btn-primary frmbtn" id="DRAFT" href="<?= base_url('spservices/renewal-of-contractors/attachments-section/' . $obj_id) ?>">
                ...
                <?php } else { ?>
                    <?php if ($payment_status !== 'Y') { ?>
                        ...
                        <?php if ($user_type == 'user') { ?>
                            <a href="<?= base_url('spservices/registration_of_contractors/Rpayment/initiate/' . $obj_id) ?>" class="btn btn-warning">
