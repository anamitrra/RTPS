                ...
                <div class="d-flex" style="margin-bottom: 20px;">
                    ...
                    <div class="row" style="font-size: 14px;">
                        <p style="text-align: justify; line-height: 24px">
                            The following Contractor is hereby upgraded to <b><?=$category?></b> Category under <?= $deptt?> and
                            the <b>Registration</b> number is hereby alloted for the year <b><?php echo $valid_year_range;?></b>.
                            <br>
                            <?php if ($response->form_data->deptt_name == 'WRD') { ?>
