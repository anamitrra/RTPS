...
<main class="rtps-container">
    <div class="container my-2">
        <form id="myfrm" method="POST" action="<?= base_url('spservices/registration_of_contractors/registration/submit_turnover_details') ?>" enctype="multipart/form-data">
            ...
            <div class="card shadow-sm">
                ...
                <div class="card-body" style="padding:5px">
                    ...
                    <?php } else { ?>
                        <legend class="h6">Financial Turnover in the last <?= $year?> years<?php if(!($deptt_code == 'GMC' && $category == 'Class-II')) {?><span class="text-danger">*</span><?php } ?> </legend>
                    <?php } ?>
                        <div class="row">
                            <div class="col-md-12">
                ...
                <div class="card-footer text-center">
                    <a class="btn btn-primary frmbtn" id="DRAFT" href="<?= base_url('spservices/registration_of_contractors/machinery-section/'. $obj_id) ?>">
