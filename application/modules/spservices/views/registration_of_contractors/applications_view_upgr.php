        ...
        <div class="card my-4">
            <div class="card-body">
                ...
                Upgradation of Contractors
                    <a href="<?= base_url('spservices/upgradation_of_contractors') ?>" class="mybtn" target="_blnk">
                ...
                <?php if ($upgr_of_contractors) : ?>
                    <table class="table">
                        ...
                        <tbody id="">
                            <?php
                            foreach ($upgr_of_contractors as $key => $dbrow) :
                                if(!$dbrow)
                                {
                                    continue;
                                }
                                ...
                                <tr>
                                    <td><?= ($key + 1) ?></td>
                                    <td class="txt"><a href="<?= base_url('spservices/upgradation_of_contractors/view/' . $obj_id) ?>"><?= $dbrow->service_data->appl_ref_no ?></td>
                                    ...
                                    <td>
                                        <?php if ($status == "DRAFT") { ?>
                                            <a class="btn btn-primary btn-sm mbtn" href="<?= base_url("spservices/upgradation_of_contractors/personal-details/") . $obj_id ?>">Complete Your Application</a>
                                        ...
                                        ?>
                                            <a class="btn btn-success btn-sm mbtn" href="<?= base_url("spservices/registration_of_contractors/acknowledgement/") . $obj_id ?>">Acknowledgement</a>
                                            <a href="<?= base_url('spservices/registration_of_contractors/track/' . $obj_id) ?>" class="btn btn-secondary btn-sm mbtn">Track</a>
                                            <a class="btn btn-warning btn-sm mbtn" href="<?= base_url('spservices/upgradation_of_contractors/personal-details/' . $obj_id) ?>">Reply to query</a>
                                            <?php
                                            ...
                                            ?>
                                                <form method="post" name="getGRN" id="getGRN" action="<?= $this->config->item('egras_grn_cin_url') ?>">
                                                    ...
                                                    <input type="hidden" id="SUB_SYSTEM" name="SUB_SYSTEM" value="ARTPS-SP|<?= base_url('spservices/registration_of_contractors/Payment_response_upgr/cin_response') ?>" />
                                            ...
                                            ?>
                                                <a class="btn btn-warning btn-sm mbtn" href="<?= base_url('spservices/registration_of_contractors/upgradation/finalsubmition/' . $obj_id) ?>">Verify Payment</a>
                                            <?php
                                            } else {  ?>
                                                <a class="btn btn-warning btn-sm mbtn" href="<?= base_url('spservices/registration_of_contractors/Payment_upgr/verify/' . $obj_id) ?>">Make/Verify Payment</a>
                                            <?php }
                                            ?>
