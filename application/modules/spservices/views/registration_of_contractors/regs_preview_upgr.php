...
$affidavit_license_expired = isset($dbrow->form_data->enclosures->affidavit_license_expired) ? $dbrow->form_data->enclosures->affidavit_license_expired : '';
$forwarding_letter = isset($dbrow->form_data->enclosures->forwarding_letter) ? $dbrow->form_data->enclosures->forwarding_letter : '';
    ...
    <div class="container my-2">
        <div class="card shadow-sm" id="printDiv">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                Contractor's Registration (Upgradation)
                                </h1>
                            </td>
                    ...
                    <fieldset class="border border-success" style="margin-top:5px">
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <?php if($affidavit_license_expired!=''){?>
                                <tr>
                                    <td>Affidavit for expired/lapsed</td>
                                    <td>
                                ...
                                <?php if($forwarding_letter!=''){?>
                                <tr>
                                    <td>Forwarding Letter</td>
                                    <td>
            ...
            <div class="card-footer text-center no-print">
                ...
                if(!$flg) { 
                if ($status == 'QS') { ?>
                    <button class="btn btn-success" id="finalBtn" type="button" onclick="location.href='<?= base_url('spservices/registration_of_contractors/upgradation/submit_query/' . $obj_id) ?>'">
                        <i class="fa fa-check"></i> Final Submit
                    </button>
                    <a class="btn btn-primary frmbtn" id="DRAFT" href="<?= base_url('spservices/upgradation_of_contractors/attachments-section/' . $obj_id) ?>">
                ...
                <?php } else { ?>
                    <?php if ($payment_status !== 'Y') { ?>
                        ...
                        <?php if ($user_type == 'user') { ?>
                            <a href="<?= base_url('spservices/registration_of_contractors/Payment_upgr/initiate/' . $obj_id) ?>" class="btn btn-warning">
