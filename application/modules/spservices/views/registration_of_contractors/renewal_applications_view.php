        ...
        <div class="card my-4">
            <div class="card-body">
                <h4>
                    ...
                    <a href="<?= base_url('spservices/renewal-of-contractors') ?>" class="mybtn" target="_blnk">
                ...
                <?php if ($renewal_of_contractors) : ?>
                    <table class="table">
                        ...
                        <tbody id="">
                            <?php
                            foreach ($renewal_of_contractors as $key => $dbrow) :
                                if(!$dbrow)
                                {
                                    continue;
                                }
                                ...
                                <tr>
                                    <td><?= ($key + 1) ?></td>
                                    <td class="txt"><a href="<?= base_url('spservices/renewal-of-contractors/view/' . $obj_id) ?>"><?= $dbrow->service_data->appl_ref_no ?></td>
                                    ...
                                    <td>
                                        <?php if ($status == "DRAFT") { ?>
                                            <a class="btn btn-primary btn-sm mbtn" href="<?= base_url("spservices/renewal-of-contractors/personal-details/") . $obj_id ?>">Complete Your Application</a>
                                        <?php } elseif ($status == "submitted") { ?>
                                            <a class="btn btn-success btn-sm mbtn" href="<?= base_url("spservices/renewal-of-contractors/acknowledgement/") . $obj_id ?>">Acknowledgement</a>
                                            <a href="<?= base_url('spservices/renewal-of-contractors/track/' . $obj_id) ?>" class="btn btn-secondary btn-sm mbtn">Track</a>
                                        <?php } elseif ($status == "QS") {
                                        ?>
                                            <a class="btn btn-success btn-sm mbtn" href="<?= base_url("spservices/renewal-of-contractors/acknowledgement/") . $obj_id ?>">Acknowledgement</a>
                                            <a href="<?= base_url('spservices/renewal-of-contractors/track/' . $obj_id) ?>" class="btn btn-secondary btn-sm mbtn">Track</a>
                                            <a class="btn btn-warning btn-sm mbtn" href="<?= base_url('spservices/renewal-of-contractors/personal-details/' . $obj_id) ?>">Reply to query</a>
                                            <?php
                                            ...
                                            ?>
                                                <form method="post" name="getGRN" id="getGRN" action="<?= $this->config->item('egras_grn_cin_url') ?>">
                                                    ...
                                                    <input type="hidden" id="SUB_SYSTEM" name="SUB_SYSTEM" value="ARTPS-SP|<?= base_url('spservices/renewal-of-contractors/Rpayment_response/cin_response') ?>" />
                                            ...
                                            ?>
                                                <a class="btn btn-warning btn-sm mbtn" href="<?= base_url('spservices/registration_of_contractors/renewal/finalsubmition/' . $obj_id) ?>">Verify Payment</a>
                                            <?php
                                            } else {  ?>
                                                <a class="btn btn-warning btn-sm mbtn" href="<?= base_url('spservices/renewal-of-contractors/Rpayment/verify/' . $obj_id) ?>">Make/Verify Payment</a>
                                            <?php }
                                            ?>
                                        <?php } elseif ($status == "S" || $status == "QA" || $status == "PR" || $status == "R" || $status == "F" || $status == "AF") { ?>
                                            <a class="btn btn-success btn-sm mbtn" href="<?= base_url("spservices/renewal-of-contractors/acknowledgement/") . $obj_id ?>">Acknowledgement</a>
                                            <a href="<?= base_url('spservices/employment-registration-nonaadhaar/track/' . $obj_id) ?>" class="btn btn-secondary btn-sm mbtn">Track</a>
