    ...
    if($levelRows) {
        foreach($levelRows as $lRow) {
            if(count($levelRow->level_rights)) {
                ...
                $level_rights = array_unique(array_merge($level_rights, $lRow->level_rights), SORT_REGULAR);
            }//End of if
        }//End of foreach()
    }//End of if        
}//End of if
...
// echo '<pre>'; pre($filterForward); '</pre>'; die;
?>
