...
if ($dbrow) {
    ...
    $court_fee_type = isset($dbrow->form_data->court_fee_type) ? $dbrow->form_data->court_fee_type : '';
    $court_fee = isset($dbrow->form_data->court_fee) ? $dbrow->form_data->court_fee : '';
    $paymentreceipt_type = isset($dbrow->form_data->paymentreceipt_type) ? $dbrow->form_data->paymentreceipt_type : '';
    $paymentreceipt = isset($dbrow->form_data->paymentreceipt) ? $dbrow->form_data->paymentreceipt : '';
...
<main class="rtps-container">
    <div class="container my-2">
        <form id="myfrm" method="POST" action="<?= base_url('spservices/bakijai-clearance-certificate') ?>" enctype="multipart/form-data">
            ...
            <input name="court_fee_type" value="<?= $court_fee_type ?>" type="hidden" />
            <input name="court_fee" value="<?= $court_fee ?>" type="hidden" />
            <input name="paymentreceipt_type" value="<?= $paymentreceipt_type ?>" type="hidden" />
            <input name="paymentreceipt" value="<?= $paymentreceipt ?>" type="hidden" />
                ...
                <div class="card-body" style="padding:5px">
                    ...
                    <fieldset class="border border-success">
                        ...
                        <ol style="  margin-left: 24px; margin-top: 20px">
                            <li>The certificate will be delivered within 5 Days of application.</li>
                            <li>প্ৰমাণ পত্ৰ ৫ দিনৰ ভিতৰত প্ৰদান কৰা হ'ব</li>
                        </ol>

                        <strong style="font-size:16px;  margin-top: 10px">Fees/Charges/ মাছুল :</strong>
                        <ul style="  margin-left: 24px; margin-top: 10px">
                            <li>1. User/Statutory charges -Rs. 20</li>
                            <li>১. ব্যৱহাৰকাৰী/ স্থায়ী মাচুল - ২০ টকা</li>
