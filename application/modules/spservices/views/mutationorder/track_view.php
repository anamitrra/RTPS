            ...
            <div class="card-body">
                <table class="table  table-sm" id="application_list_table">
                    <tr>
                        ...
                        <td>
                            <p style="font-size:16px ; text-align:right "><b>Application Receiving Date : <?php echo date('d/m/Y', strtotime($this->mongo_db->getDateTime($dbrow->service_data->created_at))); ?></b></p>
                        </td>
                    </tr>
                </table>
