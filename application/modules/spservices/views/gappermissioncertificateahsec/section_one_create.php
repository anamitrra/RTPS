...
if($dbrow) {
    ...
    $applicant_name = !empty(set_value("father_name"))? set_value("father_name"):(isset($dbrow->form_data->father_name)? $dbrow->form_data->father_name: "");//$dbrow->form_data->applicant_name;
    ...
    $pa_district = !empty(set_value("pa_district"))? set_value("pa_district"):(isset($dbrow->form_data->pa_district)? $dbrow->form_data->pa_district: "");// $dbrow->form_data->pa_district?? '';
    $pa_pincode = !empty(set_value("pa_pincode"))? set_value("pa_pincode"):(isset($dbrow->form_data->pa_pincode)? $dbrow->form_data->pa_pincode: "");//$dbrow->form_data->pa_pincode?? '';
