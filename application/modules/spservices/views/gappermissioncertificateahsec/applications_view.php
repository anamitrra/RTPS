...
<?php 
$applications = !empty($gapahsecs) ? $gapahsecs : array();
...
<div class="container">
    <div class="row">
        <div class="col-sm-12 mx-auto">
            <div class="card my-4">
                <div class="card-body">
                    <h4>Registration of Gap Certificate <a
                            href="<?= base_url('spservices/gappermissioncertificateahsec/registration/details') ?>"
                    ...
                    <table class="table">
                        ...
                        <tbody id="">
                            ...
                            <tr>
                                <td><?=($key+1)?></td>
                                <td><a href="<?=base_url("spservices/gappermissioncertificateahsec/registration/applicationpreview/").$obj_id ?>"
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-primary btn-sm mbtn"
                                        href="<?=base_url("spservices/gappermissioncertificateahsec/registration/index/").$obj_id ?>">Complete
                                        Your Application</a>
                                    <?php }
                                   elseif($value->service_data->appl_status == "submitted"){?>
                                    ...
                                    <a class="btn btn-warning btn-sm mbtn"
                                        href="<?= base_url('spservices/gappermissioncertificateahsec/registration/queryform/'.$obj_id)?>">Reply
                                        to query</a>
                                    <?php 
                                    ...
                                    <a class="btn btn-success btn-sm mbtn" title="Query Payment"
                                        href="<?=base_url("spservices/gappermissioncertificateahsec/payment/querypayment/").$obj_id ?>">Make/Verify
                                        Payment</a>
                                    ...
                                    <form method="post" name="getGRN" id="getGRN"
                                        ...
                                        <input type="hidden" id="ACTION_CODE" name="ACTION_CODE" value="GETCIN"
                                            readonly />
                                        <input type="hidden" id="SUB_SYSTEM" name="SUB_SYSTEM"
                                            value="ARTPS-SP|<?=base_url('spservices/gappermissioncertificateahsec/payment_response/cin_response')?>" />
                                        <input type="submit" style="margin-top: 3px;color:white" id="submit"
                                            class="btn btn-sm btn-warning mbtn" name="submit" target="_BLANK"
                                            value="Verify Payment" />
                                    </form>
                                    <?php
                                            ...
                                            ?>
                                    <a class="btn btn-warning btn-sm mbtn"
                                        href="<?= base_url('spservices/gappermissioncertificateahsec/registration/submit_to_backend/'.$obj_id)?>">Verify
                                        Payment</a>
                                    <?php
                                          }else{  ?>
                                    <a class="btn btn-warning btn-sm mbtn"
                                        href="<?= base_url('spservices/gappermissioncertificateahsec/payment/verify/'.$obj_id)?>">Make/Verify
                                        Payment</a>
                                    <?php }
                                          ?>
                                   ...
                                   elseif($value->service_data->appl_status == "D"){ ?>
                                    <a class="btn btn-success btn-sm mbtn"
                                        ...
                                        <?php if($value->service_data->service_id=='AHSECGAP') { ?>
                                        
                                            <a class="btn btn-primary btn-sm mbtn" target="_blank"
                                            href="<?= base_url('spservices/gappermissioncertificateahsec/registration/download_certificate/'.$obj_id)?>">
                                    ...
                                    <?php }
                                  ?>
                                    <a href="<?=base_url('spservices/gappermissioncertificateahsec/registration/track/'.$obj_id)?>"
