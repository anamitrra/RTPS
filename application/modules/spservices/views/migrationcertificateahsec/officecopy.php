...
$Roll = ((!empty($marksheet_data->Roll)) ? $marksheet_data->Roll : "") ?? '';

if($Roll !=null && is_numeric($Roll))
{
    $Roll = str_pad($Roll, 4, '0', STR_PAD_LEFT);
}

$No = ((!empty($marksheet_data->No)) ? $marksheet_data->No : "NA") ?? '';
...
<div class="certificate-container">
        ...
        <div class="certificate-text" style="display: flex;">
            ...
            <div style="width: 30%">
                <img src="<?=base_url($dbrow->form_data->photo_of_the_candidate)?>" style="width:90px; margin: 3px; float: right;" />
            </div>
        </div>
        ...
        <?php
        if ($dbrow->service_data->service_id == "AHSECMIGR")
        ...
        Year of Appearing H.S. Final year Examination : <b><?= $ahsec_yearofpassing ?></b><br>  
