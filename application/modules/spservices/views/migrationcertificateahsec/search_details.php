...
<main class="rtps-container">
    <div class="container my-2">
        <form id="myfrm" method="POST" action="<?= base_url('spservices/migrationcertificateahsec/registration/searchdetails_submit') ?>"
            ...
            <div class="card shadow-sm">
                ...
                <div class="card-body" style="padding:5px">
                    ...
                    <fieldset class="border border-success" style="margin-top:40px">
                        ...
                        <div class="row form-group">
                            <div class="col-md-6">
                                <label>Valid H.S. Final Year Examination Admit Roll/ বৈধ এইচ.এছ.  চূড়ান্ত বৰ্ষৰ এডমিট ৰোল  </label>
                            ...
                            <div class="col-md-6">
                                <label>Valid H.S. Final Year Examination Admit Number / বৈধ এইচ.এছ.  চূড়ান্ত বৰ্ষৰ এডমিট নম্বৰ \ </label>
