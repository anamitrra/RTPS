...
if($dbrow) {
    ...
    $ahsec_country_seeking = !empty(set_value("ahsec_country_seeking"))? set_value("ahsec_country_seeking"):(isset($dbrow->form_data->ahsec_country_seeking)? $dbrow->form_data->ahsec_country_seeking: "");
    //$dbrow->form_data->ahsec_country_seeking ?? '';
    $board_seaking_adm = !empty(set_value("board_seaking_adm"))? set_value("board_seaking_adm"):(isset($dbrow->form_data->board_seaking_adm)? $dbrow->form_data->board_seaking_adm: "");//$dbrow->form_data->board_seaking_adm ?? '';
    $course_seaking_adm = !empty(set_value("course_seaking_adm"))? set_value("course_seaking_adm"):(isset($dbrow->form_data->course_seaking_adm)? $dbrow->form_data->course_seaking_adm: "");//$dbrow->form_data->course_seaking_adm ?? '';
    $state_seaking_adm = !empty(set_value("state_seaking_adm"))? set_value("state_seaking_adm"):(isset($dbrow->form_data->state_seaking_adm)? $dbrow->form_data->state_seaking_adm: "");//$dbrow->form_data->state_seaking_adm ?? ''; 
    $reason_seaking_adm = !empty(set_value("reason_seaking_adm"))? set_value("reason_seaking_adm"):(isset($dbrow->form_data->reason_seaking_adm)? $dbrow->form_data->reason_seaking_adm: "");//$dbrow->form_data->reason_seaking_adm ?? '';   
    $postal = !empty(set_value("postal"))? set_value("postal"):(isset($dbrow->form_data->postal)? $dbrow->form_data->postal: "");//$dbrow->form_data->postal ?? '';  
                ...
                <div class="card-body" style="padding:5px">
                    ...
                    <fieldset class="border border-success" style="margin-top:40px">
                        ...
                        <div class="row ">
                            ...
                            <div class="form-group col-md-6">
                                <label>State where seeking admission/ ৰাজ্যৰ ক’ত নামভৰ্তি বিচাৰিছে সেই কথা উল্লেখ কৰক<span
                                        class="text-danger">*</span> </label>
