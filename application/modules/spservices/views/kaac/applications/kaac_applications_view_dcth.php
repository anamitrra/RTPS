...
<?php
$applications = !empty($kaac_services_DCTH) ? $kaac_services_DCTH : array();
...
<div class="container">
  <div class="row">
    <div class="col-sm-12 mx-auto">
      <div class="card my-4">
        <div class="card-body">
          <h4>Certified copy of Chitha <a href="<?= base_url('spservices/kaac-services/DCTH') ?>" class="btn btn-sm btn-warning" style="float: right" target="_blank">Apply for Chitha
              Certificate</a></h4>
