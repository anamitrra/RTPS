...
$applications = !empty($kaac_services_LVC) ? $kaac_services_LVC : array();
...
<div class="container">
    <div class="row">
        <div class="col-sm-12 mx-auto">
            <div class="card my-4">
                <div class="card-body">
                    <h4>Land Valuation Certificate <a href="<?= base_url('spservices/kaac-services/LVC') ?>" class="btn btn-sm btn-warning" style="float: right" target="_blank">Apply for Land Valuation Certificate</a></h4>
