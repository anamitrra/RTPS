...
$applications = !empty($kaac_services_NECKA) ? $kaac_services_NECKA : array();
...
<div class="container">
    <div class="row">
        <div class="col-sm-12 mx-auto">
            <div class="card my-4">
                <div class="card-body">
                    <h4>Non-Encumbrance Certificate <a href="<?= base_url('spservices/kaac-services/NECKA') ?>" class="btn btn-sm btn-warning" style="float: right" target="_blank">Apply for Non-Encumbrance Certificate</a></h4>
