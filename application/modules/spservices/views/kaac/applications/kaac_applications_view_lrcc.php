...
$applications = !empty($kaac_services_LRCC) ? $kaac_services_LRCC : array();
...
<div class="container">
    <div class="row">
        <div class="col-sm-12 mx-auto">
            <div class="card my-4">
                <div class="card-body">
                    <h4>Land Revenue Clearance Certificate <a href="<?= base_url('spservices/kaac-services/LRCC') ?>" class="btn btn-sm btn-warning" style="float: right" target="_blank">Apply for Land Revenue Clearance Certificate</a></h4>
