...
$applications = !empty($kaac_services_LHOLD) ? $kaac_services_LHOLD : array();
...
<div class="container">
    <div class="row">
        <div class="col-sm-12 mx-auto">
            <div class="card my-4">
                <div class="card-body">
                    <h4>Land Holding Certificate <a href="<?= base_url('spservices/kaac-services/LHOLD') ?>" class="btn btn-sm btn-warning" style="float: right" target="_blank">Apply for Land Holding Certificate</a></h4>
