...
$p_police_st = $dbrow->form_data->police_station;
            ...
            <div class="card-body" style="padding:5px">
                ...
                <fieldset class="border border-success table-responsive" style="margin-top:40px">
                    ...
                    <table class="table table-borderless" style="margin-top:0px; margin-bottom:0px;">
                        <tbody style="border-top: none !important">
                            <tr>
                                <td>Circle Name/ সম্পূৰ্ণ স্থায়ী ঠিকনা<br><strong><?= $circle_office ?></strong> </td>
                                <td>Mouza Name/ ৰাজ্য<br><strong><?= $mouza_name ?></strong> </td>
                                <td>Revenue Village/ জিলা<br><strong><?= $revenue_village ?></strong></td>
                            </tr>
                            <tr>
