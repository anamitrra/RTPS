...
$applications = !empty($karbi_krbcs) ? $karbi_krbcs : array();
...
<div class="container">
  <div class="row">
    <div class="col-sm-12 mx-auto">
      <div class="card my-4">
        <div class="card-body">
          <h4>Renewal Of Business Registration Certificate <a
                            href="<?= base_url('spservices/kaac_brc/registration/index/KRBC') ?>"
