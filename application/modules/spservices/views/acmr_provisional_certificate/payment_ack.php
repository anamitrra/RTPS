        ...
        <div class="col-sm-12 mx-auto">
            <div class="card my-4 " style="border: 1px solid;padding:20px">
                <div class="card-body">
                  ...
                  <div class="row akno">
                    <span><u>Acknowledgement No: </u><strong><?= $dbrow->service_data->appl_ref_no ?></strong>
                    </span>
                     <span style="float: right;"><u>Payment Date:</u><strong><?= $dbrow->form_data->query_payment_response->ENTRY_DATE ?></strong></span>
                   </div>
                  <div class="row">
                      ...
                      <br/>
                      <br/>
                      Your payment has been made successfully on <strong></strong> and
                      your Acknowledgement No. is <strong><?= $dbrow->service_data->appl_ref_no ?></strong>. Please use this Acknowledgement
                  ...
                  <div class="row">
                       <p>Payment Ref. No:<strong><?= $dbrow->form_data->query_payment_response->GRN ?></strong></p>

                    </div>

                  <!-- fee description -->
                  <?php if (!empty($dbrow->form_data->query_payment_response->AMOUNT)) { ?>
                    ...
                    <div class="row">
                          <table>
                            ...
                            <?php endif; ?>
                              ...
                              <tr>
                                <td><b>Total:</b></td>
                                <td><?=$dbrow->form_data->query_payment_response->AMOUNT?></td>
                              </tr>
