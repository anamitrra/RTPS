...
<?php
$applications = !empty($kaac_farmer) ? $kaac_farmer : array();
    ...
    <div class="col-sm-12 mx-auto">
      <div class="card my-4">
        <div class="card-body table-container">
          <h4>Application Form for Farmer's Certificate </h4>
            ...
            <table class="table">
              ...
              <tbody>
                ...
                ?>
                    <tr>
                      <td><?= ($key + 1) ?></td>
                      <td><a href="<?= base_url("spservices/kaac_farmer/registration/preview/") . $obj_id ?>" target="_blank"><?= $value->service_data->appl_ref_no ?></a></td>
