...
<?php 
$applications = !empty($ahsecpasscerduplicatecertificate) ? $ahsecpasscerduplicatecertificate : array();
        ...
        <div class="col-sm-12 mx-auto">
            <div class="card my-4">
                <div class="card-body table-container">
                    <h4>AHSEC - Duplicate Pass Certificate </h4>
                                ...
                                <td>
                                   ...
                                   elseif($value->service_data->appl_status == "D"){ ?>
                                    ...
                                    <a class="btn btn-danger btn-sm mbtn"
                                        ...
                                        for re-correction</a>
                                    <?php if($value->service_data->service_id=='AHSECDPC') { ?>
