    ...
    $(document).ready(function () {
        ...
        $(document).on("change", "#dept_info", function(){
            ...
            if(deptInfo.length > 10) {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?=base_url('spservices/admin/users/get_services')?>",
        ...
        var getOfflineOffices = function(service_code) {
            if(service_code.length) { 
                $.ajax({
                    type: "POST",
                    url: "<?=base_url('spservices/admin/offices/get_offices')?>",
        ...
        var getRoles = function(service_code) {
            $.ajax({
                type: "POST",
                url: "<?=base_url('spservices/admin/levels/get_roles')?>",
                data: {"service_code": service_code},
                beforeSend:function(){
...
<div class="content-wrapper mt-2 p-2">
    ...
    <?php }//End of if ?>
    <form method="POST" action="<?=base_url('spservices/admin/users/edit')?>">
            ...
            <div class="card-body">
                ...
                <div class="row mt-2">  
                    ...
                    <div class="col-md-6 form-group">
                        ...
                        <input class="form-control" name="login_username" value="<?=$login_username?>" maxlength="100" type="text" readonly/>
