    ...
    $(document).ready(function () {
        ...
        $(document).on("click", "#finalsubmit", function(){
            Swal.fire({
                ...
                if (result.value) {
                    window.location.href = "<?=base_url('spservices/nec_landhub/necertificate/post_data/'.$obj_id)?>";
                }
            });
        });
    });
    ...
    <div class="container my-2">
        <div class="card shadow-sm" id="printDiv">
            ...
            <div class="card-footer text-center no-print">
                <?php if($status === 'DRAFT') { ?>
                    <a href="<?=base_url('spservices/nec_landhub/necertificate/index/'.$obj_id)?>" class="btn btn-primary">
                ...
                <?php if($payment_status !== 'PAID') { ?>    
                    <a href="<?=base_url('spservices/nec_landhub/necpayment/initiate/'.$obj_id)?>" class="btn btn-warning frmsbbtn">
