    ...
    <div class="container my-2">
        <div class="card shadow-sm" id="printDiv" style="background:#FBFBFB">
            ...
            <div class="card-footer text-center no-print">
                <?php if($status === 'DRAFT') { ?>
                    <a href="<?=base_url('spservices/marriageregistration/applicantdetails/index/'.$obj_id)?>" class="btn btn-primary">
                ...
                <?php if($payment_status !== 'PAID') { ?>
                    <a href="<?=base_url('spservices/marriageregistration/payment/initiate/'.$obj_id)?>" class="btn btn-success">
                        <i class="fa fa-angle-double-right"></i> Make Payment
                    </a>
                <?php } ?>
                <?php if($status === 'QS') { ?>
                    <a href="<?=base_url('spservices/marriageregistration/query/submit/'.$obj_id)?>" class="btn btn-success">
