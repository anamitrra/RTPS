...
$ahsec_yr_exam = set_value("ahsec_yr_exam");
?>
<style type="text/css">
legend {
    display: inline;
...
<main class="rtps-container">
    <div class="container my-2">
        <form id="myfrm" method="POST" action="<?= base_url('spservices/duplicate-certificate-searchdeatails-ahsec') ?>"
                ...
                <div class="card-body" style="padding:5px">
                    ...
                    <fieldset class="border border-success" style="margin-top:40px">
                        ...
                        <div class="row form-group">
                            <div class="col-md-6">
                                <label>AHSEC Registration Session/ AHSEC পঞ্জীয়ন বৰ্ষ <span
                            ...
                            <div class="col-md-6">
                                <label>Valid AHSEC Registrtion Number / AHSEC ৰ বৈধ পঞ্জীয়ন নম্বৰ <span
                                        class="text-danger">*</span> </label>
                        ...
                        <div class="row form-group">
                            <div class="col-md-6" id="ahsec_admit_roll_container">
                                <label>Valid H.S. Final Year Examination Roll/ বৈধ H.S চূড়ান্ত বৰ্ষৰ পৰীক্ষাৰ ৰোল <span
                                        class="text-danger">*</span> </label>
                            ...
                            <div class="col-md-6"  id="ahsec_admit_no_container">
                                <label>Valid H.S. Final Year Examination Number / বৈধ H.S চূড়ান্ত বৰ্ষৰ পৰীক্ষাৰ নম্বৰ<span
                                        class="text-danger">*</span> </label>
                        ...
                        <div class="row form-group">
                            <div class="col-md-6">
                                <label>
                                    <?php if ($pageTitleId == "AHSECDPC") { ?>Year of Passing in H.S Final Examination/ H.S চূড়ান্ত পৰীক্ষাত উত্তীৰ্ণ হোৱাৰ বছৰ <?php } else { ?>Year of Appearing in HS Final Examination/ H.S চূড়ান্ত পৰীক্ষাত অৱতীৰ্ণ হোৱাৰ বছৰ <?php } ?>
                                </label>
                                <span class="text-danger">*</span> </label>
                                <select name="ahsec_yr_exam" id="ahsec_yearofappearing" class="form-control" onchange="checkDropdownValue()" required>
                                    <option value="">Please Select</option>
                                    <?php if ($pageTitleId == "AHSECDRC") { ?>
                                        <option value="<?php echo 'Not yet appeared'; ?>" <?= ($ahsec_yr_exam === "Not yet appeared") ? 'selected' : '' ?>>Not yet appeared</option>
                                    <?php } ?>
                                    <?php foreach($years as $yr) { ?>
                                    <option value="<?php echo $yr ?>" <?= ($ahsec_yr_exam === $yr) ? 'selected' : '' ?>>
                                        <?php echo $yr ?></option>
                                    <?php } ?>
                                </select>
                                <?= form_error("ahsec_yr_exam") ?>
                            </div>
...
function showMessage(value) {
    ...
    if (value === "SHOW_MESSAGE") {
        messageElement.innerHTML =
            "<i class='icon fas fa-hand-point-right'></i> PLEASE PROVIDE BELOW ACADEMIC DETAILS CAREFULLY & ACCURATELY, AS BASED ON THESE DETAILS APPLICATIONS WILL BE FURTHER PROCESSED";
