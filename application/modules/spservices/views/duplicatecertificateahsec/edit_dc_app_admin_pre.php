...
$ahsec_inst_name =  isset($dbrow->form_data->institution_name) ? $dbrow->form_data->institution_name : ""; //$dbrow->form_data->ahsec_inst_name?? '';
...
else if ($dbrow->service_data->service_id == "AHSECDADM")
    $sl_no = $marksheet_data->Admit_Card_Serial_No
        ?? '';
else if ($dbrow->service_data->service_id == "AHSECDPC")
...
<div class="content-wrapper mt-2 p-2">
    ...
    <?php if ($this->session->flashdata('success') != null) { ?>
        ...
        <a href='<?= base_url('spservices/duplicatecertificateahsec/actions/preview/' . $objId) ?>' class='btn btn-primary btn-sm' target='_blank'>View</a>
        ...
        <div class="card-header bg-info">
            <div class="tab">
                ...
                <button class="tablinks" onclick="openDiv(event, 'edit')">
                    ...
                    <?php } ?>
                    <?php if ($dbrow->service_data->service_id == "AHSECDADM") { ?>
                        Edit Admit Card Details
                    <?php } ?>
                    <?php if ($dbrow->service_data->service_id == "AHSECDPC") { ?>
                        Edit Pass Certificate Details
                    <?php } ?>
                    <?php if ($dbrow->service_data->service_id == "AHSECDMRK") { ?>
        ...
        <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <table class="table table-bordered table-striped" style="overflow: scroll;">
                            ...
                            <tr>
                                <th>Office Copy</th>
                                <td><a target="_blank" class="btn btn-sm btn-primary" href="<?= base_url('/spservices/duplicatecertificateahsec/actions/officeCopy/' . $dbrow->service_data->service_id . '/' . $objId) ?>">Download
                                        Office Copy</a></td>
                            </tr>
                            <tr>
                    ...
                    <div class="col-md-6">
                        <table class="table table-bordered table-striped" style="overflow: scroll;">
                            ...
                            <tr>
                                <th>Photo</th>
                                <td> <img src="<?= base_url($dbrow->form_data->photo_of_the_candidate) ?>" style="width:130px; height: 130px; margin: 3px;" /></td>
                            </tr>
                            <tr>
                                <th>Signature</th>
                                <td><img src="<?= base_url($dbrow->form_data->candidate_sign) ?>" style="width:130px;  height: 40px; margin: 3px;" /></td>
                            </tr>
                            <tr>
                            ...
                            <?php if (isset($ahsec_yearofpassing) && !empty($ahsec_yearofpassing)) { ?>
                                <tr>
                                    <th><?php if ($dbrow->service_data->service_id == "AHSECDPC") { ?>Year of Passing in HS Final Examination <?php } else { ?>Year of Appearing in HS Final Examination<?php } ?></th>
                            ...
                            <?php if (!empty($dbrow->form_data->fir_type)) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?= base_url($dbrow->form_data->fir) ?>" class="btn font-weight-bold text-success" target="_blank">
                            ...
                            <?php if (!empty($dbrow->form_data->paper_advertisement_type)) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?= base_url($dbrow->form_data->paper_advertisement) ?>" class="btn font-weight-bold text-success" target="_blank">
                                            <span class="fa fa-download"></span>
                                            View/Download
                                        </a>
                                    </td>
                            ...
                            <?php if (!empty($dbrow->form_data->hslc_tenth_mrksht_type)) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?= base_url($dbrow->form_data->hslc_tenth_mrksht) ?>" class="btn font-weight-bold text-success" target="_blank">
                                            <span class="fa fa-download"></span>
                                            View/Download
                                        </a>
                                    </td>
                            ...
                            <?php if (!empty($dbrow->form_data->damage_reg_card_type)) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?= base_url($dbrow->form_data->damage_reg_card) ?>" class="btn font-weight-bold text-success" target="_blank">
                                            <span class="fa fa-download"></span>
                                            View/Download
                                        </a>
                                    </td>
                            ...
                            <?php if (!empty($dbrow->form_data->damage_admit_card_type)) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?= base_url($dbrow->form_data->damage_admit_card) ?>" class="btn font-weight-bold text-success" target="_blank">
                                            <span class="fa fa-download"></span>
                                            View/Download
                                        </a>
                                    </td>
                            ...
                            <?php if (!empty($dbrow->form_data->hs_reg_card_type)) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?= base_url($dbrow->form_data->hs_reg_card) ?>" class="btn font-weight-bold text-success" target="_blank">
                                            <span class="fa fa-download"></span>
                                            View/Download
                                        </a>
                                    </td>
                            ...
                            <?php if (!empty($dbrow->form_data->damage_mrksht_type)) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?= base_url($dbrow->form_data->damage_mrksht) ?>" class="btn font-weight-bold text-success" target="_blank">
                                            <span class="fa fa-download"></span>
                                            View/Download
                                        </a>
                                    </td>
                            ...
                            <?php if (!empty($dbrow->form_data->hs_admit_card_type)) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?= base_url($dbrow->form_data->hs_admit_card) ?>" class="btn font-weight-bold text-success" target="_blank">
                                            <span class="fa fa-download"></span>
                                            View/Download
                                        </a>
                                    </td>
                            ...
                            <?php if (!empty($dbrow->form_data->hs_mrksht_type)) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?= base_url($dbrow->form_data->hs_mrksht) ?>" class="btn font-weight-bold text-success" target="_blank">
                                            <span class="fa fa-download"></span>
                                            View/Download
                                        </a>
                                    </td>
                    ...
                    <div class="col-md-6">
                        ...
                        <?php } else if ($reg_data_cnt < 2) { ?>
                            <table class="table table-bordered table-striped" style="overflow: scroll;">
                                ...
                                <tr>
                                    <th>Photo</th>
                                    <td> <img src="<?= base_url("storage/docs/ahsec/photos/0" . $reg_data->photo_key_value . ".jpg") ?>" style="width:130px; height: 130px; margin: 3px;" /></td>
                                </tr>
                                <tr>
                                    <th>Signature</th>
                                    <td><img src="<?= base_url("storage/docs/ahsec/signature/0" . $reg_data->photo_key_value . ".jpg") ?>" style="width:130px;  height: 40px; margin: 3px;" /></td>
                                </tr>
                                <tr>
            ...
            <div id="edit" class="tabcontent" style="color: black;">
                <?php if ($reg_data_cnt == 0) { ?>
                    ...
                    <form class="form-horizontal" action="<?= base_url('spservices/duplicatecertificateahsec/actions/insert_reg_master_data/' . $objId) ?>" method="POST" autocomplete="off">
                ...
                <?php } else if (($reg_data_cnt < 2) || ($marksheet_data_cnt < 2)) { ?>
                    ...
                    <?php if ($dbrow->service_data->service_id == "AHSECDRC" || $dbrow->service_data->service_id == "AHSECDADM" || $dbrow->service_data->service_id == "AHSECDPC") { ?>
                        <form class="form-horizontal" action="<?= base_url('spservices/duplicatecertificateahsec/actions/update_reg_master_data/' . $objId) ?>" method="POST" autocomplete="off">
                            <div class="form-group">
                                <label class="control-label col-sm-2" for="sl_no">Sl No:</label>
                                <div class="col-sm-10">
                            ...
                            <?php if ($dbrow->service_data->service_id != "AHSECDRC") { ?>
                                ...
                                <div class="form-group">
                                    <label class="control-label col-sm-2" for="roll">Roll :</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="roll" value="<?= $roll ?>" placeholder="Enter Roll" name="roll" required readonly>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label col-sm-2" for="no">No :</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="no" value="<?= $no ?>" placeholder="Enter No" name="no" required readonly>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label col-sm-2" for="exam_year">Exam Year:</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <select class="form-control" required id="commencing_day" name="commencing_day">
                                            <option value="">Select Any One</option>
                                            <?php for ($i = 1; $i <= 31; $i++) { ?>
                                                <option <?php if ($i == $commencing_day) { ?> selected <?php } ?> value="<?= $i ?>">
                                                    <?= $i ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <select class="form-control" required id="core_sub_1" name="core_sub_1">
                                        <option value="">Select Any One</option>
                                        <?php foreach ($subjects as $subject) { ?>
                                            <option <?php if ($subject->subject_code == $sub_1) { ?> selected <?php } ?> value="<?= $subject->subject_code ?>">
                                                <?= $subject->subject_code . ' | ' . $subject->subject_name ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-control" required id="core_sub_2" name="core_sub_2">
                                        <option value="">Select Any One</option>
                                        <?php foreach ($subjects as $subject) { ?>
                                            <option <?php if ($subject->subject_code == $sub_2) { ?> selected <?php } ?> value="<?= $subject->subject_code ?>">
                                                <?= $subject->subject_code . ' | ' . $subject->subject_name ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-control" required id="elective_sub_3" name="elective_sub_3">
                                        <option value="">Select Any One</option>
                                        <?php foreach ($subjects as $subject) { ?>
                                            <option <?php if ($subject->subject_code == $sub_3) { ?> selected <?php } ?> value="<?= $subject->subject_code ?>">
                                                <?= $subject->subject_code . ' | ' . $subject->subject_name ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-control" required id="elective_sub_4" name="elective_sub_4">
                                        <option value="">Select Any One</option>
                                        <?php foreach ($subjects as $subject) { ?>
                                            <option <?php if ($subject->subject_code == $sub_4) { ?> selected <?php } ?> value="<?= $subject->subject_code ?>">
                                                <?= $subject->subject_code . ' | ' . $subject->subject_name ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-control" required id="elective_sub_5" name="elective_sub_5">
                                        <option value="">Select Any One</option>
                                        <?php foreach ($subjects as $subject) { ?>
                                            <option <?php if ($subject->subject_code == $sub_5) { ?> selected <?php } ?> value="<?= $subject->subject_code ?>">
                                                <?= $subject->subject_code . ' | ' . $subject->subject_name ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-control" required id="elective_sub_6" name="elective_sub_6">
                                        <option value="">Select Any One</option>
                                        <?php foreach ($subjects as $subject) { ?>
                                            <option <?php if ($subject->subject_code == $sub_6) { ?> selected <?php } ?> value="<?= $subject->subject_code ?>">
                                                <?= $subject->subject_code . ' | ' . $subject->subject_name ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                    ...
                    <?php } else if ($dbrow->service_data->service_id == "AHSECDMRK") { ?>
                        <form class="form-horizontal" action="<?= base_url('spservices/duplicatecertificateahsec/actions/update_marksheet_data/' . $objId) ?>" method="POST" autocomplete="off">
    ...
    function showMessage(value) {
        ...
        if (value === "SHOW_MESSAGE") {
            messageElement.innerHTML =
                "<i class='icon fas fa-hand-point-right'></i> PLEASE EXERCISE CAUTION WHILE CHANGING/UPDATING CANDIDATE ACADEMIC DETAILS TO ENSURE ACCURACY AND RELIABILITY OF OUR RECORDS";
