...
if($dbrow) {
    ...
    $photo_of_the_candidate_type = $dbrow->form_data->photo_of_the_candidate_type??null;
    $candidate_sign_type = $dbrow->form_data->candidate_sign_type??null;
    $fir_type = $dbrow->form_data->fir_type??null;
    $paper_advertisement_type = $dbrow->form_data->paper_advertisement_type??null;
    $hslc_tenth_mrksht_type = $dbrow->form_data->hslc_tenth_mrksht_type??null;
    $hs_reg_card_type = $dbrow->form_data->hs_reg_card_type??null;
    $hs_admit_card_type = $dbrow->form_data->hs_admit_card_type??null;
    $hs_mrksht_type = $dbrow->form_data->hs_mrksht_type??null;
    $damage_reg_card_type = $dbrow->form_data->damage_reg_card_type??null;
    $damage_admit_card_type = $dbrow->form_data->damage_admit_card_type??null;
    $damage_mrksht_type = $dbrow->form_data->damage_mrksht_type??null;
    $damage_pass_certi_type = $dbrow->form_data->damage_pass_certi_type??null;

    $photo_of_the_candidate = $dbrow->form_data->photo_of_the_candidate??null;
    $candidate_sign = $dbrow->form_data->candidate_sign??null;
    $fir = $dbrow->form_data->fir??null;
    $paper_advertisement = $dbrow->form_data->paper_advertisement??null;
    $hslc_tenth_mrksht = $dbrow->form_data->hslc_tenth_mrksht??null;
    $hs_reg_card = $dbrow->form_data->hs_reg_card??null;
    $hs_admit_card = $dbrow->form_data->hs_admit_card??null;
    $hs_mrksht = $dbrow->form_data->hs_mrksht??null;
    $damage_reg_card = $dbrow->form_data->damage_reg_card??null;
    $damage_admit_card = $dbrow->form_data->damage_admit_card??null;
    $damage_mrksht = $dbrow->form_data->damage_mrksht??null;
    $damage_pass_certi = $dbrow->form_data->damage_pass_certi??null;
} ?>
<style type="text/css">
    legend {
        display: inline;
...
<main class="rtps-container">
    <div class="container my-2">
        <form id="myfrm" method="POST" action="<?= base_url('spservices/duplicatecertificateahsec/registration/request_for_recorrection_submit') ?>" enctype="multipart/form-data">
            ...
            <div class="card shadow-sm">
                ...
                <div class="card-body" style="padding:5px">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <input type="text" class="form-control" name="mother_name" id="mother_name"
                                    value="<?=$mother_name?>" maxlength="255" readonly/>
                                <?= form_error("dob") ?>
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea id="comp_permanent_address" class="form-control"
                                        ...
                                        cols="50" readonly><?=$comp_permanent_address?></textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    value="<?=$pa_pincode?>" maxlength="6" readonly/>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="pa_state" id="pa_state" readonly>
                                        <option value="">Please Select</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="pa_district" id="pa_district" class="form-control pa_dists" readonly>
                                    </select>
                                    <?= form_error("state") ?>
                                </div>
                            </diiv>
                    ...
                    <fieldset class="border border-success" style="margin-top:40px">
                        ...
                        <input type="checkbox" name="checker" id="checker"  />&nbsp;&nbsp;&nbsp;<b>Same as Permanent Address</b><br/><br/>                        
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea id="comp_postal_address" class="form-control"
                                        ...
                                        cols="50" readonly><?=$comp_postal_address?></textarea>
                                ...
                                <input type="text" class="form-control" name="pos_pincode" id="pos_pincode"
                                    value="<?=$pos_pincode?>" maxlength="255" readonly/>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <label>State <span class="text-danger">*</span></label>
                                    <select class="form-control" name="pos_state" id="pos_state" readonly>
                                        <option value="">Please Select</option>
                                        <option value="Assam" autocomplete="off" selected="selected">Assam</option>
                                    </select>
                                ...
                                <div class="form-group">
                                    <label>District <span class="text-danger">*</span></label>
                                    <select class="form-control pos_dists" name="pos_district" id="pos_district" readonly>
                                    </select>
                    ...
                    <fieldset class="border border-success" style="margin-top:40px">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="ahsec_yearofpassing" class="form-control" readonly>
                                    <option value="">Please Select</option>
                                    <?php foreach($sessions as $session) { ?>   
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="institution_name" id="institution_name" value="<?= $institution_name ?>" maxlength="255" readonly/>
                        ...
                        <div class="row ">
                            <div class="form-group  col-md-6">
                                ...
                                <input type="text" class="form-control" name="board_seaking_adm" id="board_seaking_adm"
                                    value="<?=$board_seaking_adm?>" readonly/>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" name="course_seaking_adm"
                                    id="course_seaking_adm" value="<?=$course_seaking_adm?>" readonly/>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" name="state_seaking_adm" id="state_seaking_adm"
                                    value="<?=$state_seaking_adm?>" maxlength="20" readonly/>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <textarea id="reason_seaking_adm" class="form-control" name="reason_seaking_adm"
                                    rows="4" cols="50" readonly><?=$reason_seaking_adm?></textarea>
                        ...
                        <div class="row ">
                            <div class="form-group  col-md-12">
                                <input id="condi_of_doc" name="condi_of_doc" type="radio" class=""
                                    ...
                                    value="PARTIALLY DAMAGED" readonly/> PARTIALLY DAMAGED
                                <br/>
                                <input id="condi_of_doc" name="condi_of_doc" type="radio" class=""
                                    <?php if($condi_of_doc=='FULLY DAMAGED') echo "checked='checked'"; ?>
                                    value="FULLY DAMAGED" readonly/> FULLY DAMAGED
                                    <br/>
                                <input id="condi_of_doc" name="condi_of_doc" type="radio" class=""
                                    <?php if($condi_of_doc=='LOST') echo "checked='checked'"; ?>
                                    value="LOST" readonly/> LOST
                        ...
                        <div class="row ">
                            <div class="form-group  col-md-12">
                                ...
                                <input id="postal" name="postal" type="radio" class=""
                                    ...
                                    value="FROM AHSEC COUNTER" readonly/> FROM AHSEC COUNTER
                                ...
                                <input id="postal" name="postal" type="radio" class=""
                                    ...
                                    <?php echo $this->form_validation->set_radio('postal', 'IN MY POSTAL ADDRESS'); ?> readonly/>IN MY POSTAL ADDRESS
                    ...
                    <fieldset class="border border-success" style="margin-top:40px">
                        ...
                        <div class="row ">
                            <div class="form-group  col-md-6">
                                <label>Remarks / মন্তব্য<span class="text-danger">*</span></label>
                                <textarea class="form-control" name="applicant_remarks" rows="4" cols="50" required></textarea>
                            </div>
                        </div>
                    </fieldset>
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <select name="photo_of_the_candidate_type" class="form-control" readonly>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select name="candidate_sign_type" class="form-control" readonly>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select name="fir_type" class="form-control" readonly>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select name="paper_advertisement_type" class="form-control" readonly>
                                                    <option value="">Select</option>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select name="hslc_tenth_mrksht_type" class="form-control" readonly>
                                                    <option value="">Select</option>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select name="damage_reg_card_type" class="form-control" readonly>
                                                    <option value="">Select</option>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select name="damage_admit_card_type" class="form-control" readonly>
                                                    <option value="">Select</option>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select name="hs_reg_card_type" class="form-control" readonly>
                                                    <option value="">Select</option>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select name="damage_mrksht_type" class="form-control" readonly>
                                                    <option value="">Select</option>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select name="hs_admit_card_type" class="form-control" readonly>
                                                    <option value="">Select</option>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select name="damage_pass_certi_type" class="form-control" readonly>
                                                    <option value="">Select</option>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select name="hs_mrksht_type" class="form-control" readonly>
                                                    <option value="">Select</option>
