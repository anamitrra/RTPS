...
<script type="text/javascript">   
    ...
    $(document).on("click", ".frmsbbtn", function(){ 
        let url='<?=base_url('spservices/registereddeed/finalsubmition')?>';
...
<!-- 
            ...
            <div class="card-footer text-center no-print">
                <a href="<?=base_url('spservices/registereddeed/index/'.$obj_id)?>" class="btn btn-primary">
                    <i class="fa fa-pencil"></i> Edit
                </a>
                <button class="btn btn-warning" id="printBtn" type="button">
                    <i class="fa fa-print"></i> Print
                </button>
                <a href="<?=base_url('spservices/payment/initiate/'.$obj_id)?>" class="btn btn-success">
