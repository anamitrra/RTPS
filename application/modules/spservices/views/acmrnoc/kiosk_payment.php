<main class="rtps-container">
    <form method="POST" action="<?= base_url('spservices/acmrnoc/payment/submit') ?>">
                    ...
                    <fieldset class="border border-success table-responsive" style="margin-top:40px">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control" name="acmr_noc_application_fee" id="acmr_noc_application_fee" value="<?= $acmr_noc_application_fee ?>" readonly />
                                <?= form_error("acmr_noc_application_fee") ?>
                            </div>
                            <div class="col-md-4">
