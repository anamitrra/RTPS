    ...
    <div class="container my-2">
        <div class="card shadow-sm" id="printDiv">
            <div class="card-header" style="text-align: center; font-size: 20px; color: #000; font-family: georgia,serif; font-weight: bold">
                   APPLICATION FORM FOR TRADING PERMIT TO CARRY ON BUSINESS FOR TRIBAL
            </div>
            ...
            <div class="card-footer text-center no-print">
                <?php if($form_status === 'DRAFT') { ?>    
                    <a href="<?=base_url('spservices/trade_permit/Application/index/'. $obj_id)?>" class="btn btn-primary">
                ...
                <?php if($payment_status !== 'PAYMENT_COMPLETED'){
                    if($form_status === 'QS'){ ?>
                        <!--<button class="btn btn-warning frmbtn"  type="button">
                         ...
                         -->
                        <a href="<?=base_url('spservices/trade_permit/Application/finalsubmition/'. $obj_id)?>" class="btn btn-warning" onclick='this.disabled = true;'>
                        <i class="fa fa-pencil"></i> Submit
                    </a>
                     <?php } else if($user_type == 'user'){ ?>
                        <a href="<?=base_url('spservices/trade_permit/Payment/ctz_initiate/'. $obj_id)?>" class="btn btn-warning">
                    ...
                    <?php } else{ ?>
                        ...
                        <a href="<?=base_url('spservices/trade_permit/Payment/initiate/'. $obj_id)?>" class="btn btn-warning">
                        <i class="fa fa-angle-double-right"></i> Make Payment
                    </a>
                    <?php }//End of if else
                }//End of if ?>
