                ...
                <div class="card-body">
                  ...
                  <div class="row">
                      <p style="text-align:justify; line-height: 24px">
                        Dear <strong><?=( isset($response->form_data->first_name))?$response->form_data->first_name:''?></strong>,
                      <br/>
                      <br/>
                  ...
                  <div class="row">
                    <span>(NCHAC Ref no: <?=isset($response->form_data->edistrict_ref_no)?$response->form_data->edistrict_ref_no:''?>)</span>
                  </div>
                </div>
            </div>
        </div>
