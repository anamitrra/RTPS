            ...
            <div class="card-body" style="padding:5px">
                    ...
                    <table class="table table-borderless" style="margin-top:0px; margin-bottom:0px;">
                        <tbody style="border-top: none !important">
                            ...
                            <?php if ($pageTitleId != "AHSECCRC") { ?>
                                <tr>
                                    <td>Valid H.S. 2nd Year Admit Roll/ বৈধ HS ২য় বৰ্ষৰ এডমিট ৰোল <br><strong><?= $ahsec_admit_roll ?></strong></td>
                                    <td>Valid H.S. 2nd Year Admit Number / বৈধ HS ২য় বৰ্ষৰ এডমিট নম্বৰ <br><strong><?= $ahsec_admit_no ?></strong></td>
                                </tr>
                            <?php } ?>
                            <tr>
                                <td>Name of the Institution / প্ৰতিষ্ঠানটোৰ নাম <br><strong><?= $institution_name ?></strong></td>
                                <?php if ($pageTitleId != "AHSECCRC") { ?>
                                    <td>
                                        <?php if ($pageTitleId == "AHSECCMRK") { ?>Year of Passing in HS Final Exam/ HS চূড়ান্ত পৰীক্ষাত উত্তীৰ্ণ হোৱাৰ বছৰ <?php } else { ?>Year of Appearing in HS Final Exam/ HS চূড়ান্ত পৰীক্ষাত অৱতীৰ্ণ হোৱাৰ বছৰ <?php } ?>
                    ...
                    <table class="table table-borderless" style="margin-top:0px; margin-bottom:0px;">
                        <tbody style="border-top: none !important">
                            <tr>
                                ...
                                <td>Records in my document as / বৰ্তমান মোৰ নথিপত্ৰত লিপিবদ্ধ থকা তথ্য</td>
                ...
                <fieldset class="border border-success table-responsive" style="margin-top:40px">
                    ...
                    <table class="table table-borderless" style="margin-top:0px; margin-bottom:0px;">
                        <tbody style="border-top: none !important">
                            <tr>
                                <td>How would you want to receive your corrected documents? /আপুনি আপোনাৰ শুদ্ধ নথিপত্ৰকেনেদৰে প্ৰাপ্ত কৰিব বিচাৰিব? <br><strong><?= $delivery_mode ?></strong> </td>
                            </tr>
                        </tbody>
                    </table>
                </fieldset>
                <fieldset class="border border-success table-responsive" style="margin-top:40px">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    <td><?php if ($pageTitleId == "AHSECCRC") { ?>HSLC 10th Admit Card<?php } ?><?php if ($pageTitleId == "AHSECCADM" || $pageTitleId == "AHSECCMRK") { ?>HS Admit Card<?php } ?></td>
