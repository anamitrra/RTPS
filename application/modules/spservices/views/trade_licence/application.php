...
if ($dbrow) {
    ...
    $assistant_name = $dbrow->form_data->assistant_name;
    $commodities = $dbrow->form_data->commodities;
    $market_place = $dbrow->form_data->market_place;
    $market_area = $dbrow->form_data->market_area;
    $business_nature = $dbrow->form_data->business_nature;
    $annual_gross = $dbrow->form_data->annual_gross;
    $place = $dbrow->form_data->place;
    ...
    $address_same = set_value("address_same") ?? NULL;
...
<main class="rtps-container">
    <div class="container my-2">
        <form id="myfrm" method="POST" action="<?= base_url('spservices/trade_licence/Application/submit') ?>" enctype="multipart/form-data" onsubmit="$(this).find('select,radio,input').prop('disabled', false)">
            ...
            <div class="card shadow-sm">
                <div class="card-header" style="text-align: center; font-size: 18px; color: #000; font-family: georgia,serif; font-weight: bold">
                    APPLICATION FORM FOR TRADING LICENCE</br>
                    <font size="4px"></font>
                </div>
                ...
                <fieldset class="border border-success">
                    ...
                    <ol style="margin-left: 24px; margin-top: 10px">
                        <li>The certificate will be delivered within 7-10 Days of application.</li>
                    </ol>
                ...
                <div class="card-body" style="padding:5px">
                    ...
                    <fieldset class="border border-success" style="margin-top:40px">
                        <legend class="h5">Applicant Details<font size="3px"></font>
                        </legend>
                        <div class="row">
                            <div class="col-md-6 form-group">
                                <label>First Name <font size="2px"></font> <span class="text-danger">*</span> </label>
                                <input class="form-control" name="first_name" id="first_name" value="<?= $first_name ?>" maxlength="255" type="text" required="true" / <?php if ($form_status === "QS") { ?>readonly <?php } ?>>
                                <?= form_error("first_name") ?>
                            </div>
                            <div class="col-md-6 form-group">
                                <label>Last Name <font size="2px"></font> <span class="text-danger">*</span> </label>
                                <input class="form-control" name="last_name" id="last_name" value="<?= $last_name ?>" maxlength="255" type="text" required="true" / <?php if ($form_status === "QS") { ?>readonly <?php } ?>>
                                <?= form_error("last_name") ?>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 form-group">
                                <label>Father's Name<font size="2px"></font><span class="text-danger">*</span> </label>
                                <input class="form-control" name="father_name" id="father_name" value="<?= $father_name ?>" maxlength="255" type="text" <?php if ($form_status === "QS") { ?>readonly <?php } ?>>
                        ...
                        <div class="row">
                            <div class="col-md-6 form-group">
                                <label>Email</label>
                                <input class="form-control" name="emailid" id="emailid" value="<?= $emailid ?>" maxlength="100" type="text" <?php if ($form_status === "QS") { ?>readonly <?php } ?> />
                                <?= form_error("emailid") ?>
                            </div>
                            <div class="col-md-6 form-group">
                                <label>Gender <font size="2px"></font><span class="text-danger">*</span> </label>
                                <select name="applicant_gender" id="applicant_gender" class="form-control" <?php if ($form_status === "QS") { ?>disabled <?php } ?>>
                        ...
                        <div class="row">
                            <div class="col-md-6 form-group">
                                ...
                                <input class="form-control" name="nationality" id="nationality" value="<?= $nationality ?>" maxlength="255" type="text" <?php if ($form_status === "QS") { ?>readonly <?php } //?> />
                    ...
                    <fieldset class="border border-success" style="margin-top:40px">
                        <legend class="h5">Permanent Address<font size="3px"></font>
                        </legend>
                        <div class="row">
                            <div class="col-md-6 form-group">
                                <label>Address Line 1<font size="2px" class="text-danger">*</font></label>
                                <input class="form-control" name="pa_address_line_1" id="pa_address_line_1" value="<?= $pa_address_line_1 ?>" maxlength="255" type="text" <?php if ($form_status === "QS") { ?>readonly <?php } ?> />
                                <?= form_error("pa_address_line_1") ?>
                            </div>

                            <div class="col-md-6 form-group">
                                <label>Address Line 2<font size="2px"></font><span class="text-danger"></span> </label>
                                <input class="form-control" name="pa_address_line_2" id="pa_address_line_2" value="<?= $pa_address_line_2 ?>" maxlength="255" type="text" <?php if ($form_status === "QS") { ?>readonly <?php } ?> />
                        ...
                        <div class="row">
                            <div class="col-md-6 form-group">
                                ...
                                <input class="form-control" name="pa_address_line_3" id="pa_address_line_3" value="<?= $pa_address_line_3 ?>" maxlength="255" type="text" <?php if ($form_status === "QS") { ?>readonly <?php } ?> />
                                <?= form_error("pa_address_line_3") ?>
                            </div>
                            <div class="col-md-6 form-group">
                                <label>Post Office<font size="2px"></font><span class="text-danger">*</span> </label>
                                <input class="form-control" name="pa_post_office" id="pa_post_office" value="<?= $pa_post_office ?>" maxlength="255" type="text" <?php if ($form_status === "QS") { ?>readonly <?php } ?> />
                        ...
                        <div class="row">
                            <div class="col-md-6 form-group">
                                ...
                                <input class="form-control number_input" name="pa_pin_code" id="pa_pin_code" value="<?= $pa_pin_code ?>" maxlength="6" type="text" <?php if ($form_status === "QS") { ?>readonly <?php } ?> />
                                <?= form_error("pa_pin_code") ?>
                            </div>
                            <div class="col-md-6 form-group">
                                <label>Country<span class="text-danger">*</span> </label>
                                <select name="pa_country" id="pa_country" class="form-control" <?php if ($form_status === "QS") { ?>disabled <?php }?>>
                        ...
                        <div class="row">
                            <div class="col-md-6 form-group">
                                ...
                                <select name="pa_state" id="pa_state" class="form-control" <?php if ($form_status === "QS") { ?>disabled <?php } ?>>
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <select name="pa_district" id="pa_district" class="form-control" <?php if ($form_status === "QS") { ?>disabled <?php } ?>>
                        ...
                        <div class="row">
                         <div class="col-md-6 form-group">
                            ...
                            <div id="pa_circles_div">
                                <select name="pa_circle" id="pa_circle" class="form-control" <?php if ($form_status === "QS") { ?>disabled <?php } ?>>
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <input class="form-control" name="pa_village" id="pa_village" value="<?= $pa_village ?>" maxlength="100" type="text" <?php if ($form_status === "QS") { ?>readonly <?php } // ?> />
                        ...
                        <div class="row">
                            <div class="col-md-6 form-group">
                                ...
                                <input class="form-control" name="pa_police_station" id="pa_police_station" value="<?= $pa_police_station ?>" maxlength="100" type="text" <?php if ($form_status === "QS") { ?>readonly <?php } ?> />
                    ...
                    <fieldset class="border border-success" style="margin-top:40px">
                        <legend class="h5">Current Address <font size="3px"></font>
                        </legend>
                        <div class="row mt-2 mb-4">
                            ...
                            <div class="col-md-6">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input address_same" type="radio" name="address_same" id="dcsYes" value="Y" <?= ($address_same === 'Y') ? 'checked' : '' ?> <?php if ($form_status === "QS") { ?>disabled <?php } ?> />
                                    <label class="form-check-label" for="dcsYes">YES</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input address_same" type="radio" name="address_same" id="dcsNo" value="N" <?= ($address_same === 'N') ? 'checked' : '' ?> <?php if ($form_status === "QS") { ?>disabled <?php } ?> />
                        ...
                        <div class="row">
                            <div class="col-md-6 form-group">
                                <label>Address Line 1<font size="2px" class="text-danger">*</font></label>
                                <input class="form-control" name="ca_address_line_1" id="ca_address_line_1" value="<?= $ca_address_line_1 ?>" maxlength="255" type="text" <?php if ($form_status === "QS") { ?>readonly <?php } ?> />
                                <?= form_error("ca_address_line_1") ?>
                            </div>
                            <div class="col-md-6 form-group">
                                <label>Address Line 2<font size="2px"></font><span class="text-danger"></span> </label>
                                <input class="form-control" name="ca_address_line_2" id="ca_address_line_2" value="<?= $ca_address_line_2 ?>" maxlength="255" type="text" <?php if ($form_status === "QS") { ?>readonly <?php } ?> />
                        ...
                        <div class="row">
                            <div class="col-md-6 form-group">
                                <label>Address Line 3<font size="2px"></font><span class="text-danger"></span> </label>
                                <input class="form-control" name="ca_address_line_3" id="ca_address_line_3" value="<?= $ca_address_line_3 ?>" maxlength="255" type="text" <?php if ($form_status === "QS") { ?>readonly <?php } ?> />
                                <?= form_error("ca_address_line_3") ?>
                            </div>
                            <div class="col-md-6 form-group">
                                <label>Post Office<font size="2px"></font><span class="text-danger">*</span> </label>
                                <input class="form-control" name="ca_post_office" id="ca_post_office" value="<?= $ca_post_office ?>" maxlength="255" type="text" <?php if ($form_status === "QS") { ?>readonly <?php } ?> />
                        ...
                        <div class="row">
                            <div class="col-md-6 form-group">
                                <label>Postal / Zip Code<font size="2px"></font><span class="text-danger">*</span> </label>
                                <input class="form-control number_input" name="ca_pin_code" id="ca_pin_code" value="<?= $ca_pin_code ?>" maxlength="6" type="text" <?php if ($form_status === "QS") { ?>readonly <?php } ?> />
                                <?= form_error("ca_pin_code") ?>
                            </div>
                            <div class="col-md-6 form-group">
                                <label>Country<span class="text-danger">*</span> </label>
                                <select name="ca_country" id="ca_country" class="form-control" <?php if ($form_status === "QS") { ?>disabled <?php } ?>>
                                    <option value="India">India</option>
                                </select>
                        ...
                        <div class="row">
                            <div class="col-md-6 form-group">
                                ...
                                <div id="ca_state_div_1">
                                    <input class="form-control" name="ca_state" id="ca_state" value="<?= $ca_state ?>" maxlength="255" type="text" <?php if ($form_status === "QS") { ?>readonly <?php }?>>
                                </div>
                                <div id="ca_state_div_2">
                                    <select name="ca_state" id="ca_state" class="form-control" <?php if ($form_status === "QS") { ?>disabled <?php } ?>>
                                        <option>Select</option>
                                        <?php if ($states) {
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <div id="ca_district_div_2">
                                    <select name="ca_district" id="ca_district" class="form-control ca_dists" <?php if ($form_status === "QS") { ?>disabled <?php } ?>>
                                        <option value="<?= $ca_district ?>"><?= strlen($ca_district) ? $ca_district : 'Select' ?></option>
                                    </select>
                                </div>
                                <div id="ca_district_div_1">
                                    <input class="form-control" name="ca_district" id="ca_district_1" value="<?= $ca_district ?>" maxlength="255" type="text" <?php if ($form_status === "QS") { ?>readonly <?php } ?> />
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 form-group">
                                <label>Village<font size="2px"></font><span class="text-danger">*</span> </label>
                                <input class="form-control" name="ca_village" id="ca_village" value="<?= $ca_village ?>" maxlength="100" type="text" <?php if ($form_status === "QS") { ?>readonly <?php } //?> />
                                <?= form_error("ca_village") ?>
                            </div>
                            <div class="col-md-6 form-group">
                                <label>Police Station<font size="2px"></font><span class="text-danger">*</span> </label>
                                <input class="form-control" name="ca_police_station" id="ca_police_station" value="<?= $ca_police_station ?>" maxlength="100" type="text" <?php if ($form_status === "QS") { ?>readonly <?php } ?> />
                    ...
                    <fieldset class="border border-success" style="margin-top:40px">
                        <legend class="h5"> Other Details <font size="2px"></font>
                        </legend>
                        <div class="row">
                            <div class="col-md-6 form-group">
                                <label>Name of the assistants employed or intended to be employed <font size="2px"></font><span class="text-danger">*</span> </label>
                                <input class="form-control" name="assistant_name" id="assistant_name" value="<?= $assistant_name ?>" maxlength="255" type="text" <?php if ($form_status === "QS") { ?>readonly <?php } ?> />
                                <?= form_error("assistant_name") ?>
                            </div>
                            <div class="col-md-6 form-group">
                                <label>Nature of Commoditie<font size="2px"></font><span class="text-danger">*</span> </label>
                                <input class="form-control" name="commodities" id="commodities" value="<?= $commodities ?>" maxlength="255" type="text" <?php if ($form_status === "QS") { ?>readonly <?php } //
                                ?> />
                        ...
                        <div class="row">
                            <div class="col-md-6 form-group">
                                <label>Market Place<font size="2px"></font><span class="text-danger">*</span> </label>
                                <input class="form-control" name="market_place" id="market_place" value="<?= $market_place ?>" maxlength="255" type="text" <?php if ($form_status === "QS") { ?>readonly <?php } ?> />
                                <?= form_error("market_place") ?>
                            </div>
                            <div class="col-md-6 form-group">
                                <label>Marketing Area</font><span class="text-danger">*</span> </label>
                                <input class="form-control" name="market_area" id="market_area" value="<?= $market_area ?>" maxlength="255" type="text" <?php if ($form_status === "QS") { ?>readonly <?php } //?> />
                                <?= form_error("market_area") ?>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 form-group">
                                <label>Nature of Business<font size="2px"></font><span class="text-danger">*</span> </label>
                                <input class="form-control" name="business_nature" id="business_nature" value="<?= $business_nature ?>" maxlength="255" type="text" <?php if ($form_status === "QS") { ?>readonly <?php } ?> />
                                <?= form_error("business_nature") ?>
                            </div>
                            <div class="col-md-6 form-group">
                                <label>Annual gross outturn will be about Rs.</font><span class="text-danger">*</span> </label>
                                <input class="form-control" name="annual_gross" id="annual_gross" value="<?= $annual_gross ?>" maxlength="255" type="text" <?php if ($form_status === "QS") { ?>readonly <?php } ?> />
                                <?= form_error("annual_gross") ?>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 form-group">
                                <label>Place</font><span class="text-danger">*</span> </label>
                                <input class="form-control" name="place" id="place" value="<?= $place ?>" maxlength="255" type="text" <?php if ($form_status === "QS") { ?>readonly <?php } ?> />
                                <?= form_error("place") ?>
                            </div>
                        </div>
                    </fieldset>
                            ...
                            <div class="col-12">
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                        <tr>
                                            <td>Land Documents or PRC<font></font><span class="text-danger">*</span></td>
                                            <td>
