...
if ($dbrow) {
    ...
    // $name_of_the_house_apartment_p = set_value("name_of_the_house_apartment_p");
    // $house_no_apartment_no_p = set_value("house_no_apartment_no_p");
    // $building_no_block_no_p = set_value("building_no_block_no_p");
    // $address_locality_street_etc_p = set_value("address_locality_street_etc_p");
    // $vill_town_ward_city_p = set_value("vill_town_ward_city_p");
    // $post_office_p = set_value("post_office_p");
    // $police_station_p = set_value("police_station_p");
    // $pin_code_p = set_value("pin_code_p");
    // $district_p = set_value("district_p");
    // $sub_division = set_value("sub-division");
    // $revenue_circle = set_value("revenue_circle");
    // $residence = set_value("residence");
    // $same_as_permanent_address = set_value("same_as_permanent_address");
    // $name_of_the_house_apartment = set_value("name_of_the_house_apartment");
    // $house_no_apartment_no = set_value("house_no_apartment_no");
    // $building_no_block_no = set_value("building_no_block_no");
    // $address_locality_street_etc = set_value("address_locality_street_etc");
    // $vill_town_ward_city = set_value("vill_town_ward_city");
...
<main class="rtps-container">
    <div class="container my-2">
        <form id="myfrm" method="POST" action="<?= base_url('spservices/employment_aadhaar_based/registration/submit_address') ?>" enctype="multipart/form-data">
            ...
            <div class="card shadow-sm">
                ...
                <div class="card-body" style="padding:5px">
                    ...
                    <fieldset class="border border-success" style="margin-top:40px">
                        ...
                        <div class="row form-group">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="name_of_the_house_apartment_p" id="name_of_the_house_apartment_p" value="<?= $name_of_the_house_apartment_p ?>" />
                                <?= form_error("name_of_the_house_apartment_p") ?>
                            </div>
                            <div class="col-md-6">
                                <label>House No/Apartment No </label>
                                <input type="text" class="form-control" name="house_no_apartment_no_p" id="house_no_apartment_no_p" value="<?= $house_no_apartment_no_p ?>" />
                        ...
                        <div class="row form-group">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="building_no_block_no_p" id="building_no_block_no_p" value="<?= $building_no_block_no_p ?>" />
                                <?= form_error("building_no_block_no_p") ?>
                            </div>
                            <div class="col-md-6">
                                <label>Address (Locality/Street/etc.) </label>
                                <input type="text" class="form-control" name="address_locality_street_etc_p" id="address_locality_street_etc_p" value="<?= $address_locality_street_etc_p ?>" />
                        ...
                        <div class="row form-group">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="vill_town_ward_city_p" id="vill_town_ward_city_p" value="<?= $vill_town_ward_city_p ?>" />
                                <?= form_error("vill_town_ward_city_p") ?>
                            </div>
                            <div class="col-md-6">
                                <label>Post Office <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" name="post_office_p" id="post_office_p" value="<?= $post_office_p ?>" />
                        ...
                        <div class="row form-group">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="police_station_p" id="police_station_p" value="<?= $police_station_p ?>" />
                                <?= form_error("police_station_p") ?>
                            </div>
                            <div class="col-md-6">
                                <label>Pin Code <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" name="pin_code_p" id="pin_code_p" value="<?= $pin_code_p ?>" maxlength="6" />
                        ...
                        <div class="row form-group">
                            <div class="col-md-6">
                                ...
                                <select name="district_p" class="form-control" id="district_p">
                    ...
                    <fieldset class="border border-success" style="margin-top:40px">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-md-6">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input address_same" type="radio" name="same_as_permanent_address" id="dcsYes" value="Yes" <?= ($same_as_permanent_address === 'Yes') ? 'checked' : '' ?> />
                                    <label class="form-check-label" for="dcsYes">YES</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input address_same" type="radio" name="same_as_permanent_address" id="dcsNo" value="No" <?= ($same_as_permanent_address === 'No') ? 'checked' : '' ?> />
                        ...
                        <div class="row form-group">
                            <div class="col-md-6">
                                <label>Name of the House/Apartment </label>
                                <input type="text" class="form-control" name="name_of_the_house_apartment" id="name_of_the_house_apartment" value="<?= $name_of_the_house_apartment ?>" <?= ($same_as_permanent_address === 'Yes') ? 'readonly' : '' ?>/>
                                <?= form_error("name_of_the_house_apartment") ?>
                            </div>
                            <div class="col-md-6">
                                <label>House No/Apartment No </label>
                                <input type="text" class="form-control" name="house_no_apartment_no" id="house_no_apartment_no" value="<?= $house_no_apartment_no ?>" <?= ($same_as_permanent_address === 'Yes') ? 'readonly' : '' ?> />
                ...
                <div class="card-footer text-center">
                    <a class="btn btn-primary frmbtn" id="DRAFT" href="<?= base_url('spservices/employment-registration/personal-details/'. $obj_id) ?>">
