...
<div class="row">
    <div class="col-sm-12 mx-auto">
        <div class="card my-4">
            <div class="card-body">
                <h4>
                    Employment Exchange Registration Non-aadhaar
                    <a href="<?= base_url('spservices/employmentnonaadhaar/reregistration/search_reg_details/') ?>" class="mybtn1" target="_blnk">
                        RE-REGISTRATION <i class="fa fa-edit"></i>
                    </a>

                    <a href="<?= base_url('spservices/employment-registration-nonaadhaar') ?>" class="mybtn" target="_blnk">
                ...
                <?php } ?>
                <?php if ($employment_exchange_nonaadhaar) : ?>
                    <table class="table">
                        <thead>
                            <tr>
                                <th width="5%">#</th>
                        ...
                        <tbody id="">
                            <?php
                            foreach ($employment_exchange_nonaadhaar as $key => $dbrow) :
                                $obj_id = $dbrow->_id->{'$id'};
                                ...
                                <tr>
                                    <td><?= ($key + 1) ?></td>
                                    <td class="txt"><a href="<?= base_url('spservices/employment-registration-nonaadhaar/view/' . $obj_id) ?>"><?= $dbrow->service_data->appl_ref_no ?></td>
                                    ...
                                    <td>
                                        <?php if ($status == "DRAFT") { ?>
                                            <a class="btn btn-primary btn-sm mbtn" href="<?= base_url("spservices/employment-registration-nonaadhaar/personal-details/") . $obj_id ?>">Complete Your Application</a>
                                        <?php } elseif ($status == "submitted") { ?>
                                            <a class="btn btn-success btn-sm mbtn" href="<?= base_url("spservices/employment-registration-nonaadhaar/acknowledgement/") . $obj_id ?>">Acknowledgement</a>
                                        ...
                                        ?>
                                            <a class="btn btn-success btn-sm mbtn" href="<?= base_url("spservices/employment-registration-nonaadhaar/acknowledgement/") . $obj_id ?>">Acknowledgement</a>
                                            <a href="<?= base_url('spservices/employment-registration-nonaadhaar/track/' . $obj_id) ?>" class="btn btn-secondary btn-sm mbtn">Track</a>
                                            <a class="btn btn-warning btn-sm mbtn" href="<?= base_url('spservices/employment-registration-nonaadhaar/personal-details/' . $obj_id) ?>">Reply to query</a>
                                            <?php
                                            ...
                                            ?>
                                                <form method="post" name="getGRN" id="getGRN" action="<?= $this->config->item('egras_grn_cin_url') ?>">
                                                    ...
                                                    <input type="hidden" id="SUB_SYSTEM" name="SUB_SYSTEM" value="ARTPS-SP|<?= base_url('spservices/employmentnonaadhaar/Payment_response/cin_response') ?>" />
                                            ...
                                            ?>
                                                <a class="btn btn-warning btn-sm mbtn" href="<?= base_url('spservices/employmentnonaadhaar/registration/finalsubmition/' . $obj_id) ?>">Verify Payment</a>
                                            <?php
                                            } else {  ?>
