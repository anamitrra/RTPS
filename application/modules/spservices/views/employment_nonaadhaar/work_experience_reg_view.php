...
<main class="rtps-container">
    <div class="container my-2">
        <form id="myfrm" method="POST" action="<?= base_url('spservices/employment-registration-nonaadhaar/save-work-experiences') ?>" enctype="multipart/form-data">
            ...
            <div class="card shadow-sm">
                ...
                <div class="card-body" style="padding:5px">
                    ...
                    <fieldset class="border border-success deed_div" style="margin-top:40px">
                                ...
                                <div class="table-responsive mb-2">
                                    <table class="table table-bordered " id="work_experience_tbl">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                    <tr>
                                                        <td><input name="employer[]" value="<?= $work_experience[$i]->employer ?>" class="form-control" type="text" /></td>
                                                        <td>
                                                            <select name="nature_of_work[]" class="form-control" id="">
                                                                <option value="">Please Select</option>
                                                        ...
                                                        <td><input name="from[]" value="<?= (strlen($work_experience[$i]->from) == 10) ? date('d-m-Y', strtotime($work_experience[$i]->from)) : '' ?>" class="form-control dp" type="text" /></td>
                                                        <td><input name="to[]" value="<?= (strlen($work_experience[$i]->to) == 10) ? date('d-m-Y', strtotime($work_experience[$i]->to)) : '' ?>" class="form-control dp" type="text" /></td>
                                                        <td><input name="duration[]" value="<?= $work_experience[$i]->duration ?>" class="form-control" type="text" /></td>
                                                        <td><input name="highest_designation[]" value="<?= $work_experience[$i]->highest_designation ?>" class="form-control" type="text" /></td>
                                                        <td><input name="last_salary_drawn[]" value="<?= $work_experience[$i]->last_salary_drawn ?>" class="form-control" type="text" /></td>
                                                        <td>
                                                            <select name="functional_roles[]" class="form-control" id="functional_roles">
                                                                <option value="">Please Select</option>
                                                        ...
                                                        <td>
                                                            <select name="industry_sector[]" class="form-control" id="industry_sector">
                                                                <option value="">Please Select</option>
                                                        ...
                                                        <td>
                                                            <select name="functional_area[]" class="form-control" id="functional_area">
                                                                <option value="">Please Select</option>
                        ...
                        <div class="row form-group">
                            <div class="col-md-6">
                                ...
                                <select name="current_employment_status" class="form-control">
                    ...
                    <fieldset class="border border-success" style="margin-top:40px">
                        ...
                        <div class="row form-group">
                            <div class="col-md-6">
                                <label>Years</label>
                                <input  type="text" class="form-control" name="years" id="years" value="<?= $years ?>"  />
                                <?= form_error("years") ?>
                            </div>
                            <div class="col-md-6">
                                <label>Months</label>
                                <input type="text" class="form-control" name="months" id="months" value="<?= $months ?>" />
                                <?= form_error("months") ?>
                            </div>
                        </div>
                    </fieldset>
                ...
                <div class="card-footer text-center">
                    <a class="btn btn-primary frmbtn"a id="DRAFT" href="<?= base_url('spservices/employment-registration-nonaadhaar/education-skill-details/' . $obj_id) ?>">
