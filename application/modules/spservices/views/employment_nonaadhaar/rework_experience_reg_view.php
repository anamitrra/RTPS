...
<main class="rtps-container">
    <div class="container my-2">
        <form id="myfrm" method="POST" action="<?= base_url('spservices/employmentnonaadhaar/reregistration/submit_work_experience') ?>" enctype="multipart/form-data">
            ...
            <div class="card shadow-sm">
                ...
                <div class="card-body" style="padding:5px">
                    ...
                    <fieldset class="border border-success deed_div" style="margin-top:40px">
                                        ...
                                        <tbody>
                                            ...
                                            if ($workExperience > 0) {
                                                for ($i = 0; $i < $workExperience; $i++) {
                                                    if ($i == 0) {
                                                        $btn = '<button class="btn btn-info" id="add_work_experience_tbl_row" type="button"><i class="fa fa-plus-circle"></i></button>';
                                                    } else {
                                                        $btn = '<button class="btn btn-danger delete_work_experience_tblrow" type="button"><i class="fa fa-trash-o"></i></button>';
                                                    } // End of if else 
                                            ?>
                                                    <tr>
                                                        <td><input <?php ($type_of_reg == '4')? print  "": print "disabled"; ?> name="employer[]" value="<?= $work_experience[$i]->employer ?>" class="form-control" type="text" /></td>
                                                        <td>
                                                            <select <?php ($type_of_reg == '4')? print  "": print "disabled"; ?> name="nature_of_work[]" class="form-control" id="">
                                                                <option value="">Please Select</option>
                                                        ...
                                                        <td><input <?php ($type_of_reg == '4')? print  "": print "disabled"; ?> name="from[]" value="<?= (strlen($work_experience[$i]->from) == 10) ? date('d-m-Y', strtotime($work_experience[$i]->from)) : '' ?>" class="form-control dp" type="text" /></td>
                                                        <td><input <?php ($type_of_reg == '4')? print  "": print "disabled"; ?> name="to[]" value="<?= (strlen($work_experience[$i]->to) == 10) ? date('d-m-Y', strtotime($work_experience[$i]->to)) : '' ?>" class="form-control dp" type="text" /></td>
                                                        <td><input <?php ($type_of_reg == '4')? print  "": print "disabled"; ?> name="duration[]" value="<?= $work_experience[$i]->duration ?>" class="form-control" type="text" /></td>
                                                        <td><input <?php ($type_of_reg == '4')? print  "": print "disabled"; ?> name="highest_designation[]" value="<?= $work_experience[$i]->highest_designation ?>" class="form-control" type="text" /></td>
                                                        <td><input <?php ($type_of_reg == '4')? print  "": print "disabled"; ?> name="last_salary_drawn[]" value="<?= $work_experience[$i]->last_salary_drawn ?>" class="form-control" type="text" /></td>
                                                        <td>
                                                            <select <?php ($type_of_reg == '4')? print  "": print "disabled"; ?> name="functional_roles[]" class="form-control" id="functional_roles">
                                                                <option value="">Please Select</option>
                                                        ...
                                                        <td class="other_functional_roles d-none"><input <?php ($type_of_reg == '4')? print  "": print "disabled"; ?> name="other_functional_roles[]" class="form-control " type="text" /></td>
                                                        <td>
                                                            <select <?php ($type_of_reg == '4')? print  "": print "disabled"; ?> name="industry_sector[]" class="form-control" id="industry_sector">
                                                                <option value="">Please Select</option>
                                                        ...
                                                        <td class="other_industry_sector d-none"><input name="other_industry_sector[]" class="form-control" type="text" /></td>
                                                        <td>
                                                            <select <?php ($type_of_reg == '4')? print  "": print "disabled"; ?> name="functional_area[]" class="form-control" id="functional_area">
                                                                <option value="">Please Select</option>
                                                        ...
                                                        <td class="other_functional_area d-none"><input <?php ($type_of_reg == '4')? print  "": print "disabled"; ?> name="other_functional_area[]" class="form-control" type="text" /></td>
                                                        <td>
                                                ...
                                                <tr>
                                                    <td><input <?php ($type_of_reg == '4')? print  "": print "disabled"; ?> name="employer[]" class="form-control" type="text" /></td>
                                                    <td>
                                                        <select <?php ($type_of_reg == '4')? print  "": print "disabled"; ?> name="nature_of_work[]" class="form-control" id="">
                                                            <option value="">Please Select</option>
                                                            <option value="Full time"> Full time</option>
                                                    ...
                                                    <td><input <?php ($type_of_reg == '4')? print  "": print "disabled"; ?> name="from[]" class="form-control dp" type="text" /></td>
                                                    <td><input <?php ($type_of_reg == '4')? print  "": print "disabled"; ?> name="to[]" class="form-control dp" type="text" /></td>
                                                    <td><input <?php ($type_of_reg == '4')? print  "": print "disabled"; ?> name="duration[]" class="form-control" type="text" /></td>
                                                    <td><input <?php ($type_of_reg == '4')? print  "": print "disabled"; ?> name="highest_designation[]" class="form-control" type="text" /></td>
                                                    <td><input <?php ($type_of_reg == '4')? print  "": print "disabled"; ?> name="last_salary_drawn[]" class="form-control" type="text" /></td>
                                                    <td>
                                                        <select <?php ($type_of_reg == '4')? print  "": print "disabled"; ?> name="functional_roles[]" class="form-control" id="functional_roles">
                                                            <option value="">Please Select</option>
                                                            <?php foreach ($functionalRoles as $functional_role) {
                                                    ...
                                                    <td class="other_industry_sector d-none"><input <?php ($type_of_reg == '4')? print  "": print "disabled"; ?> name="other_industry_sector[]" class="form-control" type="text" /></td>
                                                    <td>
                                                        <select <?php ($type_of_reg == '4')? print  "": print "disabled"; ?> name="functional_area[]" class="form-control" id="functional_area">
                                                            <?php foreach ($functionalArea as $function_area) {
                                                    ...
                                                    <?php if($type_of_reg == '4'){ ?>
                                                        <button class="btn btn-info" id="add_work_experience_tbl_row" type="button">
                        ...
                        <div class="row form-group">
                            <div class="col-md-6">
                                ...
                                <select <?php ($type_of_reg == '4')? print  "": print "disabled"; ?> name="current_employment_status" class="form-control">
                                    <?php if (count($editable_fields)) {
                                        if (in_array('current_employment_status', $editable_fields)) { ?>
                                            <option value="">Please Select</option>
                                        ...
                                        <?php } else {
                                            echo '<option value="' . $current_employment_status . '" selected>' . $current_employment_status . '</option>';
                                        }
                                    } else { ?>
                                        <option value="">Please Select</option>
                                        <option value="Apprentice" <?= ($current_employment_status === "Apprentice") ? 'selected' : '' ?>>Apprentice</option>
                    ...
                    <fieldset class="border border-success" style="margin-top:40px">
                        ...
                        <div class="row form-group">
                            <div class="col-md-6">
                                <label>Years</label>
                                <input <?php ($type_of_reg == '4')? print  "": print "disabled"; ?> type="text" class="form-control" name="years" id="years" value="<?= $years ?>"  <?= (count($editable_fields)) ? ((in_array('years', $editable_fields)) ? '' : 'readonly') : '' ?> />
                                <?= form_error("years") ?>
                            </div>
                            <div class="col-md-6">
                                <label>Months</label>
                                <input <?php ($type_of_reg == '4')? print  "": print "disabled"; ?> type="text" class="form-control" name="months" id="months" value="<?= $months ?>" <?= (count($editable_fields)) ? ((in_array('months', $editable_fields)) ? '' : 'readonly') : '' ?> />
                                <?= form_error("months") ?>
                            </div>
                        </div>
                    </fieldset>
                ...
                <div class="card-footer text-center">
                    <a class="btn btn-primary frmbtn"a id="DRAFT" href="<?= base_url('spservices/employment-reregistration-nonaadhaar/education-skill-details/' . $obj_id) ?>">
