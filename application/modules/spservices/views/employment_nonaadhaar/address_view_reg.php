...
<main class="rtps-container">
    <div class="container my-2">
        <form id="myfrm" method="POST" action="<?= base_url('spservices/employment-registration-nonaadhaar/save-address') ?>" enctype="multipart/form-data">
            ...
            <div class="card shadow-sm">
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="district_p" class="form-control" id="district_p">
                                    ...
                                    <?php if ($appl_status == 'QS') { ?>
                                        <option value="<?= $district_p ?>" selected><?= $district_p ?></option>
                                        <?php } else {
                ...
                <div class="card-footer text-center">
                    <a class="btn btn-primary frmbtn" id="DRAFT" href="<?= base_url('spservices/employment-registration-nonaadhaar/personal-details/' . $obj_id) ?>">
