...
<main class="rtps-container">
    <div class="container my-2">
        <form id="myfrm" method="POST" action="<?= base_url('spservices/employment-registration-nonaadhaar/save-enclosures') ?>" enctype="multipart/form-data">
            ...
            <div class="card shadow-sm">
                        ...
                        <div class="modal-dialog modal-lg modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <div class="modal-body" style="text-align:justify">
                                    ...
                                    <p>1. All the information provided by the applicants in the ARTPS Portal for online registration is deemed to be true & correct. The verification of the information is a continuous process. If any information at any stage is found to be wrong/false/ incorrect the registration will be automatically cancelled & action may be initiated against the applicant as per law. Applicant has given/submitted his/her permanent address with proper documents and if any variation found he/she will be personally liable/responsible and his/her registration may be cancelled at any time.<br>
                                    2. The Directorate of Employment & Craftsmen Training( DECT), Rehabari, Guwahati, Assam reserves the right to modify the terms & conditions either partially or fully at any time.<br>
                                    3. The applicants will be solely responsible for authenticity of any information supplied by him/her & also for updating it periodically. Information so received from the applicants shall be accessible by any employer/ placement agency/skill provider etc.<br>
                                    4. The user of this service will not be able to claim any copyright or other Intellectual Property Rights over the data uploaded by him/her on the portal & is expected to abide by relevant rules & regulations enforced from time to time.<br>
                                    5. The DECT reserves its right to reject & delete any profile (part or whole) or information fed in by the users in case of violation of any of its extant rules & regulations.<br>
                                    6.The DECT is neither responsible for the selection or non-selection of any candidate by any employer or placement agency etc. nor it shall be responsible for any loss or damage caused to the applicant ,if any, for using services of the portal. Directorate shall not be responsible for job offer, terms of employment and/or conditions of service.<br>
                                    7. Posting of irrelevant, defamatory, obscene, communal, racist, offensive, abusive, hateful and discriminatory contents whether implicitly or explicitly is strictly prohibited.<br>
                                    8. DECT reserves its right to change the look, design, prominence, depiction, classification of the information template on the portal in order to improve the representation of information at any time without giving any notice.<br>
                                    9. The applicants are solely responsible for maintaining the confidentiality of their online registration account & password.<br>
                                    10. In case of any disputes arising from & related to this content, the jurisdiction shall be the Honourable High Court, Guwahati, Assam or its subordinate court as the case may be within the territory of state of Assam.
                                    </p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="card-footer text-center">
                    <a class="btn btn-primary frmbtn" id="DRAFT" href="<?= base_url('spservices/employment-registration-nonaadhaar/slot-booking/' . $obj_id) ?>">
