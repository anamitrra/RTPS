                    ...
                    <fieldset class="border border-success" style="margin-top:40px">
                        ...
                        <div class="row form-group">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="applicant_name" id="applicant_name" value="<?= $applicant_name ?>" <?= ($appl_status == 'QS') ? 'readonly' : '' ?> />
                        ...
                        <div class="row form-group">
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    <input class="form-control" name="mobile_number" id="mobile_number" maxlength="10" value="<?= $mobile_number ?>" <?= ($mobile_verify_status == 1) ? 'readonly' : (($this->slug === 'user') ? 'readonly' : '') ?> type="text" <?= ($appl_status == 'QS') ? 'readonly' : '' ?> />
                        ...
                        <div class="row form-group">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="fathers_name" id="fathers_name" value="<?= $fathers_name ?>" />
                    ...
                    <fieldset class="border border-success" style="margin-top:40px">
                        ...
                        <div class="row form-group">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="fathers_name_guardians_name" id="fathers_name_guardians_name" value="<?= $fathers_name_guardians_name ?>" />
                                <?= form_error("fathers_name_guardians_name") ?>
                            </div>
                            <div class="col-md-6">
                                <label>Mother Name <span class="text-danger">*</span> </label>
                                <input type="text" class="form-control" name="mothers_name" id="mothers_name" value="<?= $mothers_name ?>" />
                        ...
                        <div class="row form-group">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control dp" name="date_of_birth" id="date_of_birth" value="<?= $date_of_birth ?>" />
                        ...
                        <div class="row form-group">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="husbands_name" id="husbands_name" value="<?= $husbands_name ?>" />
                    ...
                    <fieldset class="border border-success" style="margin-top:40px">
                        ...
                        <div class="row form-group">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="height_in_cm" value="<?= $height_in_cm ?>" />
                                <?= form_error("height_in_cm") ?>
                            </div>
                            <div class="col-md-6">
                                <label>Weight (Kgs) </label>
                                <input type="text" class="form-control" name="weight_kgs" value="<?= $weight_kgs ?>" />
                        ...
                        <div class="row form-group">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="eye_sight" value="<?= $eye_sight ?>" />
                                <?= form_error("eye_sight") ?>
                            </div>
                            <div class="col-md-6">
                                <label>Chest (Inch) </label>
                                <input type="text" class="form-control" name="chest_inch" value="<?= $chest_inch ?>" />
