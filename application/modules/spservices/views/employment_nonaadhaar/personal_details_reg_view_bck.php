...
<main class="rtps-container">
    <div class="container my-2">
        <form id="myfrm" method="POST" action="<?= base_url('spservices/employment-registration-nonaadhaar/save-personal-details') ?>" enctype="multipart/form-data">
                    ...
                    <fieldset class="border border-success" style="margin-top:40px">
                        ...
                        <div class="row form-group">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="applicant_name" id="applicant_name" value="<?= $applicant_name ?>" <?= (count($editable_fields)) ? ((in_array('applicant_name', $editable_fields)) ? '' : 'readonly') : '' ?> />
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-md-6">
                                <label>E-Mail</label>
                                <input type="email" class="form-control" name="e_mail" value="<?= $e_mail ?>" <?= (count($editable_fields)) ? ((in_array('e_mail', $editable_fields)) ? '' : 'readonly') : '' ?> />
                                <?= form_error("e_mail") ?>
                            </div>
                        </div>
                        ...
                        <div class="row form-group">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="fathers_name" id="fathers_name" value="<?= $fathers_name ?>" <?= (count($editable_fields)) ? ((in_array('fathers_name', $editable_fields)) ? '' : 'readonly') : '' ?> />
                    ...
                    <fieldset class="border border-success" style="margin-top:40px">
                        ...
                        <div class="row form-group">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="fathers_name_guardians_name" id="fathers_name_guardians_name" value="<?= $fathers_name_guardians_name ?>" <?= (count($editable_fields)) ? ((in_array('fathers_name_guardians_name', $editable_fields)) ? '' : 'readonly') : '' ?> />
                                <?= form_error("fathers_name_guardians_name") ?>
                            </div>
                            <div class="col-md-6">
                                <label>Mother Name <span class="text-danger">*</span> </label>
                                <input type="text" class="form-control" name="mothers_name" id="mothers_name" value="<?= $mothers_name ?>" <?= (count($editable_fields)) ? ((in_array('mothers_name', $editable_fields)) ? '' : 'readonly') : '' ?> />
                        ...
                        <div class="row form-group">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control dp" name="date_of_birth" id="date_of_birth" value="<?= $date_of_birth ?>" <?= (count($editable_fields)) ? ((in_array('date_of_birth', $editable_fields)) ? '' : 'readonly') : '' ?> />
                        ...
                        <div class="row form-group">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="husbands_name" id="husbands_name" value="<?= $husbands_name ?>" <?= (count($editable_fields)) ? ((in_array('husbands_name', $editable_fields)) ? '' : 'readonly') : '' ?> />
                            ...
                            <div class="col-md-6">
                                ...
                                <?php if (count($editable_fields)) {
                                    ...
                                    <?php } else { ?>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input ex_serviceman" type="radio" name="whether_ex_servicemen" id="ex_service_yes" <?= ($whether_ex_servicemen === "Yes") ? 'checked' : 'disabled' ?> value="Yes">
                                            <label class="form-check-label" for="ex_service_yes">Yes</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input ex_serviceman" type="radio" name="whether_ex_servicemen" id="ex_service_no" <?= ($whether_ex_servicemen === "No") ? 'checked' : 'disabled' ?> value="No">
                                            <label class="form-check-label" for="ex_service_no">No</label>
                                        </div>
                                    <?php }
                                } else { ?>
                        ...
                        <div class="row form-group"> -->
                            <div class="col-md-6 mt-3">
                                ...
                                <input type="text" class="form-control" name="unique_identification_no" id="unique_identification_no" value="<?= $unique_identification_no ?>" <?= count($editable_fields) ? ((in_array('unique_identification_no', $editable_fields)) ? '' : 'readonly') : '' ?> />
                                <?= form_error("unique_identification_no") ?>
                            </div>
                            <div class="col-md-6 mt-3">
                                <label>Prominent Identification Mark <span class="text-danger">*</span> </label>
                                <input type="text" class="form-control" name="prominent_identification_mark" id="prominent_identification_mark" value="<?= $prominent_identification_mark ?>" <?= count($editable_fields) ? ((in_array('prominent_identification_mark', $editable_fields)) ? '' : 'readonly') : '' ?> />
                    ...
                    <fieldset class="border border-success" style="margin-top:40px">
                        ...
                        <div class="row form-group">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="height_in_cm" value="<?= $height_in_cm ?>" <?= count($editable_fields) ? ((in_array('height_in_cm', $editable_fields)) ? '' : 'readonly') : '' ?> />
                                <?= form_error("height_in_cm") ?>
                            </div>
                            <div class="col-md-6">
                                <label>Weight (Kgs) </label>
                                <input type="text" class="form-control" name="weight_kgs" value="<?= $weight_kgs ?>" <?= count($editable_fields) ? ((in_array('weight_kgs', $editable_fields)) ? '' : 'readonly') : '' ?> />
                        ...
                        <div class="row form-group">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="eye_sight" value="<?= $eye_sight ?>" <?= count($editable_fields) ? ((in_array('eye_sight', $editable_fields)) ? '' : 'readonly') : '' ?> />
                                <?= form_error("eye_sight") ?>
                            </div>
                            <div class="col-md-6">
                                <label>Chest (Inch) </label>
                                <input type="text" class="form-control" name="chest_inch" value="<?= $chest_inch ?>" <?= count($editable_fields) ? ((in_array('chest_inch', $editable_fields)) ? '' : 'readonly') : '' ?> />
