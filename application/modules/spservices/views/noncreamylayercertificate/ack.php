...
$pfc_payment_status = isset($response->form_data->pfc_payment_status) ? $response->form_data->pfc_payment_status : '';
                    ...
                    <div class="card-body">
                        ...
                        <div class="row akno">
                            <span><u>Acknowledgement no:
                                ...
                                <?= isset($response->service_data->rtps_trans_id) ? $response->service_data->rtps_trans_id : '' ?><u>and eDistrict Ref. No.</u> <?=isset($response->form_data->edistrict_ref_no)?$response->form_data->edistrict_ref_no:''?></span>
                        ...
                        <div class="row">
                            <p style="text-align:justify; line-height: 24px">
                                ...
                                <strong><?= isset($response->service_data->rtps_trans_id) ? $response->service_data->rtps_trans_id : '' ?></strong> and eDistrict Ref. No. <strong><?=isset($response->form_data->edistrict_ref_no)?$response->form_data->edistrict_ref_no:''?></strong>
                                ...
                                <strong><?= isset($response->service_data->service_timeline) ? $response->service_data->service_timeline . ' days' : '' ?></strong>
                                days.
                        ...
                        <!-- fee description -->
                        <?php if (!empty($response->form_data->pfc_payment_status) && $response->form_data->pfc_payment_status === "Y") { ?>
                        ...
                        <div class="row">
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td><?= ($response->form_data->no_printing_page) * ($response->form_data->printing_charge_per_page) . ".00" ?>
                                    </td>
                                </tr>
                                <?php endif; ?>
                                ...
                                <tr>
                                    ...
                                    <td><?= ($response->form_data->no_scanning_page) * ($response->form_data->scanning_charge_per_page) . ".00" ?>
                                    </td>
                                </tr>
                                <?php endif; ?>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <!-- <td><?= $response->form_data->pfc_payment_response->AMOUNT ?></td> -->
                                </tr>
                                <tr>
                                    <td colspan="2"><b>Payment GRN:
                                        </b><?= $response->form_data->pfc_payment_response->GRN ?>
                                    </td>
                                </tr>
                            </table>
                        </div>
            ...
            <div class="col-sm-12 mx-auto">
                <div class="card my-4 " style="border: 1px solid;padding:20px">
                    <div class="card-body">
                        ...
                        <div class="row akno">
                            <span><u>স্বীকৃতি নম্বৰ: </u><?=isset($response->service_data->rtps_trans_id)?$response->service_data->rtps_trans_id:''?><u>,</u><?=isset($response->form_data->edistrict_ref_no)?$response->form_data->edistrict_ref_no:''?></span>
...
{
    $total = 40;
    if (!empty($response->form_data->pfc_payment_status) && $response->form_data->pfc_payment_status === "Y") {

        if (!empty($response->form_data->no_printing_page)) {
            $total  +=  ($response->form_data->no_printing_page) * ($response->form_data->printing_charge_per_page);
        }

        if (!empty($response->form_data->no_scanning_page)) {
            $total +=  ($response->form_data->no_scanning_page) * ($response->form_data->scanning_charge_per_page);
        }

        if (!empty($response->form_data->service_charge)) {
            $total += $response->form_data->service_charge;
        }
