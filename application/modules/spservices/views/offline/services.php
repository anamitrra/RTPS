    ...
    <div class="content-header">
      <div class="container-fluid">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active"><a href="">Offline Services</a></li>
    ...
    <div class="container">
      ...
      <div class="card my-12">
        <div class="card-header">
          <h3 class="card-title">Offline Services</h3>
          <?php echo anchor(site_url('spservices/offline/servicelist/form'), 'Create Service', 'class="btn btn-sm btn-primary float-right"'); ?>
        </div>
        <div class="card-body">
        <div class="row">
...
<script>
  $(document).ready(function() {
    ...
    var table = $('#applications').DataTable({
            ...
            "ajax": {
                url: "<?php echo site_url("spservices/offline/servicelist/get_records") ?>",
                type: 'POST',
                beforeSend: function () {
