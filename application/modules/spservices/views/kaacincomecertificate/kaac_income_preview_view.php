        ...
        <div class="card shadow-sm" id="printDiv">
            ...
            <div class="card-body" style="padding:5px">
                ...
                <fieldset class="border border-success table-responsive" style="margin-top:40px">
                    ...
                    <table class="table table-borderless" style="margin-top:0px;margin-bottom:0px;border-collapse: collapse;width: 100%;table-layout: fixed;">
                        <tbody style="border-top: none !important">
                            <tr>
                                <td>Applicant Category/ আবেদনকাৰীৰ শ্ৰেণী নিৰ্বাচন কৰক <br><strong><?= $applicant_category_text ?></strong></td>
                            </tr>
                        </tbody>
                    </table>
                </fieldset>
                <?php if($applicant_category == 1 || $applicant_category == 2) { ?> 
                <fieldset class="border border-success table-responsive" style="margin-top:40px">
            ...
            <div class="card-footer text-center no-print">
                <?php if ($appl_status === 'DRAFT') { ?>
                    <a href="<?= base_url('spservices/kaacincomecertificate/registration/index/' . $obj_id) ?>" class="btn btn-primary">
                ...
                <?php if (($appl_status != 'QA') && ($appl_status != 'QS') && ($appl_status == 'DRAFT')) { ?>
                    ...
                    <a href="<?= base_url('spservices/kaacincomecertificate/payment/initiate/' . $obj_id) ?>" class="btn btn-success">
