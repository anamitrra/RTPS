<main class="rtps-container">
    <form  method="POST" action="<?= base_url('spservices/marriageregistration_landhub/payment/submit') ?>">
            ...
            <div class="card shadow-sm" id="printDiv" style="background:#E6F1FF">
                ...
                <div class="card-body" >
                    ...
                    <fieldset class="border border-success table-responsive" style="margin-top:40px">
                        ...
                        <input name="objid" value="<?= $objid ?>" type="hidden" />
                        <input name="rtps_trans_id" value="<?= $dbrow->rtps_trans_id ?>" type="hidden" />
