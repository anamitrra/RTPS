...
<main class="rtps-container">
    <div class="container my-2">
        <form method="POST" action="<?= base_url('spservices/marriageregistration_landhub/fileuploads/submit') ?>" enctype="multipart/form-data">
            ...
            <div class="card shadow-sm">
                ...
                <div class="card-footer text-center">
                    <a href="<?=site_url('spservices/marriageregistration_landhub/groomdetails/index/'.$dbrow->{'_id'}->{'$id'})?>" class="btn btn-primary">
