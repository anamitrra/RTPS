<main class="rtps-container">
    <form method="POST" action="<?= base_url('spservices/kaac_noc_trade_license/payment/submit') ?>">
                    ...
                    <fieldset class="border border-success table-responsive" style="margin-top:40px">
                        ...
                        <div class="row form-group">
                            ...
                            <!-- <div class="col-md-4">
                                ...
                                <input type="text" class="form-control" name="edistrict_amtron_charge" id="edistrict_amtron_charge" value="<?= $edistrict_amtron_charge ?>" readonly />
                                <?= form_error("edistrict_amtron_charge") ?>
                            </div> -->
                            <div class="col-md-4">
                                <label>Convenience Charge<span class="text-danger">*</span> </label>
                                <input type="text" class="form-control" name="rtps_convenience_fee" id="rtps_convenience_fee" value="<?= $rtps_convenience_fee ?>" readonly />
                                <?= form_error("rtps_convenience_fee") ?>
                            </div>
