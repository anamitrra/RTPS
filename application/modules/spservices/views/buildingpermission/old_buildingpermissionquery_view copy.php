...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $.getJSON("<?=$apiURL?>ward", function(data) {
            ...
            var panchayat = "<?php print $panchayat; ?>";
            if (panchayat == 0) {
                $("#ward_no option").each(function() {
                    if (this.value == 0)
                        $(this).hide();
                    else
                        $(this).show();
        ...
        $(document).on("change", "#revenue_village", function(){
            ...
            var revenue_village = $("#revenue_village").val();
            $.getJSON("<?=$apiURL?>get-panchayat-zone?villageId="+revenue_village, function(data) {
                // console.log(data);
                //Panchayat
                let selectOption = '';
                $('#panchayat').empty().append('<option value="">Please Select</option>');
                selectOption += '<option value="'+data.panchayatId+'">'+data.panchayatName+'</option>';
                $('#panchayat').append(selectOption);

                //Zone
                let selectOptions = '';
                $('#zone').empty().append('<option value="">Please Select</option>');
                selectOptions += '<option value="'+data.zoneId+'">'+data.zoneName+'</option>';
                $('#zone').append(selectOptions);
            });
        });

        <?php if(!empty($revenue_village)){ ?>
        $.getJSON("<?=$apiURL?>get-panchayat-zone?villageId="+"<?php print $revenue_village; ?>", function(data) {
            console.log(data);
            //Panchayat
            let selectOption = '';
            $('#panchayat').empty().append('<option value="">Please Select</option>');
            if ("<?php print $panchayat; ?>" == data.panchayatId){
                selectOption += '<option value="'+data.panchayatId+'" selected>'+data.panchayatName+'</option>';
                $("#panchayat_name").val(data.panchayatName);
            }
            $('#panchayat').append(selectOption);
            ...
            let selectOptions = '';
            $('#zone').empty().append('<option value="">Please Select</option>');
            if ("<?php print $zone; ?>" == data.zoneId){
                selectOptions += '<option value="'+data.zoneId+'" selected>'+data.zoneName+'</option>';
                $("#zone_name").val(data.zoneName);
            }
            $('#zone').append(selectOptions);
        });
        <?php } ?>
        ...
        $(document).on("change", "#panchayat", function(){
            ...
            $("#panchayat_name").val($("#panchayat option:selected").text());
                    ...
                    <fieldset class="border border-success" style="margin-top:40px">
                        ...
                        <div class="row form-group">
                            <div class="col-md-6">
                                ...
                                <select name="ertp" class="form-control" id="ertp" readonly>
                                    <option value="">Please Select</option>
                        ...
                        <div class="row form-group">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="technical_person_name" id="technical_person_name" value="<?=$technical_person_name?>" maxlength="255" readonly/>
                        ...
                        <div class="row form-group">
                            <div class="col-md-6">
                                ...
                                <input type="hide" name="empanelled_reg_tech_person_name" id="empanelled_reg_tech_person_name" hidden/>
                                <?= form_error("empanelled_reg_tech_person") ?>
                            </div>
                            <div class="col-md-6">
                            </div>
                    ...
                    <fieldset class="border border-success" style="margin-top:40px" id="site_address">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="mouza_name" id="mouza_name" hidden/>
                                <?= form_error("mouza") ?>
                            </div>   
                        </div>
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="panchayat_name" id="panchayat_name" hidden/>
                        ...
                        <div class="row form-group">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="revenue_village_name" id="revenue_village_name" hidden/>
                        ...
                        <div class="row form-group">
                            <div class="col-md-6">
                                ...
                                <input name="zone_name" id="zone_name" type="text" hidden/>
                                <?= form_error("zone") ?>
                            </div>  
                            <div class="col-md-6">
                        ...
                        <div class="row form-group">
                            <div class="col-md-6">
                                ...
                                <input id="ward_no_name" name="ward_no_name" type="text" hidden/>
                                <?= form_error("ward_no") ?>
                            </div>  
                            <div class="col-md-6">
