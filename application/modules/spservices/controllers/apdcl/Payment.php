      ...
      // die;
        ...
        if($obj_id){
          ...
          if (property_exists($dbRow, 'pfc_payment_status') && $dbRow->form_data->pfc_payment_status == 'Y') { 
              $this->application_submission($obj_id,"apdcl1");
          ...
          if($this->is_admin()){
              ...
              $this->load->view('apdcl/kiosk_payment',$data);
    ...
    public function citizen_payment($obj_id){
     ...
     //  pre($transaction_data);
      ...
      $data['department_data']=array(
        ...
        "SUB_SYSTEM"=>"ARTPS-SP|".base_url('spservices/apdcl/payment_response/response'),
...
//pre($data);
    ...
    private function check_pfc_payment_status($DEPARTMENT_ID=null){
      ...
      if($DEPARTMENT_ID){
        ...
        $ref=modules::load('spservices/apdcl/Payment_response');
