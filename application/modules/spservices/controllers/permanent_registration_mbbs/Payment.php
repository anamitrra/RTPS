...
class Payment extends Rtps
{
    ...
    public function application_submission($obj_id, $service_id)
    {
        if ($service_id === $this->serviceId) {
            $ref = modules::load('spservices/permanent_registration_mbbs/registration');
    ...
    private function check_pfc_payment_status($DEPARTMENT_ID = null)
    {
        if ($DEPARTMENT_ID) {
            ...
            $ref = modules::load('spservices/permanent_registration_mbbs/Payment_response');
    ...
    public function initiate($obj_id = null)
    {
        ...
        if (count((array) $dbRow)) {
            ...
            if (!empty($this->session->userdata('role'))) {
                ...
                $this->load->view('permanent_registration_mbbs/kiosk_payment', $data);
        ...
        if (count((array) $dbRow)) {
            ...
            if ($this->slug === "user") {
                $data['department_data'] = array(
                    ...
                    "REC_FIN_YEAR" => getFinYear(), //added sbk
                    "HOA1" => "",
                    ...
                    "SUB_SYSTEM" => "ARTPS-SP|" . base_url('spservices/permanent_registration_mbbs/payment_response/response'),
                    ...
                    "AC1_AMOUNT" => $application_charge,
                    "ACCOUNT1" => "DME17589", //$user->account1,$account = "PFC23362";	
                    // "ACCOUNT1" => $dbRowGras->account_code,	
                    "AC2_AMOUNT" => $this->convenience_fee + $gst,
                    "ACCOUNT2" => "ARI64576",	
