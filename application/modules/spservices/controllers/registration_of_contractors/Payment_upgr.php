...
class Payment_upgr extends Rtps
{
    ...
    {
        $ref = modules::load('spservices/registration_of_contractors/upgradation');
    ...
    private function check_pfc_payment_status($DEPARTMENT_ID = null)
    {
        if ($DEPARTMENT_ID) {
            ...
            $ref = modules::load('spservices/registration_of_contractors/Payment_response_upgr');
    ...
    public function initiate($obj_id = null)
    {
        ...
        if (count((array) $dbRow)) {
            ...
            if (!empty($this->session->userdata('role'))) {
                ...
                $this->load->view('registration_of_contractors/kiosk_payment_upgr', $data);
        ...
        if (count((array) $dbRow)) {
            ...
            if ($this->slug === "user") {
                $data['department_data'] = array(
                    ...
                    "SUB_SYSTEM" => "ARTPS-SP|" . base_url('spservices/registration_of_contractors/Payment_response_upgr/response'),
