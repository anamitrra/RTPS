...
class Payment_query extends Rtps
{
    ...
    private function check_query_payment_status($DEPARTMENT_ID = null) {
        if ($DEPARTMENT_ID) {
            ...
            $ref = modules::load('spservices/kaac_brc/Payment_query_response');
        ...
        if (count((array) $dbRow)) {
            ...
            $data['query_payment'] = true;
                ...
                $data['department_data'] = array(
                    ...
                    "SUB_SYSTEM" => "ARTPS-SP|" . base_url('spservices/kaac_brc/payment_query_response/response'),
                    ...
                    "ACCOUNT1" => $this->config->item('kaac_query_account'), //$dbRowGras->ACCOUNT1,
                );
