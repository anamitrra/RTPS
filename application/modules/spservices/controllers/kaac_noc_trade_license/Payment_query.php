...
class Payment_query extends Rtps
{
    ...
    private function check_query_payment_status($DEPARTMENT_ID = null) {
        if ($DEPARTMENT_ID) {
            ...
            // pre("yt");
            $ref = modules::load('spservices/kaac_noc_trade_license/Payment_query_response');
...
// pre($grndata);
    ...
    public function initiate($obj_id = null) {
        ...
        if (count((array) $dbRow)) {
            ...
            // pre("HIIIIIIIIIIIII ne wnew neewew");
        ...
        if (count((array) $dbRow)) {
            ...
            $data['query_payment'] = true;
                ...
                $data['department_data'] = array(
                    ...
                    "SUB_SYSTEM" => "ARTPS-SP|" . base_url('spservices/kaac_noc_trade_license/payment_query_response/response'),
    ...
    public function update_query_payment_amount($data, $application_charge){
        ...
        if ($result->getMatchedCount()) {
            if (isset($data['query_payment'])) {
                ...
                $data_to_update_history['form_data']['query_department_id'] = $payment_params['DEPARTMENT_ID'];
