...
class tlapi extends frontend {
    ...
    public function update_data() { 
        ...
        $dbrow = $this->tradelicence_model->get_row(array('service_data.appl_id'=>(int)$applId));
            ...
            if($status === 'QS') {
                 if (strlen($applId) < 9) {
                    ...
                    $sms=array(
                        ...
                        "service_name" => 'APPLICATION FORM FOR TRADING LICENCE',
                 ...
                 if (strlen($applId) < 9) {
                    ...
                    if (!is_dir($dirPath)) {
                        ...
                        file_put_contents($dirPath . "index.html", '<html><head></head><body>This directory contains files for APPLICATION FORM FOR TRADING LICENCE only</body></html>');
                    }
                 ...
                 if (strlen($applId) < 9) {
                    ...
                    $this->tradelicence_model->update_where(['_id' => new ObjectId($dbrow->_id->{'$id'})], $data);
