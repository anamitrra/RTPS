...
class Payment_query extends Rtps
{
    ...
    private function check_query_payment_status($DEPARTMENT_ID = null) {
        if ($DEPARTMENT_ID) {
            ...
            $ref = modules::load('spservices/trade_licence/Payment_query_response');
    ...
    public function initiate($obj_id = null) {
        ...
        if (count((array) $dbRow)) {
            ...
            $this->tradelicence_model->update_where(['_id' => new ObjectId($obj_id)], array('service_data.appl_status'=>'FRS')); //Update status  
    ...
    private function payment_make($obj_id = null)
    {
        ...
        if (count((array) $dbRow)) {
            ...
            $application_charge = $dbRow->service_data->amount;
            ...
            $data['department_data'] = array(
                ...
                "SUB_SYSTEM" => "ARTPS-SP|" . base_url('spservices/trade_licence/Payment_query_response/response'),
                ...
                "TOTAL_NON_TREASURY_AMOUNT" => $application_charge,
                "AC1_AMOUNT" => $application_charge,
                "ACCOUNT1" => "ITD42971", //$user->account1,
            );
            
            $res = $this->update_query_payment_amount($data, $application_charge);
    ...
    public function update_query_payment_amount($data, $application_charge){
        ...
        $result=$this->tradepermit_model->update_payment_status($appl_ref_no,$data_to_update);
