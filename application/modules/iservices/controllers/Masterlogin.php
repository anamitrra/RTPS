...
class Masterlogin extends Frontend
{
  ...
  {
    if ($this->check_logintoken($login_token)) {
      $this->isLoggedIn();
    } else {
  ...
  public function process_login()
  {
    ...
    $checkUserExist = $this->checkUser($mobile);
  ...
  public function check_logintoken($token)
  {
    $key = "rtps";
    $actual_token = "developer";
  ...
  function get_user($mobile)
  {
    ...
    $res = $this->mongo_db->find_one('front_users');
    return $res;
  }
}
