        ...
        <div class="card shadow">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-7">
                        <a href="<?= base_url('iservices/serviceplus/view_form_data/' . $object_id) ?>" target="_blank">View Form Data</a>
                    </div>
                </div>


                <?php if (isset($data->applicant_query) && $data->applicant_query == true) { ?>
                    <p style="font-size:20px;margin-top:5px;"><label><i class="fa fa-hand-o-right" aria-hidden="true"></i><span class="text-danger"> Waiting for applicant response. Please <a href="<?= isset($action_tiny_url) ? $action_tiny_url : ''; ?>" class="btn btn-info btn-sm">click here</a> to proceed.</span></label></p>
                <?php } ?>
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td scope="col">
                                        ...
                                        ?>
                                            <a href="<?= base_url("iservices/serviceplus/issued_doc/") . $curr_process_id . '/' . $object_id ?>"><?= $doc_label ?></a>
                                        <?php
                                        }
                                        ?>
                                    </td>
                            ...
                            <tr>
                                ...
                                <td scope="col">
                                    ...
                                    if (isset($data->certs)) {
                                        ...
                                        $current_process_id = 'NA';
                                    }
                                    if ($current_process_id != '') {
                                    ?>
                                        <a href="<?= base_url("iservices/serviceplus/issued_doc/") . $current_process_id . '/' . $object_id ?>">Download Application Submission Acknowledgement</a>
                                    <?php
                                    } else {
                                        echo 'NA';
                                    }
                        ...
                        ?>
                            ...
                            <tr>
                                ...
                                <td scope="col">
                                    ...
                                    if ($current_process_id != '') {
                                    ?>
                                        <a href="<?= base_url("iservices/serviceplus/issued_doc/") . $current_process_id . '/' . $object_id ?>">Download Issued Document</a>
                                    <?php
                                    } else {
                                        echo 'NA';
                                    }
