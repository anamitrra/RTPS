        ...
        <div class="card shadow">
            ...
            <div class="card-body">
                ...
                if (!empty($enclosure_details)) {
                    $i = 1;
                    foreach ($enclosure_details as $key => $value) {
                        echo '<div class="row">';
                ...
                ?>
                                    <a href="<?= base_url("iservices/serviceplus/annexures/") . $i . '/' . $object_id ?>">View Document</a>

                                <?php       } else { ?>
                                    <div class="col-md-4"><label><?= $sub_val ?></label></div>
                <?php
                                }
                            }
                        }
