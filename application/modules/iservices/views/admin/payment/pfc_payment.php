...
if(!empty($this->session->userdata('role'))){
  $slug = $this->session->userdata('role') === "csc" ? "CSC" : $this->session->userdata('role')->slug;
}
?>
<div class="container">
                  ...
                  <!-- <h2>Response</h2><br/><br/> -->
                    ...
                    <div class="row">
                      <div class="form-group  col-sm-6">
                        ...
                        <input type="number" class="form-control" name="no_printing_page" id="no_printing_page" placeholder="" min="0" />
                        <!-- <span class="error-applicant_name">Please Enter User Contact No.</span> -->
                      </div>
                      <div class="form-group  col-sm-6">
                        <label for="user_mobile">No of Scanning Page. </label>
                        <input type="number" class="form-control" name="no_scanning_page" id="no_scanning_page" placeholder="" min="0" />
                      </div>
                    </div>
                    <?php if ($ApplicationStatus === "S"): ?>
                        <div class="row">
    ...
    $(document).ready(function () {
        ...
        saveAndPFCAmount.click(function () {
            ...
            if(no_printing_page.length > 0 ){
                ...
                if(no_printing_page < 1){
                  alert("Number of page can not be a negative value");
                  return false;
                }
            ...
            if(role === "CSC"){
              $("#AC1_AMOUNT").val(parseFloat(service_charge));
              $("#TOTAL_NON_TREASURY_AMOUNT").val(parseFloat(service_charge));
            }else{
