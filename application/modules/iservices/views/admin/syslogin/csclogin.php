...
<div class="admin-login">
    <div class="row">
        <div class="card border-top-0 rounded-0">
            <form id="adminloginForm" method="POST" action="<?=base_url('iservices/admin/SysLogin/csc')?>">
                <div class="card-body mt-3">
                    <div id="adminloginInfo">
                        <div class="form-group">
                            <label for="contactEmail">CSC ID</label>
                            <input type="text" class="form-control" name="cscid" id="cscid" placeholder="Enter your email-id" required>
                        </div>
                        <div class="form-group">
