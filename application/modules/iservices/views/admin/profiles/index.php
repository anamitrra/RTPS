                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-12">
                            <form method="post" id="profile-update" action="<?= base_url('iservices/admin/profile/update') ?>">
                                <div class="row">
                                ...
                                <div class="row">
                                  ...
                                  <div class="col-6 form-group">
                                      ...
                                      <input type="text"  class="form-control" value="<?= $dept_code ?>" readonly>
                                  </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-6 form-group">
                                        ...
                                        <input type="text" class="form-control" value="<?= $office_code ?>" readonly>
                                    </div>
                                    <div class="col-6 form-group">
                                        <label for="phone">Account1</label>
                                        <input type="text"  class="form-control" value="<?= $account1 ?>" readonly>
                                    </div>
