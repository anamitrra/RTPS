 ...
 <script>
     $(function() {
         ...
         $(document).ready(function() {
             $.get('<?= base_url("dashboard/applications/count_applications") ?>', function(data, status) {
         ...
         //  Load top services
         $.get('<?= base_url("dashboard/applications/top_services"); ?>', function(data, status) {
             let content = '';
        ...
        <div class="progress-bar" style="width: ${element[1]/element[2] * 100}%"></div>
         ...
         $.get('<?= base_url("dashboard/applications/leading_departments"); ?>', function(data, status) {
             // Hide the spinner
