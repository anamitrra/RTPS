    ...
    <div class="row pt-2">
        <div class="col-sm-12 pull-right">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Forwarded Applications</li>
            </ol>
        </div>
    </div>
...
<?php endif; ?>
    <div class="card shadow">
        <div class="card-header bg-info">Forwarded Applications</div>
        <div class="card-body">
    ...
    <script type="text/javascript">
        var table = $('#application_list_table').DataTable({
            ...
            "ajax": {
                url: "<?php echo site_url("iservices/superadmin/applications/get_forwarded_applications") ?>",
                type: 'POST',
                beforeSend: function() {
