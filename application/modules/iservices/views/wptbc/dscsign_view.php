...
$b64PdfData =base64_encode(file_get_contents($pdfPath));
?>
<!DOCTYPE html>
<html>
    <head>
        <title>DSC Sign Demo</title>
        <meta charset="UTF-8">
    ...
    <body>
        <div class="row">
            <div class="col-md-12">
                <div style="width: 80%; height: 500px; border: 2px double #ccc; margin: 10px auto">
                    ...
                    <embed src="<?=$pdfPath?>" type="application/pdf" frameBorder="0" scrolling="auto" height="500px" width="100%"></embed>
                </div>
                <div class="well-sm">
                    <form id="pdfForm">
                        ...
                        <input type="hidden" id="stampingX" name="stampingX" value="200" />
                        <input type="hidden" id="stampingY" name="stampingY" value="200" />
                            ...
                            success: function(data) {
                                if (data.status_cd == 1) {
                                    ...
                                    if (jsonData.status === "SUCCESS") {
                                        ...
                                        $.post("<?=base_url('iservices/wptbc/dscsign/pdfsigned')?>", {
