...
$caste_certificate_type = $dbrow->caste_certificate_type??'';
$caste_certificate = $dbrow->caste_certificate??'';
$gaonbura_report_type = $dbrow->gaonbura_report_type??'';
$gaonbura_report = $dbrow->gaonbura_report??'';
$prc_type = $dbrow->prc_type??'';
$prc = $dbrow->prc??'';
$nrc_type = $dbrow->nrc_type??'';
$nrc = $dbrow->nrc??'';
$ajp_type = $dbrow->ajp_type??'';
$ajp = $dbrow->ajp??'';
