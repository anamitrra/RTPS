...
class Portals extends Frontend
{
    ...
    public function get_records()
    {
        ...
        if (!empty($records)) {
            ...
            foreach ($records as $rows) {
                  ...
                  $objId = $rows->{"_id"}->{'$id'};
                  $btnForward="";
                  $edit_btn = '<a data-id="' . $objId . '" href="'.base_url().'external-portal/portals/edit/'.$objId.'" data-toggle="tooltip" data-placement="top" title="Edit Portal" class="btn btn-info btn-sm">Edit</a>';
                  $btns = '<a data-id="' . $objId . '" href="'.base_url().'external-portal/portals/detail/'.$objId.'" data-toggle="tooltip" data-placement="top" title="View Portal" class="btn btn-primary btn-sm">View</a>';
    ...
    public function add_action(){
      ...
      redirect(base_url("external-portal/portals"));
    }
