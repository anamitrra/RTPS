            ...
            <div class="card my-4" style="border: 1px solid;padding:20px">
                <div class="card-body">
                  ...
                  <div class="row" style="padding:20px">
                    <b>Your application status could not be verified. Please go to <a href="<?=base_url('external-portal/transactions')?>">My Transactions</a> and click on Re-try button to complete your application submission.</b>
