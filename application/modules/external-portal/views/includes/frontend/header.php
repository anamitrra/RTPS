                ...
                <ul class="navbar-nav ml-auto">
                   ...
                   ?>
                    <li class="nav-item hvr-bounce-in hvr-float-shadow mr-md-4">
                        <a class="nav-link text-light text-center" href="<?=base_url('external-portal/transactions')?>"><span>My Transactions</span></a>
                    </li>
                    <li class="nav-item hvr-bounce-in hvr-float-shadow mr-md-4">
                        <a class="nav-link text-light text-center" href="<?=base_url('external-portal/status')?>"><span>Track Application</span></a>
                    </li>
                    <li class="nav-item hvr-bounce-in hvr-float-shadow mr-md-4">
                        <a class="nav-link text-light text-center" href="<?=base_url('login/logout')?>"><span>LOGOUT</span></a>
                    </li>
                    <?php
                    }
                   ?>
...
<?php $this->load->view('includes/frontend/menu')?>
<!--HEADER END-->
