...
<head>
    ...
    <script src="<?= base_url('assets/site/theme1/js/temp_services.js') ?>" defer></script>
...
<body>
    ...
    <main class="container">
        ...
        <h2 class="text-center pt-3 text-capitalise">
            ARTPS Services (<?= empty($type) ? 'All' : strtoupper($type) ?>)
        </h2>
        <hr>
        ...
        <table id="example" class="table table-bordered table-striped display" style="width:100%;">
            ...
            <tbody>
                <?php foreach ($services as $val) : ?>
                    ...
                    <?php if (strtoupper($type) == 'PFC' && ($val['kiosk_availability'] == 'PFC' || $val['kiosk_availability'] == 'ALL')) : ?>
                        <tr>
                            <td><?= $val['department'] ?></td>
                            <td><?= $val['service'] ?></td>
                            <td>
                                <?php if (!empty($val['service_url'])) : ?>
                                    <a class="btn rtps-btn" role="button" href="<?= $val['service_url'] ?>">Apply</a>


                                <?php else : ?>
                                    <a class="btn rtps-btn" role="button" href="#" onclick="loadDynamicContentModal(<?= $val['service_id'] ?>)">Apply</a>
                    ...
                    <?php elseif (strtoupper($type) == 'CSC' && ($val['kiosk_availability'] == 'CSC' || $val['kiosk_availability'] == 'ALL')) : ?>
                        <tr>
                            <td><?= $val['department'] ?></td>
                            <td><?= $val['service'] ?></td>
                            <td>
