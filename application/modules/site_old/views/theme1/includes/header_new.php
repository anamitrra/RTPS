                ...
                <section class="top-align w-50 d-none d-md-flex align-items-stretch">
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <a class="screen-reader p-2 me-1" href="<?= base_url('site/screen_reader') ?>" title="<?= $header->top_bar[5]->$lang ?>">
                            <img class="d-inline-block" src="<?= base_url('assets/site/theme1/images/screen_reader.png') ?>" alt="sitemap" width="16">
                        </a>
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <a class="track p-2 small text-uppercase fw-bold" href="#" data-bs-toggle="modal" data-bs-target="#trackModal">
                            <img class="d-inline-block" src="<?= base_url('assets/site/theme1/images/track.png') ?>" alt="sitemap" width="16">
        ...
        <section class="container-fluid py-2">
            <div class="container d-flex justify-content-between align-items-center">
                ...
                <div class="d-flex justify-content-md-between position-relative">
                    <img class="d-md-inline-block" src="<?= base_url('assets/site/theme1/images/emblem.png') ?>" style="transform: translateX(-10px);" id="emblem" alt="Emblem" height="80">
    ...
    <div class="modal fade" id="newLoginModel" tabindex="-1" aria-labelledby="newLoginModel" aria-hidden="true" data-bs-keyboard="true">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <!-- MCC officials login -->
                <a href="https://rtps.assam.gov.in/spservices/mcc/user-login" target="_blank" rel="noopener noreferrer" class="btn btn-link text-decoration-none btn-lg link-danger border-top">
                    <?= $header->new_login_model->mcc_link->$lang ?> <i class="fas fa-sign-in-alt"></i>
                </a>
