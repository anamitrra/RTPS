            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Users</h3><?php echo anchor(site_url('dashboard/users/create'), 'Create', 'class="float-right"'); ?>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                    <div class="row">
                    ...
                    <script type="text/javascript">
                        $(document).ready(function() {
                            ...
                            var table = $('#ticket-table').DataTable({
                                ...
                                "ajax": {
                                    url: "<?php echo base_url("dashboard/users/get_records") ?>",
                                    type: 'POST',
                                    data: function(d) {
