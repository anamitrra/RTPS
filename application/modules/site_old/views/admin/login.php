<div class="d-flex justify-content-center">
    <div class="row">
        <div class="col-md-12">
                   ...
                   <h3 class="text-center my-2 mt-4">ARTPS Portal Management</h3>
            <div class="login-box">
                ...
                <div class="card mt-4">
                    <div class="card-body login-card-body">
                        <form id="login-form" action="<?php echo base_url(); ?>site/admin/login/loginMe" method="post">
                            ...
                            <!-- <div class="form-group d-flex justify-content-between">
                                ...
                                <a href="<?php echo base_url('dashboard/login/forgot-password') ?>">Forgot password?</a>
                            </div> -->
...
<script type="text/javascript">
    ...
    const refreshCaptchaURL = '<?=base_url('site/admin/login/refresh_captcha')?>';
    $(function(){
