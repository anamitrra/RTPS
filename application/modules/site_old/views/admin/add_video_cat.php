<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            ...
            <div class="col-sm-8">
                ...
                <div class="col-sm-4">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="<?= base_url("site/admin/videos_category"); ?>">Video Categories</a></li>
            ...
            <?= form_open( base_url("site/admin/videos_category/add_video_category_action") ); ?>
            ...
            <a class="btn btn-outline-secondary" href="<?= base_url('site/admin/videos_category') ?>" role="button">Cancel</a>
        </form>
...
$(document).ready(function(){
    ...
    // Checking if Video_CAT already exists
    $('[name="short_name"]').on('keyup', function (event) {
        ...
        $.ajax({
            type: 'GET',
            url: '<?= base_url("site/admin/videos_category/check_video_category_api/") ?>' + key,
            dataType: 'json',
