            ...
            <div class="card my-4" style="border: 1px solid;padding:20px">
                <div class="card-body">
                  ...
                  <?php if (!empty($this->session->userdata('role')) && ($this->session->userdata('role')->slug === "PFC" || $this->session->userdata('role')->slug === "SA") ): ?>
                    <b>Your application status could not be verified. Please go to <a href="<?=base_url('expr/admin/my-transactions')?>">My Transactions</a> and click on Re-try button to complete your application submission.</b>
                  <?php else: ?>
                    <b>Your application status could not be verified. Please go to <a href="<?=base_url('expr/transactions')?>">My Transactions</a> and click on Re-try button to complete your application submission.</b>
                  <?php endif; ?>
