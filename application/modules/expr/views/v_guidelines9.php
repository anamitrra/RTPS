...
<div class="container">
    <div class="row">
        <div class="col-sm-12 mx-auto">
            <div class="card my-4">
                <div class="card-body">
                  <h2 class="transport-appl-header">No Objection Certificate for Transfer of Record of Registration to Other Registering Authority</h2>
                  <p class="transport-appl-para">Supporting Documents:</p>


                  <ul class="transport-appl-list">
                                                <li>NCRB report from CID Office on litigation free of the vehicle [Mandatory]</li>
                                                <li>Scratch chassis pencil print [Mandatory]</li>
                                                ...
                                                <li>If the vehicle is hypothecated, NOC from Bank or endorsement in form 34 & 35. [Mandatory]</li>
                                                <li>In case of commercial passenger vehicle, NOC from the STA / RTA [Mandatory]</li>
                                                <li>In case of commercial goods and passenger vehicle, no offence case clearance certificate from concerned enforcement wing [Mandatory]</li>
                  </ul>
