...
<div class="container">
    <div class="row">
        <div class="col-sm-12 mx-auto">
            <div class="card my-4">
                <div class="card-body">
                  <h2 class="transport-appl-header">Duplicate Registration Certificate for Non-transport Vehicle </h2>
                  <p class="transport-appl-para">Supporting Documents:</p>


                  <ul class="transport-appl-list">
                                                <li>Police report with General Diary Entry (GDE) no. and date (in case of loss) Or</li>
                                                <li>Original destroyed/mutilated registration certificate (in case of damage)</li>
                                                <li>Consent of the financier in case of hypothecated vehicle</li>
                                                <li>Up to date Tax paid Receipt</li>
                                                <li>Copy of valid insurance certificate</li>
                                                <li>Up-to-date Pollution under certificate (PUC)</li>
                  </ul>
                  ...
                  <?php if (isset($apply_by) && ($apply_by === "PFC" || $apply_by === "SA")): ?>
                    <div class="row">
                      <div class="form-group  col-sm-6">
                        <label for="user_mobile">User Contact No. </label>
                        <input type="text" class="form-control" name="user_mobile" id="user_mobile" placeholder=""  />
...
$(function(){
  ...
  procced.click(function () {
    ...
    let validation =false;
          ...
          if(user_mobile === ""){
            $('.error-user-mobile').slideDown();
            validation=false;
          }else {
            $('.error-user-mobile').slideUp();
            validation=true;
          }
          if(validation){
