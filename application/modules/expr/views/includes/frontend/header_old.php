...
<head>
    ...
    <title>APPLICATION FOR ALLOTMENT OF GOVERNMENT QUARTER</title>
    ...
    <style >
      ...
      .logo {
          background-image: url(<?=site_url('assets/frontend/images/emblem-dark.png')?>);
...
<section class="wrapper header-wrapper">
	<div class="container header-container">
    	<h1 class="logo">
      			<a class="main_gov brown-text" href="">Government Of Assam</a>
						<a class="sub_dept" href="">General Administration</a>
		  </h1>
