    ...
    <div class="row">
      <div class="col-12">
        <div class="card">
          ...
          <div class="card-body">
            <form action="<?php echo site_url('admin/users/upload_action'); ?>" method="post" enctype="multipart/form-data">
              ...
              <div class="row">
                <div class="fb-number col-md-6 form-group ">
                  ...
                  <input class="form-control" name="office_code" id="office_code"  type="text" required  >
                </div>
                <div class="fb-number col-md-6 form-group ">
                  <label for="dept_code" class="fb-number-label">Dept Code  <span class="fb-required text-danger">*</span></label>
                  <input class="form-control" name="dept_code" id="dept_code"  type="text" required >
                </div>
