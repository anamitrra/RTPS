                                ...
                                <td>
                                  <?php if(isset($value->applied_by)){ ?>
                                                  <?php if ( isset($value->pfc_payment_status)  && $value->pfc_payment_status ==="Y"): ?>
                                                    ...
                                                    <a class="btn btn-success btn-sm mbtn" href="<?=base_url("expr/v-acknowledgement/").$value->vahan_app_no?>" >Acknowledgement</a>
                                                  <?php endif; ?>
                                  <?php }else { ?>
                                                  ...
                                                  <?php if ($value->status ==="R"): ?>
                                                      <a href="<?=base_url("expr/vahan-service/retry/").$value->rtps_trans_id?>" class="btn btn-sm btn-primary">Re-try</button>
                                                  <?php elseif($value->status ===""): ?>
                                                    <a class="btn btn-sm btn-primary mbtn" href="<?=base_url("expr/vahan-service/retry/").$value->rtps_trans_id?>" >Try Again</a>
                                                  <?php else: ?>
                                                  <?php endif ?>
                                                  ...
                                                  <?php if ($value->status ==="F" || $value->status ==="N"): ?>
                                                    <a class="btn btn-success btn-sm mbtn" href="<?=base_url("expr/vahan/").$value->service_id?>" >Apply Again</a>
                                                  <?php endif; ?>
                                  <?php }?>
                                ...
                                <td>
                                    <?php if(isset($value->applied_by)){ ?>
                                          <?php if ( isset($value->pfc_payment_status)  && $value->pfc_payment_status ==="Y"): ?>
                                            ...
                                            <a class=" btn btn-success btn-sm mbtn" href="<?=base_url("expr/o-acknowledgement?app_ref_no=").$value->app_ref_no?>" >Acknowledgement</a>
                                          <?php endif; ?>
                                    <?php }else { ?>
                                          ...
                                          <?php if ($value->status ==="F"): ?>
                                            <a class="btn btn-success btn-sm mbtn" href="<?=base_url("expr/guidelines/").$value->service_id."/".$value->portal_no?>" >Apply Again</a>
                                          <?php endif; ?>
                                            <?php if ($value->status ==="" || $value->status ==="P"): ?>
                                              <a href="<?=base_url("expr/retry/").$value->rtps_trans_id."/".$value->service_id."/".$value->portal_no?>" class="btn btn-sm btn-primary">Re-try</button>
                                            <?php endif; ?>
                                            <?php if ($value->status === "S"): ?>
                                              <a class="btn btn-success btn-sm mbtn" href="<?=base_url("expr/o-acknowledgement?app_ref_no=").$value->app_ref_no?>" >Acknowledgement</a>
                                            <?php endif; ?>
