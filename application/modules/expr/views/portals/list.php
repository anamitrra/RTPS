        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="<?=base_url("expr/portals/create")?>" class="btn btn-primary btn-sm float-right" ><i class="fas fa-plus" aria-hidden="true"></i>&nbsp;
                        Add</a>
                </div>
...
<script>
    $(document).ready(function() {
        ...
        var table = $('#applications').DataTable({
            ...
            "ajax": {
                url: "<?php echo base_url("expr/portals/get_records") ?>",
                type: 'POST',
                beforeSend: function() {
