...
//            "pageTitle" => "Login"
    ...
    public function loginMe()
    {
        ...
        if($this->form_validation->run() == FALSE)
        {
            ...
            redirect(base_url() . 'expr/admin/login');
        }
        ...
        if ($email == "" || $password == "") {
          ...
          //  pre($result);
            if (isset($result) && $result != NULL) {
                ...
                redirect(base_url() . 'expr/admin/dashboard');
            } else {
...
//        pre($value);
        if (!empty($mobile)) {
            ...
            // $this->sms->send_login_otp($mobile, $msg);
            if(ENV !== "DEV"){
...
//            return true;
    ...
    public function process_login()
    {
      ...
      $email = strval($this->input->post('contactEmail', true));
        ...
        if(ENV !== "DEV"){
          $value=$this->sms->verify_login_otp($mobile,$otp);
        }else {
          $value=true;
        }
        //pre($value);
        ...
        $status["url"] = base_url() . 'expr/admin/dashboard';
        $sessionArray = array(
            'userId' => $user->_id,
