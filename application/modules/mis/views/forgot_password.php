            ...
            <div class="login-box">
                ...
                <div class="card">
                    <div class="card-body login-card-body">
                        ...
                        <form id="login-form" action="<?php echo base_url('mis/login/resetPasswordUser');?>"
                              method="post">
                            ...
                            <div class="form-group d-flex justify-content-between mb-3">
                                ...
                                <?= anchor('dashboard', 'Cancel', 'class="btn btn-light btn-sm"') ?>
                            </div>
...
<script src="<?= base_url(); ?>assets/plugins/bootstrap/js/bootstrap.bundle.min.js"
