                ...
                <div class="card-body">
                    <form id="filter-citizen-form" action="#" method="POST">
                        <div class="row">
                            ...
                            <!-- <div class="col-12 col-md-3">
                                <label for="submission_location">Department</label>
                                <select name="department_id" id="department_id" class="form-control select2">
                                <option value="">Select Depatment</option>
                                <option value="1">Depatment 1</option>
                                </select>
                            </div> -->
                            <div class="col-12 col-md-3">
                                <label for="submission_location">Agency</label>
                                <select name="agency_id" id="agency_id" class="form-control select2">
                                
                                </select>
                            </div>
                            <div class="col-12 col-md-3">
                                <label for="submission_location">Vendor</label>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-3">
                                <label for="submission_location">Kiosk</label>
                                <select name="kiosk_id" id="kiosk_id" class="form-control select2">
                                
                                </select>
                            </div>
                        </div>
                        <p class="mt-2 mb-0"><span class="text-danger">*</span> <span class="small text-muted font-weight-bold">Please select date range of 3 months</span></p>
                ...
                <div class="table-responsive mt-3">
                    <table id="citizen-data-table" class="table table-bordered text-center">
                        ...
                        <tr>
                            ...
                            <th class="align-top">Operator ID </th>
                            <th class="align-top">District</th>
                            <!-- <th class="align-top">Type</th> -->
                            <th class="align-top">Agency ID</th>
                            <th class="align-top">PFC/CSC ID</th>
...
<script>
    ...
    var downloadExcelUrl = '<?=base_url('mis/revenue_reports/download_excel')?>';
    var def1
    $(function(){
        $('.select2').select2();
        ...
        const table = $('#citizen-data-table').DataTable({
            ...
            "ajax": {
                url: '<?php echo base_url("mis/revenue_reports/get_records") ?>',
                type: 'POST',
                data: function (d){
   ...
   //filters
            ...
            $(document).on('change',"#vendor_id",function(){
                        ...
                        $.ajax({
                                                url: "<?php echo base_url("mis/revenue_reports/get_agency") ?>",
                                                type: 'GET',
                                                data: {
                                                    vendor_id
                                                },
        ...
        $(document).on('change',"#agency_id",function(){
                        ...
                        $.ajax({
                                                url: "<?php echo base_url("mis/revenue_reports/get_kiosk") ?>",
                                                type: 'GET',
                                                data: {
                                                    agency_id
                                                },
