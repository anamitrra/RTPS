                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label for="office" class="col-sm-3 col-form-label text-left">Select office:</label>
                                    <div class="col-sm-9">
                                        <select id="office" class="form-control select2" name="office[]" multiple>
                                            <option>Select</option>
                                            <?php foreach ($office as $key => $value) : ?>
                                                <option value="<?= $value->location_name ?>"><?= $value->location_name ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                    </div>
                                </div>
                    ...
                    <script type="text/javascript">
                        $(document).ready(function() {
                            ...
                            var table = $('#travellers-table').DataTable({
                                ...
                                "ajax": {
                                    url: "<?php echo base_url("mis/applications/get_records") ?>",
                                    type: 'POST',
                                    data: function(d) {
