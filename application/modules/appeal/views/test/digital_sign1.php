<?php
$pdfPath = base_url($pdf_path);
// echo( $pdfPath);
// return

$pdfPath1 = FCPATH . $pdf_path;
            ...
            <div class="col-md-12">
                <div style="width: 100%;  border: 2px double #ccc; margin: 10px auto">
                    <div style=" background: #337ab7; margin: 5px; padding: 5px;">
                        ...
                        <a id="backtohome" href='<?= base_url('appeal/process/view/').$obj_id ?>' type=""></a>
                ...
                <div class="well-sm">
                    <form id="pdfForm">
                        ...
                        <input type="hidden" id="stampingY" name="stampingY" value="620" />
                            ...
                            success: function(data) {
                                ...
                                if (data.status_cd == 1) {
                                    ...
                                    if (jsonData.status === "SUCCESS") {
                                        ...
                                        $.post("<?=base_url('appeal/test_app/dsc_callback')?>", {
                                            "obj_id":"<?=$obj_id?>",
                                            "pdf_file":"<?=base_url($pdf_path)?>",
                                            "signed_pdf":pdfData,
                                            'type':"<?=$type?>"
                                        }, function(res){
                                            // alert("Res: " + res);
