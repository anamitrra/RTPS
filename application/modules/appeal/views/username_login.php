            ...
            <div class="login-box">
                ...
                <div class="card">
                    <div class="card-body login-card-body">
                        <form id="login-form" action="<?php echo base_url(); ?>/appeal/login/loginUsingUsername" method="post">
                            ...
                            <div class="row my-2">
                                <div class="col-6">
                                    <div class="d-grid">
                                        <a class="btn btn-outline-success" href="<?= base_url('appeal/admin/login') ?>">Login using email</a>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="d-grid">
                                        <a href="<?= base_url('appeal/admin/username-login') ?>" class="btn btn-success">Login using username</a>
                                    </div>
                                </div>
                            </div>
