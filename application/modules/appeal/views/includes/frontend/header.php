...
<head>
    <title>Sewa Setu | Government of Assam</title>
    ...
    <div class="container-fluid top-panel">
        <section class="container p-0 d-flex justify-content-between align-items-stretch flex-wrap">
            ...
            <div class="py-1 govt-text">
                ...
                <span class="small text-uppercase govt-title">Government of assam</span>
            </div>
    ...
    <nav class="navbar navbar-expand-lg bg-rim navbar-light shadow sticky-top p-0">
        <div class="d-flex justify-content-md-between position-relative">
            ...
            <div class="heading-text">
                <h2 class="emb fw-bold mb-0"> SewaSetu </h2>
                <h6 class="mb-0 fst-italic">
                    A Comprehensive Citizen Platform </h6>
            </div>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav text-uppercase">
                    <a class="nav-link text-white me-4 px-md-3" href="<?= base_url('appeal') ?>">
                        Citizen Login
                    </a>
                    <a class="nav-link text-white me-4 px-md-3" href="<?= base_url('appeal/admin/login') ?>">
                        Department Login
                    </a>
                </div>
            </div>
