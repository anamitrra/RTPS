    ...
    <div class="card my-2 border-0 shadow">
        ...
        <div class="card-body">
            <div class="d-flex justify-content-end mb-2">
                ...
                <a href="<?=base_url('appeal/logout')?>" class="btn btn-sm btn-outline-danger font-weight-bold mx-1" >close</a>
            </div>
            <div class="row">
                <div class="col-3">
            ...
            <div class="row">
                ...
                <div class="col-3"><?=format_mongo_date($appealApplication->created_at)?></div>
                <div class="col-3">
...
<script>
    ...
    var refreshProcessUrl = '<?= base_url('appeal/process/refresh/' . $appealApplication->appeal_id) ?>';
    $(function () {
