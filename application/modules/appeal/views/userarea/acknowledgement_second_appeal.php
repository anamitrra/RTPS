        ...
        <div class="card-body m-0">
            ...
            <div id="ack" class="alert alert-light" role="alert">
                ...
                <ol class="font-weight-normal">
                    ...
                    <li>Department Name : <?=$department->department_name?></li>
                ...
                <p class="mb-0">Note : </p>
                <ol class="font-weight-normal">
                    <!-- <li>(a)The mentioned hearing date is Tentative. The intimation for actual hearing will be given in due course of time with email and sms notification.</li> -->
            ...
            <a href="<?=base_url('appeal/userarea')?>" class="btn btn-block btn-outline-secondary mb-2 font-weight-bold">
                Close
            </a>
        </div>
    </div>
