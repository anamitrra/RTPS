            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="<?=base_url('appeal/make-appeal')?>" data-tooltip="tooltip" title="Make new appeal only if the application is not shown below" class="btn btn-sm btn-outline-danger float-right">Appeal for Unlisted Application</a>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                        <h4>If you do not find your application listed below then please <a href="<?=base_url('appeal/make-appeal')?>">click here</a> to make an appeal
</h4>
<br/>
                    ...
                    <script type="text/javascript">
                        $(document).ready(function() {
                            ...
                            var table = $('#travellers-table').DataTable({
                                ...
                                "ajax": {
                                    url: "<?php echo base_url("appeal/myapplications/get_records") ?>",
                                    type: 'POST',
                                    data: function(d) {
