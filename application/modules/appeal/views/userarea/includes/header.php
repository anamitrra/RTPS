...
<div class="wrapper">
    <?php
        if($this->session->userdata('role') &&  in_array($this->session->userdata('role')->slug,['PFC','DA']) ){
            $this->load->view("includes/topbar");
            $this->load->view("includes/sidebar");
        }else{
            $this->load->view("userarea/includes/topbar");
            $this->load->view("userarea/includes/sidebar");
        }
    ?>
    <!-- /.navbar -->