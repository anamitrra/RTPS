        ...
        <div class="card-body m-0">
            ...
            <div id="ack" class="alert alert-success" role="alert">
                ...
                if(property_exists($appealApplication,'appeal_expiry_status') && $appealApplication->appeal_expiry_status){
                    ...
                    <p>Your Application reference No. is <b><?=$appealApplication->appl_ref_no?></b>, Previous Appeal reference No. <b><?=$appealApplication->ref_appeal_id?></b> and your Appeal Request ID is <b><?=$appealApplication->appeal_id?></b></p>
                    <?php
                }else{
                ?>
                <p>You have successfully applied for the second appeal of RTPS Application reference No. <b><?=$appealApplication->appl_ref_no?></b>,
                    <br>
                    Previous Appeal reference No. <b><?=$appealApplication->ref_appeal_id?></b> and your Appeal ID is <b><u><?=$appealApplication->appeal_id?></u></b>.
                </p>
                <?php } ?>
                ...
                <ol class="font-weight-normal">
                    ...
                    <li>(b) Appellant can track the appeal status using the ARTPS no. & Appeal number at the
                        Portal or by calling at Call Center Number (1800.......)</li>
                </ol>
                <hr>
