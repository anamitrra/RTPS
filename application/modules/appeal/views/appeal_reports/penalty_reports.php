        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Penalty Report</h3>
                    <a class="float-right btn btn-success btn-xs" href="<?= base_url("appeal/appeal_reports/excel_export_penalty_reports") ?>"><i class="fas fa-file-excel"></i> Export To Excel</a>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                    <div class="row">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var table = $('#apeals').DataTable({
            ...
            "ajax": {
                url: "<?php echo site_url("appeal/appeal_reports/get_penalty_records") ?>",
                type: 'POST',
                data: function(d) {
