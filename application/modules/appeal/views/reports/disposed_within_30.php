...
<div class="content-wrapper" style="min-height: 1376.4px;">
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Disposed Within 30 Appeals Report</h1>
                </div>
                <div class="col-sm-6">
        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Disposed Within 30 Appeals</h3>
...
<script type="text/javascript">
    $(document).ready(function() {       
        ...
        var table = $('#apeals').DataTable({
            ...
            "ajax": {
                url: "<?php echo site_url("appeal/reports/disposed_within_30_get_records") ?>",
                type: 'POST',
                data: function(d) {
