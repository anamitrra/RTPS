...
// $userdata = array_merge($userdata, $doc_id);
// print_r($userdata);
...
// $username = $this->session->userdata("usernamee");
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            ...
                                            <span class="text-danger font-weight-bold"><?= (!$username) ?  'Dear User, you are requested to set your unique username by going prifile section. Please note that this is a one time activity which will enable you to login with the username in future.' : '' ?></span>
