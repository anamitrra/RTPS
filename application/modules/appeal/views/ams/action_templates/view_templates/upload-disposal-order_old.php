...
<form id="hearingForm">
    ...
    <div class="card card-body mt-2 p-2 border border-warning shadow" style="flex: none" id="templateLinkBox">
        ...
        <div class="btn-group">
            <a href="#" id="actionTemplateLink" class="btn btn-outline-primary" onclick="openActionTemplateModal()">Generate Disposal order</a>
        ...
        if(isset($disposalOrderTemplates)){
            ...
            <div class="btn-group">
                ...
                if(isset($disposalOrderTemplates->{'order'})){
                    ?>
                    <a href="<?=base_url('appeal/templates/download-generated-template/'.$appealId.'/order/upload-disposal-order')?>" class="btn btn-outline-primary" >Download Disposal Order/ Final Verdict</a>
                    <?php
                }
                ?>
            </div>
