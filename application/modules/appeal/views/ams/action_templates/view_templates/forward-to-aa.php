<form id="forwardForm">
    ...
    <div class="row forward-box mt-3">
        <div class="col-12">
            <label for="forwardToAA">Forward To ( Current Appellate Authority)</label>
            <input type="hidden" class="form-control" name="forwardToAAUserId" value="<?=$aaUserId?>" id="forwardToAAUserId">
            <input type="text" class="form-control" value="<?=$aaName?>" id="forwardToAA" disabled>
        </div>
    </div>
...
<script>
    ...
    var forwardFormProcessUrl = '<?= base_url('appeal/first/process/forward-to-aa') ?>';
    $(function() {
