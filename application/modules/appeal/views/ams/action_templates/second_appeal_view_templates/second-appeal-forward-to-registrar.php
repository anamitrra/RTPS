<form id="forwardForm">
    ...
    <div class="row forward-box mt-3">
        <div class="col-12">
            <label for="forwardToRR">Forward To Registrar</label>
            <input type="hidden" class="form-control" name="forwardToRRUserId" value="<?=$rrUserId?>" id="forwardToRRUserId">
...
<script>
    ...
    var forwardFormProcessUrl = '<?= base_url('appeal/second/process/forward-to-rr') ?>';
    $(function() {
