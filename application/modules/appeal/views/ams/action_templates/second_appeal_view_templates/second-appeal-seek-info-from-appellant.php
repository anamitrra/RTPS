...
<form id="seekInfoForm">
    ...
    <div class="row  seek-box mt-3">
        <div class="col-12">
            <label for="last_date_of_submission">Last date of submission <span class="text-danger">*</span></label>
            <input type="text" name="last_date_of_submission" id="last_date_of_submission" class="form-control datepicker" placeholder="dd-mm-YYYY" required>
        </div>
    </div>
    <div class="row mt-3">
        <div class="col-12">
...
<script>
    ...
    var seekInfoFormProcessUrl = '<?= base_url('appeal/second/process/seek-info') ?>';
