...
<!--    </div>-->
    <div class="card card-body mt-2 p-2 border border-warning shadow" style="flex: none" id="templateLinkBox">
        ...
        <div class="btn-group">
            <a href="#" id="actionTemplateLink" class="btn btn-outline-primary" onclick="viewActionTemplateModal()">View Disposal order</a>

        </div>
<!--        --><?php
//        if(isset($disposalOrderTemplates)){
//            ?>
<!--            <h6 class="font-weight-bold py-2">OR Download Previously Generated Order</h6>-->
<!---->
<!--            <div class="btn-group">-->
<!--                --><?php
//                if(isset($disposalOrderTemplates->{'order'})){
//                    ?>
<!--                    <a href="--><?//=base_url('appeal/templates/download-generated-template/'.$appealId.'/order/generate-disposal-order')?><!--" class="btn btn-outline-primary" >Download Disposal Order/ Final Verdict</a>-->
<!--                    --><?php
//                }
//                ?>
<!--            </div>-->
...
<script>
    ...
    var hearingFormProcessUrl = '<?= base_url('appeal/second/process/upload-disposal-order') ?>';
