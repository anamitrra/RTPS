<form id="penaltyForm">
    ...
    <div class="row  penalty-box mt-3">
        <div class="col-md-4">
            <label for="penaltyAmount">Penalty Amount <span class="text-danger">*</span></label> <span class="text-danger">(applied to DPS - <?= $name ?>)</span>
            <input name="penaltyAmount" id="penaltyAmount" class="form-control" placeholder="Enter penalty amount ... ">
        </div>
        <div class="col-md-4">
            <label for="penaltyShouldPayWithinDays">Penalty should be paid within <span class="text-danger">*</span></label>
            <input name="penaltyShouldPayWithinDays" id="penaltyShouldPayWithinDays" class="form-control" placeholder="Enter number of days ..." data-parsley-type="number">
        </div>
        <div class="col-md-4">
            <label for="certificateIssuedWithinDays">Certificate should be issued within <span class="text-danger">*</span></label>
            <input name="certificateIssuedWithinDays" id="certificateIssuedWithinDays" class="form-control" placeholder="Enter number of days ..." data-parsley-type="number">
        </div>
    </div>
    ...
    <div class="card card-body mt-2 p-2 border border-warning shadow " style="flex: none" id="templateLinkBox">
        ...
        <div class="btn-group">
            <a href="#" id="actionTemplateLink" class="btn btn-outline-primary " onclick="openActionTemplateModal()">View Penalty Order</a>
        </div>
    </div>
...
<script>
    ...
    var penaltyFormProcessUrl = '<?= base_url('appeal/first/process/issue-penalty') ?>';
