<form id="forwardForm">
    ...
    <div class="row forward-box mt-3">
        <div class="col-12">
            <label for="forwardToRAUserId">Forward To Chairman</label>
            <input type="hidden" class="form-control" name="forwardToRAUserId" value="<?=$raUserId?>" id="forwardToRAUserId">
            <input type="text" class="form-control" value="<?=$raName?>" id="forwardToAA" disabled>
        </div>
    </div>
...
<script>
    ...
    var forwardFormProcessUrl = '<?= base_url('appeal/second/process/forward-to-chairman') ?>';
    $(function() {
