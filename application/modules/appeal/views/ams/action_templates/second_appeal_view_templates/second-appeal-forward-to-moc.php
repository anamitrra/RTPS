<form id="forwardForm">
    ...
    <div class="row forward-box mt-3">
        <div class="col-12">
            <label for="forwardToMOCUserId">Forward To</label>
            <input type="hidden" class="form-control" name="forwardToMOCUserId" value="<?=$mocUserId?>" id="forwardToMOCUserId">
            <input type="text" class="form-control" value="<?=$mocName?>" id="forwardToMOC" disabled>
        </div>
    </div>
...
<script>
    ...
    var forwardFormProcessUrl = '<?= base_url('appeal/second/process/forward-to-moc') ?>';
    $(function() {
