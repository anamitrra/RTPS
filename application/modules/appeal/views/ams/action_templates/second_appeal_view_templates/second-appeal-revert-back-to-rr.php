<form id="forwardForm">
    ...
    <div class="row forward-box mt-3">
        <div class="col-12">
            <label for="revertBackToRRUserId">Revert Back To Registrar</label>
            <input type="hidden" class="form-control" name="revertBackToRRUserId" value="<?=$rrUserId?>" id="revertBackToRRUserId">
            <input type="text" class="form-control" value="<?=$rrName?>" id="forwardToRR" disabled>
        </div>
    </div>
...
<script>
    ...
    var forwardFormProcessUrl = '<?= base_url('appeal/second/process/revert-back-to-rr') ?>';
    $(function() {
