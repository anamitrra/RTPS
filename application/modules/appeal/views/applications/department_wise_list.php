            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Applications  of <span class="font-weight-bold"><?=$departmentInfo->department_name?></span></h3>
                        <a class="float-right btn btn-success btn-xs" href="<?= base_url("applications/generatexls") ?>"><i class="fas fa-file-excel"></i> Export To Excel</a>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <select id="services" class="form-control select2" name="services[]" multiple>
                        ...
                        <div class="form-group row">
                            <label for="category" class="col-sm-2 col-form-label text-left">Service Status:</label>
                            <div class="col-sm-4">
                                <select id="service_status" class="form-control form-control-sm" name="service_status">
                                    <option value="">Select Status</option>
                                    <option value="">All Applications</option>
                                    <option value="2">Delivered Applications</option>
                                    <option value="3">Rejected Applications</option>
                                    <option value="4">Under Processed Applications</option>
                                </select>
                            </div>
                    ...
                    <script type="text/javascript">
                        $(document).ready(function() {
                            ...
                            var table = $('#travellers-table').DataTable({
                                ...
                                "ajax": {
                                    url: "<?php echo site_url("applications/dept-wise/get-records/".$departmentInfo->department_id."") ?>",
                                    type: 'POST',
                                    data: function(d) {
