...
foreach ($execution_data as $key => $val) {
 ...
 <tr>
            ...
            <td scope="col"><?=$val->task_details->task_name?></td>
            <td scope="col"><?=$val->task_details->user_name?></td>
            <td scope="col"><?=format_mongo_date($val->task_details->received_time)?></td>
            <td scope="col"><?=format_mongo_date($val->task_details->executed_time)?></td>
