...
<div class="container">
    <div class="card my-2 border-0 shadow">
        ...
        <form id="appealForm" method="POST" action="<?= base_url('appeal/demo/process') ?>">
            <div class="card-body">
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="nameOfPFC" name="nameOfPFC"
                                   value="<?=$applicationData->initiated_data->pfc_name ?? 'Not Available' ?>"                                    readonly>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="groundForAppeal" name="groundForAppeal" required
                                      placeholder="Write you ground for Appeal here"><?= $old['groundForAppeal']??'' ?></textarea>
                        </div>
                    </div>
                </div>
                <div class="row">
