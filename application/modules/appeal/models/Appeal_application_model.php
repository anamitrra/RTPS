...
class Appeal_application_model extends Mongo_model
{
    ...
    public function get_by_id($doc_id)
	{
        // pre($doc_id);
        // return;
            $data = $this->mongo_db->select(['appeal_id'])->where(['_id'=>new ObjectId($doc_id)])->find_one("appeal_applications");
            return $data;
...
//        ]];
    ...
    public function get_appeal_details_for_everyone($doc_id)
    {
        ...
        $operations = array(
            ...
            array('$unwind' => array('path'=>'$application_data','preserveNullAndEmptyArrays'=> true)),
            array(
                '$lookup'  => array(
                    'from'         => 'users',
                    'localField'   => 'dps_id',
            ...
            array('$unwind' => array('path'=>'$location_details','preserveNullAndEmptyArrays'=> true)),
            array(
                '$lookup'  => array(
                    'from'         => 'users',
                    'localField'   => 'process_users.userId',
...
//        pre($data);
    ...
    {
        // pre($this->session->userdata("role")->slug);
        $collection = 'appeal_applications';
