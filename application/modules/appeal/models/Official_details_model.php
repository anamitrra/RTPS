...
class official_details_model extends Mongo_model
{
...
//            array('$unwind' => '$user_role'),
    ...
    public function official_details_info($official_mapping_id){
    $data = $this->mongo_db->where("_id", new ObjectId($official_mapping_id));
