...
require(["esri/map", "esri/SnappingManager", "esri/SpatialReference", "esri/dijit/BasemapGallery", "esri/dijit/BasemapLayer", "esri/dijit/Basemap",
    ...
    function ajaxfun(category) {
        ...
        chartdata = [];
        if (statedd.value == 'select') {
            // url = "https://ruraldiksha.nic.in/RDMapservice/Services/service.svc/GetstatewiseMapdata_RDRurbanPercentageConvergance"; data = { "Cond1": "rd_pmayg", "Cond2": "pmayg@123" };
             // url = "http://10.177.15.190/rurbansoft/index.php/Map/stateLevelDataCgf";
             url = "https://rurban.gov.in/index.php/Map/stateLevelDataCgf";
        }
        else if (statedd.value != 'select' && distdd.value == 'select') {
            stval=statedd.value;
            // url = "https://ruraldiksha.nic.in/RDMapservice/Services/Service.svc/GetDistrictwiseMapdata_RDRurbanPercentageConvergance"; data = { "Cond1": "rd_pmayg", "Cond2": "pmayg@123", "Cond3": statedd.value };
            // url = "http://10.177.15.190/rurbansoft/index.php/Map/districtLevelDataCgf?stid="+stval;
            url = "https://rurban.gov.in/index.php/Map/districtLevelDataCgf?stid="+stval;
        }
            ...
            url = "https://rurban.gov.in/index.php/Map/blockLevelDataCgf?stid="+stval+'&distid='+distval;
        }
        else if (statedd.value != 'select' && distdd.value != 'select' && blkdd.value != 'select') {
            //url = "https://ruraldiksha.nic.in/RDMapservice/Services/Service.svc/GetPanchayatwiseMapdata_RDRurbanPercentageConvergance"; data = { "Cond1": "rd_pmayg", "Cond2": "pmayg@123", "Cond3": statedd.value, "Cond4": distdd.value, "Cond5": blkdd.value };
        }
        node = 'DATA';
    ...
    function themefun(category) {
        ...
        content += "<tr><td><b>% Convergance Expenditure</td></b>" + "<td><b>: </b></td><td>${" + subcategory + "}%</td></tr>";
    ...
    function create_table(selection, name, matched_data) {
        if (statedd.value == 'select') {
            ...
            $('#stdist1')[0].innerHTML = "Block (Cluster)";
            $('#stdist2')[0].innerHTML = "Block (Cluster)";
        }
            ...
            $('#stdist1')[0].innerHTML = "Gram Panchayat (Cluster)";
            $('#stdist2')[0].innerHTML = "Gram Panchayat (Cluster)";
        }
       
      //$('#stdist3')[0].innerHTML = name + ' ' + 'in %';
        $('#stdist3')[0].innerHTML = 'Expenditure in %';
