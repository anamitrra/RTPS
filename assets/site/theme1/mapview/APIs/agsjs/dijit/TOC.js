         ...
         _onClick: function (evt) {
             ...
             if (t == this.checkNode || dijit.getEnclosingWidget(t) == this.checkNode) {
                 ...
                 if (this.serviceLayer) {
                     ...
                     //var sel = false;
                     //for (var i = 0; i < this._getVisibleLayers().length; i++) {
                     //    for (var j = 0; j < edit_arr.length; j++) {
                     //        if (edit_arr[j].name == this.serviceLayer.name) {
                     //            if (edit_arr[j].visible)
                     //                edit_arr[j].setVisibility(false);
                     //            else
                     //                edit_arr[j].setVisibility(true);
                     //            sel = true;
                     //            break;
                     //        }
                     //    }
                     ...
                     //}
                     //for (var i = 0; i < 11; i++) {
                     //    //if (this._getVisibleLayers()[i] == featureLayerInfos[i].featureLayer.layerId) {
                     //        featureLayerInfos.splice(i, 1);
                     //    //}                         
                     //} map.removeLayer(layer1); map.removeLayer(layer2); map.removeLayer(layer3);
                     //map.removeLayer(layer4); map.removeLayer(layer5); map.removeLayer(layer6);
                     //    editorWidget.params.settings.layerInfos = featureLayerInfos;
                     //    editorWidget.editToolbar.refresh();
